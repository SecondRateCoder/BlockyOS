...
#pragma pack(push, 1)
static gdtDESC_t desc16 = {
    .address = (gdtDESC_t __far *)gdtTABLE16,
    .limit = sizeof(gdtTABLE16) - 1
};
static uint8_t gdtTABLE16[] = {
    // 32-bit Code segment
    0, 0, 0, 0, 0, 0, 0, 0,         // ull
    0xFFu, 0xFFu,                     // word
    0, 0,                           // word
...
static char g_hexes16[] = "0123456789ABCDEF";
