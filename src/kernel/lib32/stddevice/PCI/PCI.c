...
typedef struct PCIHeader0x0{
	...
	// unused.
	uint8_t unused[sizeof(PCIHeader0x2) - sizeof(PCIHeader0x1)];
}PCIHeader0x0;
...
typedef struct PCIHeader0x2{
	...
	uint32_t 16bitPC_CardLegacyModeBase;
}PCIHeader0x2;
...
PCIDevice defaults[] = {
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x0, .Attributes.SubClassCode = 0x0, .Attributes.ProgIF = 0x0},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x0, .Attributes.SubClassCode = 0x1, .Attributes.ProgIF = 0x0},

	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x0, .Attributes.ProgIF = 0x0},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x1, .Attributes.ProgIF = 0x0},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x1, .Attributes.ProgIF = 0x5},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x1, .Attributes.ProgIF = 0xA},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x1, .Attributes.ProgIF = 0xF},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x1, .Attributes.ProgIF = 0x80},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x1, .Attributes.ProgIF = 0x85},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x1, .Attributes.ProgIF = 0x8A},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x1, .Attributes.ProgIF = 0x8F},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x2, .Attributes.ProgIF = 0x0},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x3, .Attributes.ProgIF = 0x0},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x4, .Attributes.ProgIF = 0x0},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x5, .Attributes.ProgIF = 0x20},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x5, .Attributes.ProgIF = 0x30},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x6, .Attributes.ProgIF = 0x0},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x6, .Attributes.ProgIF = 0x1},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x6, .Attributes.ProgIF = 0x2},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x7, .Attributes.ProgIF = 0x0},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x7, .Attributes.ProgIF = 0x1},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x1, .Attributes.SubClassCode = 0x80, .Attributes.ProgIF = 0x0},

	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x2, .Attributes.SubClassCode = 0x0, .Attributes.ProgIF = 0x0},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x2, .Attributes.SubClassCode = 0x1, .Attributes.ProgIF = 0x0},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x2, .Attributes.SubClassCode = 0x2, .Attributes.ProgIF = 0x0},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x2, .Attributes.SubClassCode = 0x3, .Attributes.ProgIF = 0x0},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x2, .Attributes.SubClassCode = 0x4, .Attributes.ProgIF = 0x0},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x2, .Attributes.SubClassCode = 0x5, .Attributes.ProgIF = 0x0},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x2, .Attributes.SubClassCode = 0x6, .Attributes.ProgIF = 0x0},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x2, .Attributes.SubClassCode = 0x7, .Attributes.ProgIF = 0x0},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x2, .Attributes.SubClassCode = 0x8, .Attributes.ProgIF = 0x0},
	{.Attributes.padding = 0x0, .Attributes.ClassCode = 0x2, .Attributes.SubClassCode = 0x80, .Attributes.ProgIF = 0x0},
