...
OUTPUT_FORMAT("elf32-bigmips-vxworks", "elf32-bigmips-vxworks",
...
SECTIONS
{
  ...
  PROVIDE (__executable_start = SEGMENT_START("text-segment", (DEFINED (__wrs_rtp_base) ? __wrs_rtp_base : 0))); . = SEGMENT_START("text-segment", (DEFINED (__wrs_rtp_base) ? __wrs_rtp_base : 0)) + SIZEOF_HEADERS;
  .interp         : { *(.interp) }
