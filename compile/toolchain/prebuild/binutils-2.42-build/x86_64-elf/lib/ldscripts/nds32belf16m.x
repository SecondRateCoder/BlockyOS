...
OUTPUT_FORMAT("elf32-nds32be", "elf32-nds32be",
	      "elf32-nds32le")
OUTPUT_ARCH(nds32)
ENTRY(_start)
SECTIONS
{
  ...
  PROVIDE (__executable_start = SEGMENT_START("text-segment", 0x300000)); . = SEGMENT_START("text-segment", 0x300000);
