...
/* 32 bit ELF emulation code for avrxmega4_flmap
...
#define TARGET_IS_avrxmega4_flmap
...
static void gldavrxmega4_flmap_before_parse (void);
static void gldavrxmega4_flmap_before_plugin_all_symbols_read
  (void);
static void gldavrxmega4_flmap_after_open (void);
static void gldavrxmega4_flmap_before_allocation (void);
static void gldavrxmega4_flmap_after_allocation (void);
...
static void
avr_elf_avrxmega4_flmap_before_allocation (void)
{
  int ret;

  gldavrxmega4_flmap_before_allocation ();
  ...
  if (strcmp ("avrxmega4_flmap", "avr6") != 0
      && strcmp ("avrxmega4_flmap", "avrxmega6") != 0
      && strcmp ("avrxmega4_flmap", "avrxmega7") != 0)
    avr_no_stubs = true;
...
avr_elf_after_allocation (void)
{
  ...
  gldavrxmega4_flmap_after_allocation ();
...
avr_elf_before_parse (void)
{
  ...
  gldavrxmega4_flmap_before_parse ();
}
...
static void
gldavrxmega4_flmap_before_parse (void)
{
  ldfile_set_output_arch ("avr:104", bfd_arch_avr);
...
static void
gldavrxmega4_flmap_before_plugin_all_symbols_read (void)
{
...
static void
gldavrxmega4_flmap_after_open (void)
{
...
static void
gldavrxmega4_flmap_before_allocation (void)
{
...
static void
gldavrxmega4_flmap_after_allocation (void)
{
...
static char *
gldavrxmega4_flmap_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/avrxmega4_flmap.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/avrxmega4_flmap.xr";
  else if (!config.text_read_only)
    return "ldscripts/avrxmega4_flmap.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/avrxmega4_flmap.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/avrxmega4_flmap.xe";
      else
	return "ldscripts/avrxmega4_flmap.x";
    }
}
...
static void
gldavrxmega4_flmap_add_options
...
static bool
gldavrxmega4_flmap_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldavrxmega4_flmap_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_avrxmega4_flmap_emulation =
{
  avr_elf_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldavrxmega4_flmap_before_plugin_all_symbols_read,
  gldavrxmega4_flmap_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  avr_elf_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  avr_elf_avrxmega4_flmap_before_allocation,
  gldavrxmega4_flmap_get_script,
  "avrxmega4_flmap",
  "elf32-avr",
  avr_finish,
  ...
  NULL,
  gldavrxmega4_flmap_add_options,
  gldavrxmega4_flmap_handle_option,
  NULL,
  gldavrxmega4_flmap_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
