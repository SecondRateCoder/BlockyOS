...
static void gldh8300sxnelf_before_plugin_all_symbols_read
  (void);
static void gldh8300sxnelf_after_open (void);
static void gldh8300sxnelf_before_allocation (void);
static void gldh8300sxnelf_after_allocation (void);
...
static void
gldh8300sxnelf_before_plugin_all_symbols_read (void)
{
...
static void
gldh8300sxnelf_after_allocation (void)
{
...
gldh8300sxnelf_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
	...
	return "ldscripts/h8300sxnelf.xwe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/h8300sxnelf.xce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/h8300sxnelf.xe";
      else
...
static bool
gldh8300sxnelf_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_h8300sxnelf_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldh8300sxnelf_before_plugin_all_symbols_read,
  gldh8300sxnelf_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldh8300sxnelf_after_allocation,
