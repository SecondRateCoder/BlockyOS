...
/* 64 bit ELF emulation code for elf64ppc_fbsd
...
#define TARGET_IS_elf64ppc_fbsd
...
static void gldelf64ppc_fbsd_before_parse (void);
static void gldelf64ppc_fbsd_before_plugin_all_symbols_read
  (void);
static void gldelf64ppc_fbsd_after_open (void);
static void gldelf64ppc_fbsd_before_allocation (void);
static void gldelf64ppc_fbsd_after_allocation (void);
...
ppc_before_allocation (void)
{
  ...
  gldelf64ppc_fbsd_before_allocation ();
}
...
/* Call the back-end function to set TOC base after we have placed all
   the sections.  */
static void
gldelf64ppc_fbsd_after_allocation (void)
{
  int ret;
...
gldelf64ppc_fbsd_new_vers_pattern (struct bfd_elf_version_expr *entry)
{
...
static void
gldelf64ppc_fbsd_before_parse (void)
{
...
static void
gldelf64ppc_fbsd_before_plugin_all_symbols_read (void)
{
...
static void
gldelf64ppc_fbsd_after_open (void)
{
...
static void
gldelf64ppc_fbsd_before_allocation (void)
{
...
static char *
gldelf64ppc_fbsd_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf64ppc_fbsd.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf64ppc_fbsd.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf64ppc_fbsd.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf64ppc_fbsd.xn";
	...
	return "ldscripts/elf64ppc_fbsd.xdwe";
      else
	return "ldscripts/elf64ppc_fbsd.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64ppc_fbsd.xdce";
      else
	return "ldscripts/elf64ppc_fbsd.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64ppc_fbsd.xde";
      else
	return "ldscripts/elf64ppc_fbsd.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64ppc_fbsd.xswe";
      else
	return "ldscripts/elf64ppc_fbsd.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64ppc_fbsd.xsce";
      else
	return "ldscripts/elf64ppc_fbsd.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64ppc_fbsd.xse";
      else
	return "ldscripts/elf64ppc_fbsd.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64ppc_fbsd.xwe";
      else
	return "ldscripts/elf64ppc_fbsd.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64ppc_fbsd.xce";
      else
	return "ldscripts/elf64ppc_fbsd.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf64ppc_fbsd.xe";
      else
	return "ldscripts/elf64ppc_fbsd.x";
    }
}
...
static bool
gldelf64ppc_fbsd_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf64ppc_fbsd_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf64ppc_fbsd_emulation =
{
  gldelf64ppc_fbsd_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf64ppc_fbsd_before_plugin_all_symbols_read,
  ppc_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf64ppc_fbsd_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  ppc_before_allocation,
  gldelf64ppc_fbsd_get_script,
  "elf64ppc_fbsd",
  "elf64-powerpc-freebsd",
  gldelf64ppc_fbsd_finish,
  ...
  NULL,
  gldelf64ppc_fbsd_add_options,
  gldelf64ppc_fbsd_handle_option,
  NULL,
  gldelf64ppc_fbsd_list_options,
  ppc64_recognized_file,
  NULL,
  gldelf64ppc_fbsd_new_vers_pattern,
  NULL,
