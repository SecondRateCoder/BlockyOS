...
/* 32 bit ELF emulation code for elf_i386_be
...
static void gldelf_i386_be_before_parse (void);
static void gldelf_i386_be_before_plugin_all_symbols_read
  (void);
static void gldelf_i386_be_after_open (void);
static void gldelf_i386_be_before_allocation (void);
static void gldelf_i386_be_after_allocation (void);
...
elf_x86_before_parse (void)
{
  ...
  gldelf_i386_be_before_parse ();
}


static void
gldelf_i386_be_before_parse (void)
{
...
static void
gldelf_i386_be_before_plugin_all_symbols_read (void)
{
...
static void
gldelf_i386_be_after_open (void)
{
...
static void
gldelf_i386_be_before_allocation (void)
{
...
static void
gldelf_i386_be_after_allocation (void)
{
...
static char *
gldelf_i386_be_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf_i386_be.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf_i386_be.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf_i386_be.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf_i386_be.xn";
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_be.xswe";
      else
	return "ldscripts/elf_i386_be.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_be.xsce";
      else
	return "ldscripts/elf_i386_be.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_be.xse";
      else
	return "ldscripts/elf_i386_be.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_be.xwe";
      else
	return "ldscripts/elf_i386_be.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_be.xce";
      else
	return "ldscripts/elf_i386_be.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_be.xe";
      else
	return "ldscripts/elf_i386_be.x";
    }
}
...
static bool
gldelf_i386_be_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf_i386_be_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf_i386_be_emulation =
{
  elf_x86_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf_i386_be_before_plugin_all_symbols_read,
  gldelf_i386_be_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf_i386_be_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf_i386_be_before_allocation,
  gldelf_i386_be_get_script,
  "elf_i386_be",
  "elf32-i386",
  finish_default,
  ...
  NULL,
  gldelf_i386_be_add_options,
  gldelf_i386_be_handle_option,
  NULL,
  gldelf_i386_be_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
