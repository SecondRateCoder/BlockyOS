...
/* 32 bit ELF emulation code for armelfb_fbsd
...
static void gldarmelfb_fbsd_before_parse (void);
static void gldarmelfb_fbsd_before_plugin_all_symbols_read
  (void);
static void gldarmelfb_fbsd_after_open (void);
static void gldarmelfb_fbsd_before_allocation (void);
static void gldarmelfb_fbsd_after_allocation (void);
...
static void
gldarmelfb_fbsd_before_parse (void)
{
...
static void
gldarmelfb_fbsd_set_symbols (void)
{
...
arm_elf_before_allocation (void)
{
  ...
  gldarmelfb_fbsd_before_allocation ();
}
...
static void
gldarmelfb_fbsd_after_allocation (void)
{
  int ret;
...
static void
gldarmelfb_fbsd_before_plugin_all_symbols_read (void)
{
...
static void
gldarmelfb_fbsd_after_open (void)
{
...
static void
gldarmelfb_fbsd_before_allocation (void)
{
...
static char *
gldarmelfb_fbsd_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/armelfb_fbsd.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/armelfb_fbsd.xr";
  else if (!config.text_read_only)
    return "ldscripts/armelfb_fbsd.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/armelfb_fbsd.xn";
	...
	return "ldscripts/armelfb_fbsd.xdwe";
      else
	return "ldscripts/armelfb_fbsd.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_fbsd.xdce";
      else
	return "ldscripts/armelfb_fbsd.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_fbsd.xde";
      else
	return "ldscripts/armelfb_fbsd.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_fbsd.xswe";
      else
	return "ldscripts/armelfb_fbsd.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_fbsd.xsce";
      else
	return "ldscripts/armelfb_fbsd.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_fbsd.xse";
      else
	return "ldscripts/armelfb_fbsd.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_fbsd.xwe";
      else
	return "ldscripts/armelfb_fbsd.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_fbsd.xce";
      else
	return "ldscripts/armelfb_fbsd.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_fbsd.xe";
      else
	return "ldscripts/armelfb_fbsd.x";
    }
}
...
static bool
gldarmelfb_fbsd_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldarmelfb_fbsd_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_armelfb_fbsd_emulation =
{
  gldarmelfb_fbsd_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldarmelfb_fbsd_before_plugin_all_symbols_read,
  gldarmelfb_fbsd_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldarmelfb_fbsd_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  arm_elf_before_allocation,
  gldarmelfb_fbsd_get_script,
  "armelfb_fbsd",
  "elf32-bigarm",
  gldarmelfb_fbsd_finish,
  arm_elf_create_output_section_statements,
  ldelf_open_dynamic_archive,
  ldelf_place_orphan,
  gldarmelfb_fbsd_set_symbols,
  NULL,
  gldarmelfb_fbsd_add_options,
  gldarmelfb_fbsd_handle_option,
  NULL,
  gldarmelfb_fbsd_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
