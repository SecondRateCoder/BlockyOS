...
static void gldelf32ppc_before_plugin_all_symbols_read
  (void);
...
ppc_before_allocation (void)
{
  ...
  /* Turn on relaxation if executable sections have addresses that
  ...
  else if (!RELAXATION_DISABLED_BY_USER)
    {
	 ...
	 up gldelf32ppc_before_allocation sizing.  This
...
static void
gldelf32ppc_before_plugin_all_symbols_read (void)
{
...
gldelf32ppc_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32ppc.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32ppc.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32ppc.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32ppc.xn";
	...
	return "ldscripts/elf32ppc.xdwe";
      else
	return "ldscripts/elf32ppc.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppc.xdce";
      else
	return "ldscripts/elf32ppc.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppc.xde";
      else
	return "ldscripts/elf32ppc.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppc.xswe";
      else
	return "ldscripts/elf32ppc.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppc.xsce";
      else
	return "ldscripts/elf32ppc.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppc.xse";
      else
	return "ldscripts/elf32ppc.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppc.xwe";
      else
	return "ldscripts/elf32ppc.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppc.xce";
      else
	return "ldscripts/elf32ppc.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppc.xe";
      else
	return "ldscripts/elf32ppc.x";
    }
}
...
struct ld_emulation_xfer_struct ld_elf32ppc_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldelf32ppc_before_plugin_all_symbols_read,
