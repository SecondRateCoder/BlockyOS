...
/* 32 bit ELF emulation code for elf32epiphany
...
#define TARGET_IS_elf32epiphany
...
static void gldelf32epiphany_before_parse (void);
static void gldelf32epiphany_before_plugin_all_symbols_read
  (void);
static void gldelf32epiphany_after_open (void);
static void gldelf32epiphany_before_allocation (void);
static void gldelf32epiphany_after_allocation (void);


static void
gldelf32epiphany_before_parse (void)
{
  ldfile_set_output_arch ("epiphany", bfd_arch_epiphany);
...
static void
gldelf32epiphany_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32epiphany_after_open (void)
{
...
static void
gldelf32epiphany_before_allocation (void)
{
...
static void
gldelf32epiphany_after_allocation (void)
{
...
static char *
gldelf32epiphany_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32epiphany.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32epiphany.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32epiphany.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32epiphany.xn";
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32epiphany.xwe";
      else
	return "ldscripts/elf32epiphany.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32epiphany.xce";
      else
	return "ldscripts/elf32epiphany.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32epiphany.xe";
      else
	return "ldscripts/elf32epiphany.x";
    }
}
...
static bool
gldelf32epiphany_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf32epiphany_emulation =
{
  gldelf32epiphany_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32epiphany_before_plugin_all_symbols_read,
  gldelf32epiphany_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32epiphany_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32epiphany_before_allocation,
  gldelf32epiphany_get_script,
  "elf32epiphany",
  "elf32-epiphany",
  finish_default,
  NULL,
  ...
  NULL,
  gldelf32epiphany_add_options,
  gldelf32epiphany_handle_option,
  NULL,
  NULL,
  ldelf_load_symbols,
  NULL,
