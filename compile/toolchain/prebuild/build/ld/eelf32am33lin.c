...
/* 32 bit ELF emulation code for elf32am33lin
...
static void gldelf32am33lin_before_parse (void);
static void gldelf32am33lin_before_plugin_all_symbols_read
  (void);
static void gldelf32am33lin_after_open (void);
static void gldelf32am33lin_before_allocation (void);
static void gldelf32am33lin_after_allocation (void);


static void
gldelf32am33lin_before_parse (void)
{
  ldfile_set_output_arch ("mn10300", bfd_arch_mn10300);
...
static void
gldelf32am33lin_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32am33lin_after_open (void)
{
...
static void
gldelf32am33lin_before_allocation (void)
{
...
static void
gldelf32am33lin_after_allocation (void)
{
...
static char *
gldelf32am33lin_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32am33lin.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32am33lin.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32am33lin.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32am33lin.xn";
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32am33lin.xswe";
      else
	return "ldscripts/elf32am33lin.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32am33lin.xsce";
      else
	return "ldscripts/elf32am33lin.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32am33lin.xse";
      else
	return "ldscripts/elf32am33lin.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32am33lin.xwe";
      else
	return "ldscripts/elf32am33lin.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32am33lin.xce";
      else
	return "ldscripts/elf32am33lin.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32am33lin.xe";
      else
	return "ldscripts/elf32am33lin.x";
    }
}
...
static bool
gldelf32am33lin_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf32am33lin_emulation =
{
  gldelf32am33lin_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32am33lin_before_plugin_all_symbols_read,
  gldelf32am33lin_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32am33lin_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32am33lin_before_allocation,
  gldelf32am33lin_get_script,
  "elf32am33lin",
  "elf32-am33lin",
  finish_default,
  NULL,
