...
/* 32 bit ELF emulation code for m68hc11elf
...
static void gldm68hc11elf_before_parse (void);
static void gldm68hc11elf_before_plugin_all_symbols_read
  (void);
static void gldm68hc11elf_after_open (void);
static void gldm68hc11elf_before_allocation (void);
static void gldm68hc11elf_after_allocation (void);
...
static void
m68hc11_elf_m68hc11elf_before_allocation (void)
{
  lang_memory_region_type* region;
  int ret;

  gldm68hc11elf_before_allocation ();
...
m68hc11elf_after_allocation (void)
{
  ...
  gldm68hc11elf_after_allocation ();
}


static void
gldm68hc11elf_before_parse (void)
{
...
static void
gldm68hc11elf_before_plugin_all_symbols_read (void)
{
...
static void
gldm68hc11elf_before_allocation (void)
{
...
static void
gldm68hc11elf_after_allocation (void)
{
...
static char *
gldm68hc11elf_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/m68hc11elf.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/m68hc11elf.xr";
  else if (!config.text_read_only)
    return "ldscripts/m68hc11elf.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/m68hc11elf.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/m68hc11elf.xe";
      else
	return "ldscripts/m68hc11elf.x";
    }
}
...
static bool
gldm68hc11elf_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldm68hc11elf_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_m68hc11elf_emulation =
{
  gldm68hc11elf_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldm68hc11elf_before_plugin_all_symbols_read,
  gldm68hc11elf_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  m68hc11elf_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  m68hc11_elf_m68hc11elf_before_allocation,
  gldm68hc11elf_get_script,
  "m68hc11elf",
  "elf32-m68hc11",
  finish_default,
  ...
  NULL,
  gldm68hc11elf_add_options,
  gldm68hc11elf_handle_option,
  NULL,
  gldm68hc11elf_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
