...
/* 32 bit ELF emulation code for elf_i386_vxworks
...
#define TARGET_IS_elf_i386_vxworks
...
static void gldelf_i386_vxworks_before_parse (void);
static void gldelf_i386_vxworks_before_plugin_all_symbols_read
  (void);
static void gldelf_i386_vxworks_after_open (void);
static void gldelf_i386_vxworks_before_allocation (void);
static void gldelf_i386_vxworks_after_allocation (void);
...
elf_x86_before_parse (void)
{
  ...
  gldelf_i386_vxworks_before_parse ();
}
...
{
  gldelf_i386_vxworks_after_open ();
...
static void
gldelf_i386_vxworks_before_parse (void)
{
...
static void
gldelf_i386_vxworks_before_plugin_all_symbols_read (void)
{
...
static void
gldelf_i386_vxworks_after_open (void)
{
...
static void
gldelf_i386_vxworks_before_allocation (void)
{
...
static void
gldelf_i386_vxworks_after_allocation (void)
{
...
static char *
gldelf_i386_vxworks_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf_i386_vxworks.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf_i386_vxworks.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf_i386_vxworks.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf_i386_vxworks.xn";
	...
	return "ldscripts/elf_i386_vxworks.xdwe";
      else
	return "ldscripts/elf_i386_vxworks.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_vxworks.xdce";
      else
	return "ldscripts/elf_i386_vxworks.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_vxworks.xde";
      else
	return "ldscripts/elf_i386_vxworks.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_vxworks.xswe";
      else
	return "ldscripts/elf_i386_vxworks.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_vxworks.xsce";
      else
	return "ldscripts/elf_i386_vxworks.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_vxworks.xse";
      else
	return "ldscripts/elf_i386_vxworks.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_vxworks.xwe";
      else
	return "ldscripts/elf_i386_vxworks.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_vxworks.xce";
      else
	return "ldscripts/elf_i386_vxworks.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_vxworks.xe";
      else
	return "ldscripts/elf_i386_vxworks.x";
    }
}
...
static void
gldelf_i386_vxworks_add_options
...
static bool
gldelf_i386_vxworks_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf_i386_vxworks_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf_i386_vxworks_emulation =
{
  vxworks_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf_i386_vxworks_before_plugin_all_symbols_read,
  vxworks_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf_i386_vxworks_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf_i386_vxworks_before_allocation,
  gldelf_i386_vxworks_get_script,
  "elf_i386_vxworks",
  "elf32-i386-vxworks",
  finish_default,
  ...
  NULL,
  gldelf_i386_vxworks_add_options,
  gldelf_i386_vxworks_handle_option,
  NULL,
  gldelf_i386_vxworks_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
