...
/* 32 bit ELF emulation code for elf32bfin
...
static void gldelf32bfin_before_parse (void);
static void gldelf32bfin_before_plugin_all_symbols_read
  (void);
static void gldelf32bfin_after_open (void);
static void gldelf32bfin_before_allocation (void);
static void gldelf32bfin_after_allocation (void);
...
static void
gldelf32bfin_before_parse (void)
{
...
static void
gldelf32bfin_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32bfin_before_allocation (void)
{
...
static void
gldelf32bfin_after_allocation (void)
{
...
static char *
gldelf32bfin_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32bfin.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32bfin.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32bfin.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32bfin.xn";
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bfin.xswe";
      else
	return "ldscripts/elf32bfin.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bfin.xsce";
      else
	return "ldscripts/elf32bfin.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bfin.xse";
      else
	return "ldscripts/elf32bfin.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bfin.xwe";
      else
	return "ldscripts/elf32bfin.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bfin.xce";
      else
	return "ldscripts/elf32bfin.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bfin.xe";
      else
	return "ldscripts/elf32bfin.x";
    }
}
...
static bool
gldelf32bfin_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32bfin_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32bfin_emulation =
{
  gldelf32bfin_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32bfin_before_plugin_all_symbols_read,
  gldelf32bfin_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32bfin_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32bfin_before_allocation,
  gldelf32bfin_get_script,
  "elf32bfin",
  "elf32-bfin",
  finish_default,
  NULL,
  ...
  NULL,
  gldelf32bfin_add_options,
  gldelf32bfin_handle_option,
  NULL,
  gldelf32bfin_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
