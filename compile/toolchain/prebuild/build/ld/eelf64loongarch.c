...
/* 64 bit ELF emulation code for elf64loongarch
...
#define TARGET_IS_elf64loongarch
...
static void gldelf64loongarch_before_parse (void);
static void gldelf64loongarch_before_plugin_all_symbols_read
  (void);
static void gldelf64loongarch_after_open (void);
static void gldelf64loongarch_before_allocation (void);
static void gldelf64loongarch_after_allocation (void);
...
{
  gldelf64loongarch_before_allocation ();
...
static void
gldelf64loongarch_after_allocation (void)
{
  int need_layout = 0;
  ...
  bfd_elf64_loongarch_set_data_segment_info (&link_info, (int *) phase);
  /* gldelf64loongarch_map_segments (need_layout); */
...
static void
gldelf64loongarch_before_parse (void)
{
  ldfile_set_output_arch ("loongarch", bfd_arch_loongarch);
...
static void
gldelf64loongarch_before_plugin_all_symbols_read (void)
{
...
static void
gldelf64loongarch_after_open (void)
{
...
static void
gldelf64loongarch_before_allocation (void)
{
...
static char *
gldelf64loongarch_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf64loongarch.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf64loongarch.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf64loongarch.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf64loongarch.xn";
	...
	return "ldscripts/elf64loongarch.xdwe";
      else
	return "ldscripts/elf64loongarch.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64loongarch.xdce";
      else
	return "ldscripts/elf64loongarch.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64loongarch.xde";
      else
	return "ldscripts/elf64loongarch.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64loongarch.xswe";
      else
	return "ldscripts/elf64loongarch.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64loongarch.xsce";
      else
	return "ldscripts/elf64loongarch.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64loongarch.xse";
      else
	return "ldscripts/elf64loongarch.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64loongarch.xwe";
      else
	return "ldscripts/elf64loongarch.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64loongarch.xce";
      else
	return "ldscripts/elf64loongarch.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf64loongarch.xe";
      else
	return "ldscripts/elf64loongarch.x";
    }
}
...
static bool
gldelf64loongarch_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf64loongarch_emulation =
{
  gldelf64loongarch_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf64loongarch_before_plugin_all_symbols_read,
  gldelf64loongarch_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf64loongarch_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  larch_elf_before_allocation,
  gldelf64loongarch_get_script,
  "elf64loongarch",
  "elf64-loongarch",
  finish_default,
  larch_create_output_section_statements,
  ldelf_open_dynamic_archive,
  ldelf_place_orphan,
  NULL,
  NULL,
  gldelf64loongarch_add_options,
  gldelf64loongarch_handle_option,
  NULL,
  NULL,
  ldelf_load_symbols,
  NULL,
