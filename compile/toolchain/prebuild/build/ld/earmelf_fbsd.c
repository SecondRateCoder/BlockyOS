...
/* 32 bit ELF emulation code for armelf_fbsd
...
static void gldarmelf_fbsd_before_parse (void);
static void gldarmelf_fbsd_before_plugin_all_symbols_read
  (void);
static void gldarmelf_fbsd_after_open (void);
static void gldarmelf_fbsd_before_allocation (void);
static void gldarmelf_fbsd_after_allocation (void);
...
static void
gldarmelf_fbsd_before_parse (void)
{
...
static void
gldarmelf_fbsd_set_symbols (void)
{
...
arm_elf_before_allocation (void)
{
  ...
  gldarmelf_fbsd_before_allocation ();
}
...
static void
gldarmelf_fbsd_after_allocation (void)
{
  int ret;
...
static void
gldarmelf_fbsd_before_plugin_all_symbols_read (void)
{
...
static void
gldarmelf_fbsd_after_open (void)
{
...
static void
gldarmelf_fbsd_before_allocation (void)
{
...
static char *
gldarmelf_fbsd_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/armelf_fbsd.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/armelf_fbsd.xr";
  else if (!config.text_read_only)
    return "ldscripts/armelf_fbsd.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/armelf_fbsd.xn";
	...
	return "ldscripts/armelf_fbsd.xdwe";
      else
	return "ldscripts/armelf_fbsd.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_fbsd.xdce";
      else
	return "ldscripts/armelf_fbsd.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_fbsd.xde";
      else
	return "ldscripts/armelf_fbsd.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_fbsd.xswe";
      else
	return "ldscripts/armelf_fbsd.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_fbsd.xsce";
      else
	return "ldscripts/armelf_fbsd.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_fbsd.xse";
      else
	return "ldscripts/armelf_fbsd.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_fbsd.xwe";
      else
	return "ldscripts/armelf_fbsd.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_fbsd.xce";
      else
	return "ldscripts/armelf_fbsd.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_fbsd.xe";
      else
	return "ldscripts/armelf_fbsd.x";
    }
}
...
static bool
gldarmelf_fbsd_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldarmelf_fbsd_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_armelf_fbsd_emulation =
{
  gldarmelf_fbsd_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldarmelf_fbsd_before_plugin_all_symbols_read,
  gldarmelf_fbsd_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldarmelf_fbsd_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  arm_elf_before_allocation,
  gldarmelf_fbsd_get_script,
  "armelf_fbsd",
  "elf32-littlearm",
  gldarmelf_fbsd_finish,
  arm_elf_create_output_section_statements,
  ldelf_open_dynamic_archive,
  ldelf_place_orphan,
  gldarmelf_fbsd_set_symbols,
  NULL,
  gldarmelf_fbsd_add_options,
  gldarmelf_fbsd_handle_option,
  NULL,
  gldarmelf_fbsd_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
