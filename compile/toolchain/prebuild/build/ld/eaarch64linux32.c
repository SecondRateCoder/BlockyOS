...
static void gldaarch64linux32_before_plugin_all_symbols_read
  (void);
...
static void
gldaarch64linux32_before_plugin_all_symbols_read (void)
{
...
{
  ldelf_before_allocation (audit, depaudit, "/lib/ld-linux-aarch64_ilp32.so.1");
}
...
gldaarch64linux32_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/aarch64linux32.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/aarch64linux32.xr";
  else if (!config.text_read_only)
    return "ldscripts/aarch64linux32.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/aarch64linux32.xn";
	...
	return "ldscripts/aarch64linux32.xdwe";
      else
	return "ldscripts/aarch64linux32.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux32.xdce";
      else
	return "ldscripts/aarch64linux32.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux32.xde";
      else
	return "ldscripts/aarch64linux32.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux32.xswe";
      else
	return "ldscripts/aarch64linux32.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux32.xsce";
      else
	return "ldscripts/aarch64linux32.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux32.xse";
      else
	return "ldscripts/aarch64linux32.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux32.xwe";
      else
	return "ldscripts/aarch64linux32.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux32.xce";
      else
	return "ldscripts/aarch64linux32.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux32.xe";
      else
	return "ldscripts/aarch64linux32.x";
    }
}
...
struct ld_emulation_xfer_struct ld_aarch64linux32_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldaarch64linux32_before_plugin_all_symbols_read,
