...
/* 32 bit ELF emulation code for elf32ebmipvxworks
...
#define TARGET_IS_elf32ebmipvxworks
...
static void gldelf32ebmipvxworks_before_parse (void);
static void gldelf32ebmipvxworks_before_plugin_all_symbols_read
  (void);
static void gldelf32ebmipvxworks_after_open (void);
static void gldelf32ebmipvxworks_before_allocation (void);
static void gldelf32ebmipvxworks_after_allocation (void);
...
mips_before_allocation (void)
{
  ...
  gldelf32ebmipvxworks_before_allocation ();
}
...
{
  gldelf32ebmipvxworks_before_parse ();
...
{
  gldelf32ebmipvxworks_after_open ();
...
static void
gldelf32ebmipvxworks_before_parse (void)
{
...
static void
gldelf32ebmipvxworks_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32ebmipvxworks_after_open (void)
{
...
static void
gldelf32ebmipvxworks_before_allocation (void)
{
...
static void
gldelf32ebmipvxworks_after_allocation (void)
{
...
static char *
gldelf32ebmipvxworks_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32ebmipvxworks.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32ebmipvxworks.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32ebmipvxworks.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32ebmipvxworks.xn";
	...
	return "ldscripts/elf32ebmipvxworks.xdwe";
      else
	return "ldscripts/elf32ebmipvxworks.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ebmipvxworks.xdce";
      else
	return "ldscripts/elf32ebmipvxworks.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ebmipvxworks.xde";
      else
	return "ldscripts/elf32ebmipvxworks.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ebmipvxworks.xswe";
      else
	return "ldscripts/elf32ebmipvxworks.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ebmipvxworks.xsce";
      else
	return "ldscripts/elf32ebmipvxworks.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ebmipvxworks.xse";
      else
	return "ldscripts/elf32ebmipvxworks.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ebmipvxworks.xwe";
      else
	return "ldscripts/elf32ebmipvxworks.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ebmipvxworks.xce";
      else
	return "ldscripts/elf32ebmipvxworks.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ebmipvxworks.xe";
      else
	return "ldscripts/elf32ebmipvxworks.x";
    }
}
...
static void
gldelf32ebmipvxworks_add_options
...
static bool
gldelf32ebmipvxworks_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32ebmipvxworks_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32ebmipvxworks_emulation =
{
  vxworks_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32ebmipvxworks_before_plugin_all_symbols_read,
  vxworks_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32ebmipvxworks_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  mips_before_allocation,
  gldelf32ebmipvxworks_get_script,
  "elf32ebmipvxworks",
  ...
  NULL,
  gldelf32ebmipvxworks_add_options,
  gldelf32ebmipvxworks_handle_option,
  NULL,
  gldelf32ebmipvxworks_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
