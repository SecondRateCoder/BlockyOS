...
/* 32 bit ELF emulation code for elf32bsmip
...
static void gldelf32bsmip_before_parse (void);
static void gldelf32bsmip_before_plugin_all_symbols_read
  (void);
static void gldelf32bsmip_after_open (void);
static void gldelf32bsmip_before_allocation (void);
static void gldelf32bsmip_after_allocation (void);
...
mips_before_allocation (void)
{
  ...
  gldelf32bsmip_before_allocation ();
}


static void
gldelf32bsmip_before_parse (void)
{
...
static void
gldelf32bsmip_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32bsmip_before_allocation (void)
{
...
static void
gldelf32bsmip_after_allocation (void)
{
...
static char *
gldelf32bsmip_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32bsmip.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32bsmip.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32bsmip.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32bsmip.xn";
	...
	return "ldscripts/elf32bsmip.xdwe";
      else
	return "ldscripts/elf32bsmip.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bsmip.xdce";
      else
	return "ldscripts/elf32bsmip.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bsmip.xde";
      else
	return "ldscripts/elf32bsmip.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bsmip.xswe";
      else
	return "ldscripts/elf32bsmip.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bsmip.xsce";
      else
	return "ldscripts/elf32bsmip.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bsmip.xse";
      else
	return "ldscripts/elf32bsmip.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bsmip.xwe";
      else
	return "ldscripts/elf32bsmip.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bsmip.xce";
      else
	return "ldscripts/elf32bsmip.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bsmip.xe";
      else
	return "ldscripts/elf32bsmip.x";
    }
}
...
static bool
gldelf32bsmip_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32bsmip_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32bsmip_emulation =
{
  gldelf32bsmip_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32bsmip_before_plugin_all_symbols_read,
  irix_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32bsmip_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  mips_before_allocation,
  gldelf32bsmip_get_script,
  "elf32bsmip",
  "elf32-bigmips",
  finish_default,
  ...
  NULL,
  gldelf32bsmip_add_options,
  gldelf32bsmip_handle_option,
  NULL,
  gldelf32bsmip_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
