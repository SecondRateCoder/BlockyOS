...
/* 32 bit ELF emulation code for mn10300
...
static void gldmn10300_before_parse (void);
static void gldmn10300_before_plugin_all_symbols_read
  (void);
static void gldmn10300_after_open (void);
static void gldmn10300_before_allocation (void);
static void gldmn10300_after_allocation (void);


static void
gldmn10300_before_parse (void)
{
...
static void
gldmn10300_before_plugin_all_symbols_read (void)
{
...
static void
gldmn10300_before_allocation (void)
{
...
static void
gldmn10300_after_allocation (void)
{
...
static char *
gldmn10300_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/mn10300.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/mn10300.xr";
  else if (!config.text_read_only)
    return "ldscripts/mn10300.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/mn10300.xn";
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/mn10300.xswe";
      else
	return "ldscripts/mn10300.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/mn10300.xsce";
      else
	return "ldscripts/mn10300.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/mn10300.xse";
      else
	return "ldscripts/mn10300.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/mn10300.xwe";
      else
	return "ldscripts/mn10300.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/mn10300.xce";
      else
	return "ldscripts/mn10300.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/mn10300.xe";
      else
	return "ldscripts/mn10300.x";
    }
}
...
static bool
gldmn10300_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_mn10300_emulation =
{
  gldmn10300_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldmn10300_before_plugin_all_symbols_read,
  gldmn10300_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldmn10300_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldmn10300_before_allocation,
  gldmn10300_get_script,
  "mn10300",
  "elf32-mn10300",
  finish_default,
  NULL,
