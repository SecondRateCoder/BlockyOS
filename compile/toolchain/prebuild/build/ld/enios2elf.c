...
/* 32 bit ELF emulation code for nios2elf
...
static void gldnios2elf_before_parse (void);
static void gldnios2elf_before_plugin_all_symbols_read
  (void);
static void gldnios2elf_after_open (void);
static void gldnios2elf_before_allocation (void);
static void gldnios2elf_after_allocation (void);
...
static void
gldnios2elf_after_allocation (void)
{
  int ret;
...
static void
gldnios2elf_before_plugin_all_symbols_read (void)
{
...
static void
gldnios2elf_before_allocation (void)
{
...
static char *
gldnios2elf_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/nios2elf.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/nios2elf.xr";
  else if (!config.text_read_only)
    return "ldscripts/nios2elf.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/nios2elf.xn";
	...
	return "ldscripts/nios2elf.xdwe";
      else
	return "ldscripts/nios2elf.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/nios2elf.xdce";
      else
	return "ldscripts/nios2elf.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/nios2elf.xde";
      else
	return "ldscripts/nios2elf.xd";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/nios2elf.xwe";
      else
	return "ldscripts/nios2elf.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/nios2elf.xce";
      else
	return "ldscripts/nios2elf.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/nios2elf.xe";
      else
	return "ldscripts/nios2elf.x";
    }
}
...
static bool
gldnios2elf_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_nios2elf_emulation =
{
  gldnios2elf_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldnios2elf_before_plugin_all_symbols_read,
  gldnios2elf_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldnios2elf_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldnios2elf_before_allocation,
  gldnios2elf_get_script,
  "nios2elf",
  "elf32-littlenios2",
  finish_default,
