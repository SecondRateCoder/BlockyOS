...
/* 32 bit ELF emulation code for avrxmega5
...
static void gldavrxmega5_before_parse (void);
static void gldavrxmega5_before_plugin_all_symbols_read
  (void);
static void gldavrxmega5_after_open (void);
static void gldavrxmega5_before_allocation (void);
static void gldavrxmega5_after_allocation (void);
...
static void
avr_elf_avrxmega5_before_allocation (void)
{
  int ret;

  gldavrxmega5_before_allocation ();
  ...
  if (strcmp ("avrxmega5", "avr6") != 0
      && strcmp ("avrxmega5", "avrxmega6") != 0
      && strcmp ("avrxmega5", "avrxmega7") != 0)
    avr_no_stubs = true;
...
static void
gldavrxmega5_before_parse (void)
{
  ldfile_set_output_arch ("avr:105", bfd_arch_avr);
...
static void
gldavrxmega5_before_plugin_all_symbols_read (void)
{
...
static void
gldavrxmega5_before_allocation (void)
{
...
static void
gldavrxmega5_after_allocation (void)
{
...
static char *
gldavrxmega5_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/avrxmega5.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/avrxmega5.xr";
  else if (!config.text_read_only)
    return "ldscripts/avrxmega5.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/avrxmega5.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/avrxmega5.xe";
      else
	return "ldscripts/avrxmega5.x";
    }
}
...
static bool
gldavrxmega5_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldavrxmega5_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_avrxmega5_emulation =
{
  avr_elf_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldavrxmega5_before_plugin_all_symbols_read,
  gldavrxmega5_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  avr_elf_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  avr_elf_avrxmega5_before_allocation,
  gldavrxmega5_get_script,
  "avrxmega5",
  "elf32-avr",
  avr_finish,
  ...
  NULL,
  gldavrxmega5_add_options,
  gldavrxmega5_handle_option,
  NULL,
  gldavrxmega5_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
