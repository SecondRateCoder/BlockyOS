...
/* 32 bit ELF emulation code for elf32xtensa
...
static void gldelf32xtensa_before_parse (void);
static void gldelf32xtensa_before_plugin_all_symbols_read
  (void);
static void gldelf32xtensa_after_open (void);
static void gldelf32xtensa_before_allocation (void);
static void gldelf32xtensa_after_allocation (void);
...
elf_xtensa_before_allocation (void)
{
  ...
  gldelf32xtensa_before_allocation ();
...
static void
gldelf32xtensa_before_parse (void)
{
  ldfile_set_output_arch ("xtensa", bfd_arch_xtensa);
...
static void
gldelf32xtensa_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32xtensa_after_open (void)
{
...
static void
gldelf32xtensa_before_allocation (void)
{
...
static void
gldelf32xtensa_after_allocation (void)
{
...
static char *
gldelf32xtensa_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32xtensa.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32xtensa.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32xtensa.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32xtensa.xn";
	...
	return "ldscripts/elf32xtensa.xdwe";
      else
	return "ldscripts/elf32xtensa.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32xtensa.xdce";
      else
	return "ldscripts/elf32xtensa.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32xtensa.xde";
      else
	return "ldscripts/elf32xtensa.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32xtensa.xswe";
      else
	return "ldscripts/elf32xtensa.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32xtensa.xsce";
      else
	return "ldscripts/elf32xtensa.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32xtensa.xse";
      else
	return "ldscripts/elf32xtensa.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32xtensa.xwe";
      else
	return "ldscripts/elf32xtensa.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32xtensa.xce";
      else
	return "ldscripts/elf32xtensa.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32xtensa.xe";
      else
	return "ldscripts/elf32xtensa.x";
    }
}
...
static bool
gldelf32xtensa_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32xtensa_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32xtensa_emulation =
{
  elf_xtensa_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32xtensa_before_plugin_all_symbols_read,
  elf_xtensa_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32xtensa_after_allocation,
  ldelf_set_output_arch,
  elf_xtensa_choose_target,
  elf_xtensa_before_allocation,
  gldelf32xtensa_get_script,
  "elf32xtensa",
  "undefined",
  finish_default,
  NULL,
  ...
  NULL,
  gldelf32xtensa_add_options,
  gldelf32xtensa_handle_option,
  NULL,
  gldelf32xtensa_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
