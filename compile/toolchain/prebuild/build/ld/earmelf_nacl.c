...
/* 32 bit ELF emulation code for armelf_nacl
...
static void gldarmelf_nacl_before_parse (void);
static void gldarmelf_nacl_before_plugin_all_symbols_read
  (void);
static void gldarmelf_nacl_after_open (void);
static void gldarmelf_nacl_before_allocation (void);
static void gldarmelf_nacl_after_allocation (void);
...
static void
gldarmelf_nacl_before_parse (void)
{
...
static void
gldarmelf_nacl_set_symbols (void)
{
...
arm_elf_before_allocation (void)
{
  ...
  gldarmelf_nacl_before_allocation ();
}
...
static void
gldarmelf_nacl_after_allocation (void)
{
  int ret;
...
static void
gldarmelf_nacl_before_plugin_all_symbols_read (void)
{
...
static void
gldarmelf_nacl_after_open (void)
{
...
static void
gldarmelf_nacl_before_allocation (void)
{
...
static char *
gldarmelf_nacl_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/armelf_nacl.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/armelf_nacl.xr";
  else if (!config.text_read_only)
    return "ldscripts/armelf_nacl.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/armelf_nacl.xn";
	...
	return "ldscripts/armelf_nacl.xdwe";
      else
	return "ldscripts/armelf_nacl.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_nacl.xdce";
      else
	return "ldscripts/armelf_nacl.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_nacl.xde";
      else
	return "ldscripts/armelf_nacl.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_nacl.xswe";
      else
	return "ldscripts/armelf_nacl.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_nacl.xsce";
      else
	return "ldscripts/armelf_nacl.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_nacl.xse";
      else
	return "ldscripts/armelf_nacl.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_nacl.xwe";
      else
	return "ldscripts/armelf_nacl.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_nacl.xce";
      else
	return "ldscripts/armelf_nacl.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_nacl.xe";
      else
	return "ldscripts/armelf_nacl.x";
    }
}
...
static bool
gldarmelf_nacl_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldarmelf_nacl_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_armelf_nacl_emulation =
{
  gldarmelf_nacl_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldarmelf_nacl_before_plugin_all_symbols_read,
  gldarmelf_nacl_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldarmelf_nacl_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  arm_elf_before_allocation,
  gldarmelf_nacl_get_script,
  "armelf_nacl",
  "elf32-littlearm-nacl",
  gldarmelf_nacl_finish,
  arm_elf_create_output_section_statements,
  ldelf_open_dynamic_archive,
  ldelf_place_orphan,
  gldarmelf_nacl_set_symbols,
  NULL,
  gldarmelf_nacl_add_options,
  gldarmelf_nacl_handle_option,
  NULL,
  gldarmelf_nacl_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
