...
/* 32 bit ELF emulation code for shelf_uclinux
...
#define TARGET_IS_shelf_uclinux
...
static void gldshelf_uclinux_before_parse (void);
static void gldshelf_uclinux_before_plugin_all_symbols_read
  (void);
static void gldshelf_uclinux_after_open (void);
static void gldshelf_uclinux_before_allocation (void);
static void gldshelf_uclinux_after_allocation (void);


static void
gldshelf_uclinux_before_parse (void)
{
...
static void
gldshelf_uclinux_before_plugin_all_symbols_read (void)
{
...
static void
gldshelf_uclinux_after_open (void)
{
...
static void
gldshelf_uclinux_before_allocation (void)
{
...
static void
gldshelf_uclinux_after_allocation (void)
{
...
static char *
gldshelf_uclinux_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/shelf_uclinux.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/shelf_uclinux.xr";
  else if (!config.text_read_only)
    return "ldscripts/shelf_uclinux.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/shelf_uclinux.xn";
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/shelf_uclinux.xswe";
      else
	return "ldscripts/shelf_uclinux.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/shelf_uclinux.xsce";
      else
	return "ldscripts/shelf_uclinux.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/shelf_uclinux.xse";
      else
	return "ldscripts/shelf_uclinux.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/shelf_uclinux.xwe";
      else
	return "ldscripts/shelf_uclinux.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/shelf_uclinux.xce";
      else
	return "ldscripts/shelf_uclinux.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/shelf_uclinux.xe";
      else
	return "ldscripts/shelf_uclinux.x";
    }
}
...
static bool
gldshelf_uclinux_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_shelf_uclinux_emulation =
{
  gldshelf_uclinux_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldshelf_uclinux_before_plugin_all_symbols_read,
  gldshelf_uclinux_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldshelf_uclinux_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldshelf_uclinux_before_allocation,
  gldshelf_uclinux_get_script,
  "shelf_uclinux",
  "elf32-sh",
  finish_default,
  NULL,
  ...
  NULL,
  gldshelf_uclinux_add_options,
  gldshelf_uclinux_handle_option,
  NULL,
  NULL,
  ldelf_load_symbols,
  NULL,
