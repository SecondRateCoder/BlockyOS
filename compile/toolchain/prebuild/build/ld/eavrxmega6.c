...
/* 32 bit ELF emulation code for avrxmega6
...
static void gldavrxmega6_before_parse (void);
static void gldavrxmega6_before_plugin_all_symbols_read
  (void);
static void gldavrxmega6_after_open (void);
static void gldavrxmega6_before_allocation (void);
static void gldavrxmega6_after_allocation (void);
...
static void
avr_elf_avrxmega6_before_allocation (void)
{
  int ret;

  gldavrxmega6_before_allocation ();
  ...
  if (strcmp ("avrxmega6", "avr6") != 0
      && strcmp ("avrxmega6", "avrxmega6") != 0
      && strcmp ("avrxmega6", "avrxmega7") != 0)
    avr_no_stubs = true;
...
static void
gldavrxmega6_before_parse (void)
{
  ldfile_set_output_arch ("avr:106", bfd_arch_avr);
...
static void
gldavrxmega6_before_plugin_all_symbols_read (void)
{
...
static void
gldavrxmega6_before_allocation (void)
{
...
static void
gldavrxmega6_after_allocation (void)
{
...
static char *
gldavrxmega6_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/avrxmega6.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/avrxmega6.xr";
  else if (!config.text_read_only)
    return "ldscripts/avrxmega6.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/avrxmega6.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/avrxmega6.xe";
      else
	return "ldscripts/avrxmega6.x";
    }
}
...
static bool
gldavrxmega6_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldavrxmega6_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_avrxmega6_emulation =
{
  avr_elf_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldavrxmega6_before_plugin_all_symbols_read,
  gldavrxmega6_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  avr_elf_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  avr_elf_avrxmega6_before_allocation,
  gldavrxmega6_get_script,
  "avrxmega6",
  "elf32-avr",
  avr_finish,
  ...
  NULL,
  gldavrxmega6_add_options,
  gldavrxmega6_handle_option,
  NULL,
  gldavrxmega6_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
