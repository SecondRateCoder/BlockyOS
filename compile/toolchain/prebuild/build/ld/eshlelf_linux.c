...
/* 32 bit ELF emulation code for shlelf_linux
...
static void gldshlelf_linux_before_parse (void);
static void gldshlelf_linux_before_plugin_all_symbols_read
  (void);
static void gldshlelf_linux_after_open (void);
static void gldshlelf_linux_before_allocation (void);
static void gldshlelf_linux_after_allocation (void);


static void
gldshlelf_linux_before_parse (void)
{
...
static void
gldshlelf_linux_before_plugin_all_symbols_read (void)
{
...
static void
gldshlelf_linux_after_open (void)
{
...
static void
gldshlelf_linux_before_allocation (void)
{
...
static void
gldshlelf_linux_after_allocation (void)
{
...
static char *
gldshlelf_linux_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/shlelf_linux.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/shlelf_linux.xr";
  else if (!config.text_read_only)
    return "ldscripts/shlelf_linux.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/shlelf_linux.xn";
	...
	return "ldscripts/shlelf_linux.xdwe";
      else
	return "ldscripts/shlelf_linux.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_linux.xdce";
      else
	return "ldscripts/shlelf_linux.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_linux.xde";
      else
	return "ldscripts/shlelf_linux.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_linux.xswe";
      else
	return "ldscripts/shlelf_linux.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_linux.xsce";
      else
	return "ldscripts/shlelf_linux.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_linux.xse";
      else
	return "ldscripts/shlelf_linux.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_linux.xwe";
      else
	return "ldscripts/shlelf_linux.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_linux.xce";
      else
	return "ldscripts/shlelf_linux.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_linux.xe";
      else
	return "ldscripts/shlelf_linux.x";
    }
}
...
static bool
gldshlelf_linux_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_shlelf_linux_emulation =
{
  gldshlelf_linux_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldshlelf_linux_before_plugin_all_symbols_read,
  gldshlelf_linux_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldshlelf_linux_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldshlelf_linux_before_allocation,
  gldshlelf_linux_get_script,
  "shlelf_linux",
  "elf32-sh-linux",
  finish_default,
  NULL,
