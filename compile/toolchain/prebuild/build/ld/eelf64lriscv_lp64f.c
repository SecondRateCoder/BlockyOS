...
/* 64 bit ELF emulation code for elf64lriscv_lp64f
...
#define TARGET_IS_elf64lriscv_lp64f
...
static void gldelf64lriscv_lp64f_before_parse (void);
static void gldelf64lriscv_lp64f_before_plugin_all_symbols_read
  (void);
static void gldelf64lriscv_lp64f_after_open (void);
static void gldelf64lriscv_lp64f_before_allocation (void);
static void gldelf64lriscv_lp64f_after_allocation (void);
...
{
  gldelf64lriscv_lp64f_before_allocation ();
...
static void
gldelf64lriscv_lp64f_after_allocation (void)
{
  int need_layout = 0;
...
static void
gldelf64lriscv_lp64f_before_parse (void)
{
...
static void
gldelf64lriscv_lp64f_before_plugin_all_symbols_read (void)
{
...
static void
gldelf64lriscv_lp64f_after_open (void)
{
...
static void
gldelf64lriscv_lp64f_before_allocation (void)
{
...
static char *
gldelf64lriscv_lp64f_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf64lriscv_lp64f.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf64lriscv_lp64f.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf64lriscv_lp64f.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf64lriscv_lp64f.xn";
	...
	return "ldscripts/elf64lriscv_lp64f.xdwe";
      else
	return "ldscripts/elf64lriscv_lp64f.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lriscv_lp64f.xdce";
      else
	return "ldscripts/elf64lriscv_lp64f.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lriscv_lp64f.xde";
      else
	return "ldscripts/elf64lriscv_lp64f.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lriscv_lp64f.xswe";
      else
	return "ldscripts/elf64lriscv_lp64f.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lriscv_lp64f.xsce";
      else
	return "ldscripts/elf64lriscv_lp64f.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lriscv_lp64f.xse";
      else
	return "ldscripts/elf64lriscv_lp64f.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lriscv_lp64f.xwe";
      else
	return "ldscripts/elf64lriscv_lp64f.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lriscv_lp64f.xce";
      else
	return "ldscripts/elf64lriscv_lp64f.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lriscv_lp64f.xe";
      else
	return "ldscripts/elf64lriscv_lp64f.x";
    }
}
...
static void
gldelf64lriscv_lp64f_add_options
...
static bool
gldelf64lriscv_lp64f_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf64lriscv_lp64f_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf64lriscv_lp64f_emulation =
{
  gldelf64lriscv_lp64f_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf64lriscv_lp64f_before_plugin_all_symbols_read,
  gldelf64lriscv_lp64f_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf64lriscv_lp64f_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  riscv_elf_before_allocation,
  gldelf64lriscv_lp64f_get_script,
  "elf64lriscv_lp64f",
  "elf64-littleriscv",
  finish_default,
  ...
  NULL,
  gldelf64lriscv_lp64f_add_options,
  gldelf64lriscv_lp64f_handle_option,
  NULL,
  gldelf64lriscv_lp64f_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
