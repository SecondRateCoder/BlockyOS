...
/* 64 bit ELF emulation code for elf_x86_64_haiku
...
#define TARGET_IS_elf_x86_64_haiku
...
static void gldelf_x86_64_haiku_before_parse (void);
static void gldelf_x86_64_haiku_before_plugin_all_symbols_read
  (void);
static void gldelf_x86_64_haiku_after_open (void);
static void gldelf_x86_64_haiku_before_allocation (void);
static void gldelf_x86_64_haiku_after_allocation (void);
...
elf_x86_before_parse (void)
{
  ...
  gldelf_x86_64_haiku_before_parse ();
}
...
static void
gldelf_x86_64_haiku_before_parse (void)
{
...
static void
gldelf_x86_64_haiku_before_plugin_all_symbols_read (void)
{
...
static void
gldelf_x86_64_haiku_after_open (void)
{
...
static void
gldelf_x86_64_haiku_before_allocation (void)
{
...
static void
gldelf_x86_64_haiku_after_allocation (void)
{
...
static char *
gldelf_x86_64_haiku_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf_x86_64_haiku.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf_x86_64_haiku.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf_x86_64_haiku.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf_x86_64_haiku.xn";
	...
	return "ldscripts/elf_x86_64_haiku.xdwe";
      else
	return "ldscripts/elf_x86_64_haiku.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf_x86_64_haiku.xdce";
      else
	return "ldscripts/elf_x86_64_haiku.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_x86_64_haiku.xde";
      else
	return "ldscripts/elf_x86_64_haiku.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_x86_64_haiku.xswe";
      else
	return "ldscripts/elf_x86_64_haiku.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf_x86_64_haiku.xsce";
      else
	return "ldscripts/elf_x86_64_haiku.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_x86_64_haiku.xse";
      else
	return "ldscripts/elf_x86_64_haiku.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_x86_64_haiku.xwe";
      else
	return "ldscripts/elf_x86_64_haiku.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf_x86_64_haiku.xce";
      else
	return "ldscripts/elf_x86_64_haiku.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf_x86_64_haiku.xe";
      else
	return "ldscripts/elf_x86_64_haiku.x";
    }
}
...
static void
gldelf_x86_64_haiku_add_options
...
static bool
gldelf_x86_64_haiku_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf_x86_64_haiku_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf_x86_64_haiku_emulation =
{
  elf_x86_64_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf_x86_64_haiku_before_plugin_all_symbols_read,
  gldelf_x86_64_haiku_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf_x86_64_haiku_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf_x86_64_haiku_before_allocation,
  gldelf_x86_64_haiku_get_script,
  "elf_x86_64_haiku",
  "elf64-x86-64",
  finish_default,
  ...
  NULL,
  gldelf_x86_64_haiku_add_options,
  gldelf_x86_64_haiku_handle_option,
  NULL,
  gldelf_x86_64_haiku_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
