...
/* 64 bit ELF emulation code for elf64_sparc_fbsd
...
#define TARGET_IS_elf64_sparc_fbsd
...
static void gldelf64_sparc_fbsd_before_parse (void);
static void gldelf64_sparc_fbsd_before_plugin_all_symbols_read
  (void);
static void gldelf64_sparc_fbsd_after_open (void);
static void gldelf64_sparc_fbsd_before_allocation (void);
static void gldelf64_sparc_fbsd_after_allocation (void);


static void
gldelf64_sparc_fbsd_before_parse (void)
{
...
static void
gldelf64_sparc_fbsd_before_plugin_all_symbols_read (void)
{
...
static void
gldelf64_sparc_fbsd_after_open (void)
{
...
static void
gldelf64_sparc_fbsd_before_allocation (void)
{
...
static void
gldelf64_sparc_fbsd_after_allocation (void)
{
...
static char *
gldelf64_sparc_fbsd_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf64_sparc_fbsd.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf64_sparc_fbsd.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf64_sparc_fbsd.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf64_sparc_fbsd.xn";
	...
	return "ldscripts/elf64_sparc_fbsd.xdwe";
      else
	return "ldscripts/elf64_sparc_fbsd.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc_fbsd.xdce";
      else
	return "ldscripts/elf64_sparc_fbsd.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc_fbsd.xde";
      else
	return "ldscripts/elf64_sparc_fbsd.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc_fbsd.xswe";
      else
	return "ldscripts/elf64_sparc_fbsd.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc_fbsd.xsce";
      else
	return "ldscripts/elf64_sparc_fbsd.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc_fbsd.xse";
      else
	return "ldscripts/elf64_sparc_fbsd.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc_fbsd.xwe";
      else
	return "ldscripts/elf64_sparc_fbsd.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc_fbsd.xce";
      else
	return "ldscripts/elf64_sparc_fbsd.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc_fbsd.xe";
      else
	return "ldscripts/elf64_sparc_fbsd.x";
    }
}
...
static void
gldelf64_sparc_fbsd_add_options
...
static bool
gldelf64_sparc_fbsd_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf64_sparc_fbsd_emulation =
{
  gldelf64_sparc_fbsd_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf64_sparc_fbsd_before_plugin_all_symbols_read,
  gldelf64_sparc_fbsd_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf64_sparc_fbsd_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf64_sparc_fbsd_before_allocation,
  gldelf64_sparc_fbsd_get_script,
  "elf64_sparc_fbsd",
  "elf64-sparc-freebsd",
  finish_default,
  NULL,
  ...
  NULL,
  gldelf64_sparc_fbsd_add_options,
  gldelf64_sparc_fbsd_handle_option,
  NULL,
  NULL,
  ldelf_load_symbols,
  NULL,
