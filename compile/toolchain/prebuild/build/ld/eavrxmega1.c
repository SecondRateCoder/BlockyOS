...
/* 32 bit ELF emulation code for avrxmega1
...
static void gldavrxmega1_before_parse (void);
static void gldavrxmega1_before_plugin_all_symbols_read
  (void);
static void gldavrxmega1_after_open (void);
static void gldavrxmega1_before_allocation (void);
static void gldavrxmega1_after_allocation (void);
...
static void
avr_elf_avrxmega1_before_allocation (void)
{
  int ret;

  gldavrxmega1_before_allocation ();
  ...
  if (strcmp ("avrxmega1", "avr6") != 0
      && strcmp ("avrxmega1", "avrxmega6") != 0
      && strcmp ("avrxmega1", "avrxmega7") != 0)
    avr_no_stubs = true;
...
static void
gldavrxmega1_before_parse (void)
{
  ldfile_set_output_arch ("avr:101", bfd_arch_avr);
...
static void
gldavrxmega1_before_plugin_all_symbols_read (void)
{
...
static void
gldavrxmega1_before_allocation (void)
{
...
static void
gldavrxmega1_after_allocation (void)
{
...
static char *
gldavrxmega1_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/avrxmega1.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/avrxmega1.xr";
  else if (!config.text_read_only)
    return "ldscripts/avrxmega1.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/avrxmega1.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/avrxmega1.xe";
      else
	return "ldscripts/avrxmega1.x";
    }
}
...
static bool
gldavrxmega1_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldavrxmega1_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_avrxmega1_emulation =
{
  avr_elf_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldavrxmega1_before_plugin_all_symbols_read,
  gldavrxmega1_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  avr_elf_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  avr_elf_avrxmega1_before_allocation,
  gldavrxmega1_get_script,
  "avrxmega1",
  "elf32-avr",
  avr_finish,
  ...
  NULL,
  gldavrxmega1_add_options,
  gldavrxmega1_handle_option,
  NULL,
  gldavrxmega1_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
