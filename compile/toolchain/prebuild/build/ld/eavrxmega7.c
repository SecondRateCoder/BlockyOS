...
/* 32 bit ELF emulation code for avrxmega7
...
static void gldavrxmega7_before_parse (void);
static void gldavrxmega7_before_plugin_all_symbols_read
  (void);
static void gldavrxmega7_after_open (void);
static void gldavrxmega7_before_allocation (void);
static void gldavrxmega7_after_allocation (void);
...
static void
avr_elf_avrxmega7_before_allocation (void)
{
  int ret;

  gldavrxmega7_before_allocation ();
  ...
  if (strcmp ("avrxmega7", "avr6") != 0
      && strcmp ("avrxmega7", "avrxmega6") != 0
      && strcmp ("avrxmega7", "avrxmega7") != 0)
    avr_no_stubs = true;
...
static void
gldavrxmega7_before_parse (void)
{
  ldfile_set_output_arch ("avr:107", bfd_arch_avr);
...
static void
gldavrxmega7_before_plugin_all_symbols_read (void)
{
...
static void
gldavrxmega7_before_allocation (void)
{
...
static void
gldavrxmega7_after_allocation (void)
{
...
static char *
gldavrxmega7_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/avrxmega7.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/avrxmega7.xr";
  else if (!config.text_read_only)
    return "ldscripts/avrxmega7.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/avrxmega7.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/avrxmega7.xe";
      else
	return "ldscripts/avrxmega7.x";
    }
}
...
static bool
gldavrxmega7_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldavrxmega7_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_avrxmega7_emulation =
{
  avr_elf_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldavrxmega7_before_plugin_all_symbols_read,
  gldavrxmega7_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  avr_elf_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  avr_elf_avrxmega7_before_allocation,
  gldavrxmega7_get_script,
  "avrxmega7",
  "elf32-avr",
  avr_finish,
  ...
  NULL,
  gldavrxmega7_add_options,
  gldavrxmega7_handle_option,
  NULL,
  gldavrxmega7_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
