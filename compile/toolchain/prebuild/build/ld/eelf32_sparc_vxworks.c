...
/* 32 bit ELF emulation code for elf32_sparc_vxworks
...
#define TARGET_IS_elf32_sparc_vxworks
...
static void gldelf32_sparc_vxworks_before_parse (void);
static void gldelf32_sparc_vxworks_before_plugin_all_symbols_read
  (void);
static void gldelf32_sparc_vxworks_after_open (void);
static void gldelf32_sparc_vxworks_before_allocation (void);
static void gldelf32_sparc_vxworks_after_allocation (void);
...
{
  gldelf32_sparc_vxworks_before_parse ();
...
{
  gldelf32_sparc_vxworks_after_open ();
...
static void
gldelf32_sparc_vxworks_before_parse (void)
{
  ldfile_set_output_arch ("sparc", bfd_arch_sparc);
...
static void
gldelf32_sparc_vxworks_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32_sparc_vxworks_after_open (void)
{
...
static void
gldelf32_sparc_vxworks_before_allocation (void)
{
...
static void
gldelf32_sparc_vxworks_after_allocation (void)
{
...
static char *
gldelf32_sparc_vxworks_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32_sparc_vxworks.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32_sparc_vxworks.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32_sparc_vxworks.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32_sparc_vxworks.xn";
	...
	return "ldscripts/elf32_sparc_vxworks.xdwe";
      else
	return "ldscripts/elf32_sparc_vxworks.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_sparc_vxworks.xdce";
      else
	return "ldscripts/elf32_sparc_vxworks.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_sparc_vxworks.xde";
      else
	return "ldscripts/elf32_sparc_vxworks.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_sparc_vxworks.xswe";
      else
	return "ldscripts/elf32_sparc_vxworks.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_sparc_vxworks.xsce";
      else
	return "ldscripts/elf32_sparc_vxworks.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_sparc_vxworks.xse";
      else
	return "ldscripts/elf32_sparc_vxworks.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_sparc_vxworks.xwe";
      else
	return "ldscripts/elf32_sparc_vxworks.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_sparc_vxworks.xce";
      else
	return "ldscripts/elf32_sparc_vxworks.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_sparc_vxworks.xe";
      else
	return "ldscripts/elf32_sparc_vxworks.x";
    }
}
...
static void
gldelf32_sparc_vxworks_add_options
...
static bool
gldelf32_sparc_vxworks_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32_sparc_vxworks_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32_sparc_vxworks_emulation =
{
  vxworks_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32_sparc_vxworks_before_plugin_all_symbols_read,
  vxworks_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32_sparc_vxworks_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32_sparc_vxworks_before_allocation,
  gldelf32_sparc_vxworks_get_script,
  "elf32_sparc_vxworks",
  "elf32-sparc-vxworks",
  finish_default,
  NULL,
  ...
  NULL,
  gldelf32_sparc_vxworks_add_options,
  gldelf32_sparc_vxworks_handle_option,
  NULL,
  gldelf32_sparc_vxworks_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
