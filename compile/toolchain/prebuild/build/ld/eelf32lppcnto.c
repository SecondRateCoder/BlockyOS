...
/* 32 bit ELF emulation code for elf32lppcnto
...
static void gldelf32lppcnto_before_parse (void);
static void gldelf32lppcnto_before_plugin_all_symbols_read
  (void);
static void gldelf32lppcnto_after_open (void);
static void gldelf32lppcnto_before_allocation (void);
static void gldelf32lppcnto_after_allocation (void);
...
ppc_before_allocation (void)
{
  ...
  gldelf32lppcnto_before_allocation ();
  ...
  /* Turn on relaxation if executable sections have addresses that
  ...
  else if (!RELAXATION_DISABLED_BY_USER)
    {
	 ...
	 up gldelf32lppcnto_before_allocation sizing.  This
...
static void
gldelf32lppcnto_before_parse (void)
{
...
static void
gldelf32lppcnto_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32lppcnto_after_open (void)
{
...
static void
gldelf32lppcnto_before_allocation (void)
{
...
static void
gldelf32lppcnto_after_allocation (void)
{
...
static char *
gldelf32lppcnto_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32lppcnto.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32lppcnto.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32lppcnto.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32lppcnto.xn";
	...
	return "ldscripts/elf32lppcnto.xdwe";
      else
	return "ldscripts/elf32lppcnto.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppcnto.xdce";
      else
	return "ldscripts/elf32lppcnto.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppcnto.xde";
      else
	return "ldscripts/elf32lppcnto.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppcnto.xswe";
      else
	return "ldscripts/elf32lppcnto.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppcnto.xsce";
      else
	return "ldscripts/elf32lppcnto.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppcnto.xse";
      else
	return "ldscripts/elf32lppcnto.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppcnto.xwe";
      else
	return "ldscripts/elf32lppcnto.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppcnto.xce";
      else
	return "ldscripts/elf32lppcnto.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppcnto.xe";
      else
	return "ldscripts/elf32lppcnto.x";
    }
}
...
static bool
gldelf32lppcnto_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32lppcnto_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32lppcnto_emulation =
{
  gldelf32lppcnto_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32lppcnto_before_plugin_all_symbols_read,
  gldelf32lppcnto_after_open,
  ppc_after_check_relocs,
  ldelf_before_place_orphans,
  gldelf32lppcnto_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  ppc_before_allocation,
  gldelf32lppcnto_get_script,
  "elf32lppcnto",
  "elf32-powerpcle",
  ppc_finish,
  ...
  NULL,
  gldelf32lppcnto_add_options,
  gldelf32lppcnto_handle_option,
  NULL,
  gldelf32lppcnto_list_options,
  ppc_recognized_file,
  NULL,
  NULL,
  NULL,
