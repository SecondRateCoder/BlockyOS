...
/* 64 bit ELF emulation code for elf64_sparc_sol2
...
#define TARGET_IS_elf64_sparc_sol2
...
static void gldelf64_sparc_sol2_before_parse (void);
static void gldelf64_sparc_sol2_before_plugin_all_symbols_read
  (void);
static void gldelf64_sparc_sol2_after_open (void);
static void gldelf64_sparc_sol2_before_allocation (void);
static void gldelf64_sparc_sol2_after_allocation (void);

/* This file is generated by a shell script.  DO NOT EDIT! */

/* Solaris 2 emulation code for elf64_sparc_sol2
...
elf_solaris2_before_allocation (void)
{
  ...
  gldelf64_sparc_sol2_before_allocation ();
}


static void
gldelf64_sparc_sol2_before_parse (void)
{
...
static void
gldelf64_sparc_sol2_before_plugin_all_symbols_read (void)
{
...
static void
gldelf64_sparc_sol2_after_open (void)
{
...
static void
gldelf64_sparc_sol2_before_allocation (void)
{
...
static void
gldelf64_sparc_sol2_after_allocation (void)
{
...
static char *
gldelf64_sparc_sol2_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf64_sparc_sol2.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf64_sparc_sol2.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf64_sparc_sol2.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf64_sparc_sol2.xn";
	...
	return "ldscripts/elf64_sparc_sol2.xdwe";
      else
	return "ldscripts/elf64_sparc_sol2.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc_sol2.xdce";
      else
	return "ldscripts/elf64_sparc_sol2.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc_sol2.xde";
      else
	return "ldscripts/elf64_sparc_sol2.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc_sol2.xswe";
      else
	return "ldscripts/elf64_sparc_sol2.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc_sol2.xsce";
      else
	return "ldscripts/elf64_sparc_sol2.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc_sol2.xse";
      else
	return "ldscripts/elf64_sparc_sol2.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc_sol2.xwe";
      else
	return "ldscripts/elf64_sparc_sol2.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc_sol2.xce";
      else
	return "ldscripts/elf64_sparc_sol2.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc_sol2.xe";
      else
	return "ldscripts/elf64_sparc_sol2.x";
    }
}
...
static void
gldelf64_sparc_sol2_add_options
...
static bool
gldelf64_sparc_sol2_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf64_sparc_sol2_emulation =
{
  gldelf64_sparc_sol2_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf64_sparc_sol2_before_plugin_all_symbols_read,
  gldelf64_sparc_sol2_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf64_sparc_sol2_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  elf_solaris2_before_allocation,
  gldelf64_sparc_sol2_get_script,
  "elf64_sparc_sol2",
  "elf64-sparc-sol2",
  finish_default,
  NULL,
  ...
  NULL,
  gldelf64_sparc_sol2_add_options,
  gldelf64_sparc_sol2_handle_option,
  NULL,
  NULL,
  ldelf_load_symbols,
  NULL,
