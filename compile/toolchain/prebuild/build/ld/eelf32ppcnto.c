...
/* 32 bit ELF emulation code for elf32ppcnto
...
static void gldelf32ppcnto_before_parse (void);
static void gldelf32ppcnto_before_plugin_all_symbols_read
  (void);
static void gldelf32ppcnto_after_open (void);
static void gldelf32ppcnto_before_allocation (void);
static void gldelf32ppcnto_after_allocation (void);
...
ppc_before_allocation (void)
{
  ...
  gldelf32ppcnto_before_allocation ();
  ...
  /* Turn on relaxation if executable sections have addresses that
  ...
  else if (!RELAXATION_DISABLED_BY_USER)
    {
	 ...
	 up gldelf32ppcnto_before_allocation sizing.  This
...
static void
gldelf32ppcnto_before_parse (void)
{
...
static void
gldelf32ppcnto_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32ppcnto_after_open (void)
{
...
static void
gldelf32ppcnto_before_allocation (void)
{
...
static void
gldelf32ppcnto_after_allocation (void)
{
...
static char *
gldelf32ppcnto_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32ppcnto.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32ppcnto.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32ppcnto.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32ppcnto.xn";
	...
	return "ldscripts/elf32ppcnto.xdwe";
      else
	return "ldscripts/elf32ppcnto.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcnto.xdce";
      else
	return "ldscripts/elf32ppcnto.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcnto.xde";
      else
	return "ldscripts/elf32ppcnto.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcnto.xswe";
      else
	return "ldscripts/elf32ppcnto.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcnto.xsce";
      else
	return "ldscripts/elf32ppcnto.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcnto.xse";
      else
	return "ldscripts/elf32ppcnto.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcnto.xwe";
      else
	return "ldscripts/elf32ppcnto.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcnto.xce";
      else
	return "ldscripts/elf32ppcnto.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcnto.xe";
      else
	return "ldscripts/elf32ppcnto.x";
    }
}
...
static bool
gldelf32ppcnto_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32ppcnto_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32ppcnto_emulation =
{
  gldelf32ppcnto_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32ppcnto_before_plugin_all_symbols_read,
  gldelf32ppcnto_after_open,
  ppc_after_check_relocs,
  ldelf_before_place_orphans,
  gldelf32ppcnto_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  ppc_before_allocation,
  gldelf32ppcnto_get_script,
  "elf32ppcnto",
  "elf32-powerpc",
  ppc_finish,
  ...
  NULL,
  gldelf32ppcnto_add_options,
  gldelf32ppcnto_handle_option,
  NULL,
  gldelf32ppcnto_list_options,
  ppc_recognized_file,
  NULL,
  NULL,
  NULL,
