...
/* 64 bit ELF emulation code for elf64_s390
...
static void gldelf64_s390_before_parse (void);
static void gldelf64_s390_before_plugin_all_symbols_read
  (void);
static void gldelf64_s390_after_open (void);
static void gldelf64_s390_before_allocation (void);
static void gldelf64_s390_after_allocation (void);
...
static void
gldelf64_s390_before_parse (void)
{
  ldfile_set_output_arch ("s390:64-bit", bfd_arch_s390);
...
static void
gldelf64_s390_before_plugin_all_symbols_read (void)
{
...
static void
gldelf64_s390_before_allocation (void)
{
...
static void
gldelf64_s390_after_allocation (void)
{
...
static char *
gldelf64_s390_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf64_s390.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf64_s390.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf64_s390.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf64_s390.xn";
	...
	return "ldscripts/elf64_s390.xdwe";
      else
	return "ldscripts/elf64_s390.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc
	   && link_info.relro)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_s390.xdceo";
      else
	return "ldscripts/elf64_s390.xdco";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_s390.xdce";
      else
	return "ldscripts/elf64_s390.xdc";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.relro)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_s390.xdeo";
      else
	return "ldscripts/elf64_s390.xdo";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_s390.xde";
      else
	return "ldscripts/elf64_s390.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_s390.xswe";
      else
	return "ldscripts/elf64_s390.xsw";
    }
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_s390.xsceo";
      else
	return "ldscripts/elf64_s390.xsco";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_s390.xsce";
      else
	return "ldscripts/elf64_s390.xsc";
    }
  else if (bfd_link_dll (&link_info)
	   && link_info.relro)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_s390.xseo";
      else
	return "ldscripts/elf64_s390.xso";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_s390.xse";
      else
	return "ldscripts/elf64_s390.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_s390.xwe";
      else
	return "ldscripts/elf64_s390.xw";
    }
  else if (link_info.combreloc
	   && link_info.relro)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_s390.xceo";
      else
	return "ldscripts/elf64_s390.xco";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_s390.xce";
      else
	return "ldscripts/elf64_s390.xc";
    }
  else if (link_info.relro)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_s390.xeo";
      else
	return "ldscripts/elf64_s390.xo";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_s390.xe";
      else
	return "ldscripts/elf64_s390.x";
    }
}
...
static bool
gldelf64_s390_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf64_s390_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf64_s390_emulation =
{
  gldelf64_s390_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf64_s390_before_plugin_all_symbols_read,
  gldelf64_s390_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf64_s390_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf64_s390_before_allocation,
  gldelf64_s390_get_script,
  "elf64_s390",
  "elf64-s390",
  finish_default,
  ...
  NULL,
  gldelf64_s390_add_options,
  gldelf64_s390_handle_option,
  NULL,
  gldelf64_s390_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
