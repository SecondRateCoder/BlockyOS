...
/* 32 bit ELF emulation code for shlelf_nto
...
static void gldshlelf_nto_before_parse (void);
static void gldshlelf_nto_before_plugin_all_symbols_read
  (void);
static void gldshlelf_nto_after_open (void);
static void gldshlelf_nto_before_allocation (void);
static void gldshlelf_nto_after_allocation (void);


static void
gldshlelf_nto_before_parse (void)
{
...
static void
gldshlelf_nto_before_plugin_all_symbols_read (void)
{
...
static void
gldshlelf_nto_before_allocation (void)
{
...
static void
gldshlelf_nto_after_allocation (void)
{
...
static char *
gldshlelf_nto_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/shlelf_nto.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/shlelf_nto.xr";
  else if (!config.text_read_only)
    return "ldscripts/shlelf_nto.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/shlelf_nto.xn";
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_nto.xswe";
      else
	return "ldscripts/shlelf_nto.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_nto.xsce";
      else
	return "ldscripts/shlelf_nto.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_nto.xse";
      else
	return "ldscripts/shlelf_nto.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_nto.xwe";
      else
	return "ldscripts/shlelf_nto.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_nto.xce";
      else
	return "ldscripts/shlelf_nto.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_nto.xe";
      else
	return "ldscripts/shlelf_nto.x";
    }
}
...
static bool
gldshlelf_nto_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_shlelf_nto_emulation =
{
  gldshlelf_nto_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldshlelf_nto_before_plugin_all_symbols_read,
  gldshlelf_nto_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldshlelf_nto_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldshlelf_nto_before_allocation,
  gldshlelf_nto_get_script,
  "shlelf_nto",
  "elf32-shl",
  finish_default,
  NULL,
