...
/* 32 bit ELF emulation code for elf32elmip
...
static void gldelf32elmip_before_parse (void);
static void gldelf32elmip_before_plugin_all_symbols_read
  (void);
static void gldelf32elmip_after_open (void);
static void gldelf32elmip_before_allocation (void);
static void gldelf32elmip_after_allocation (void);
...
mips_before_allocation (void)
{
  ...
  gldelf32elmip_before_allocation ();
}


static void
gldelf32elmip_before_parse (void)
{
...
static void
gldelf32elmip_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32elmip_before_allocation (void)
{
...
static void
gldelf32elmip_after_allocation (void)
{
...
static char *
gldelf32elmip_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32elmip.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32elmip.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32elmip.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32elmip.xn";
	...
	return "ldscripts/elf32elmip.xdwe";
      else
	return "ldscripts/elf32elmip.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32elmip.xdce";
      else
	return "ldscripts/elf32elmip.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32elmip.xde";
      else
	return "ldscripts/elf32elmip.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32elmip.xswe";
      else
	return "ldscripts/elf32elmip.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32elmip.xsce";
      else
	return "ldscripts/elf32elmip.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32elmip.xse";
      else
	return "ldscripts/elf32elmip.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32elmip.xwe";
      else
	return "ldscripts/elf32elmip.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32elmip.xce";
      else
	return "ldscripts/elf32elmip.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32elmip.xe";
      else
	return "ldscripts/elf32elmip.x";
    }
}
...
static bool
gldelf32elmip_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32elmip_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32elmip_emulation =
{
  gldelf32elmip_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32elmip_before_plugin_all_symbols_read,
  gldelf32elmip_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32elmip_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  mips_before_allocation,
  gldelf32elmip_get_script,
  "elf32elmip",
  "elf32-littlemips",
  finish_default,
  ...
  NULL,
  gldelf32elmip_add_options,
  gldelf32elmip_handle_option,
  NULL,
  gldelf32elmip_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
