...
/* 32 bit ELF emulation code for elf32rl78
...
static void gldelf32rl78_before_parse (void);
static void gldelf32rl78_before_plugin_all_symbols_read
  (void);
static void gldelf32rl78_after_open (void);
static void gldelf32rl78_before_allocation (void);
static void gldelf32rl78_after_allocation (void);


static void
gldelf32rl78_before_parse (void)
{
  ldfile_set_output_arch ("rl78", bfd_arch_rl78);
...
static void
gldelf32rl78_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32rl78_before_allocation (void)
{
...
static void
gldelf32rl78_after_allocation (void)
{
...
static char *
gldelf32rl78_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32rl78.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32rl78.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32rl78.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32rl78.xn";
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32rl78.xwe";
      else
	return "ldscripts/elf32rl78.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32rl78.xce";
      else
	return "ldscripts/elf32rl78.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32rl78.xe";
      else
	return "ldscripts/elf32rl78.x";
    }
}
...
static bool
gldelf32rl78_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf32rl78_emulation =
{
  gldelf32rl78_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32rl78_before_plugin_all_symbols_read,
  gldelf32rl78_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32rl78_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32rl78_before_allocation,
  gldelf32rl78_get_script,
  "elf32rl78",
  "elf32-rl78",
  finish_default,
  NULL,
