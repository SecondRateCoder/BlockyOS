...
/* 32 bit ELF emulation code for elf32tilegx
...
static void gldelf32tilegx_before_parse (void);
static void gldelf32tilegx_before_plugin_all_symbols_read
  (void);
static void gldelf32tilegx_after_open (void);
static void gldelf32tilegx_before_allocation (void);
static void gldelf32tilegx_after_allocation (void);


static void
gldelf32tilegx_before_parse (void)
{
...
static void
gldelf32tilegx_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32tilegx_after_open (void)
{
...
static void
gldelf32tilegx_before_allocation (void)
{
...
static void
gldelf32tilegx_after_allocation (void)
{
...
static char *
gldelf32tilegx_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32tilegx.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32tilegx.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32tilegx.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32tilegx.xn";
	...
	return "ldscripts/elf32tilegx.xdwe";
      else
	return "ldscripts/elf32tilegx.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32tilegx.xdce";
      else
	return "ldscripts/elf32tilegx.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32tilegx.xde";
      else
	return "ldscripts/elf32tilegx.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32tilegx.xswe";
      else
	return "ldscripts/elf32tilegx.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32tilegx.xsce";
      else
	return "ldscripts/elf32tilegx.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32tilegx.xse";
      else
	return "ldscripts/elf32tilegx.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32tilegx.xwe";
      else
	return "ldscripts/elf32tilegx.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32tilegx.xce";
      else
	return "ldscripts/elf32tilegx.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32tilegx.xe";
      else
	return "ldscripts/elf32tilegx.x";
    }
}
...
static bool
gldelf32tilegx_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf32tilegx_emulation =
{
  gldelf32tilegx_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32tilegx_before_plugin_all_symbols_read,
  gldelf32tilegx_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32tilegx_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32tilegx_before_allocation,
  gldelf32tilegx_get_script,
  "elf32tilegx",
  "elf32-tilegx-le",
  finish_default,
  NULL,
