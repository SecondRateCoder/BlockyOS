...
/* 32 bit ELF emulation code for shelf_vxworks
...
#define TARGET_IS_shelf_vxworks
...
static void gldshelf_vxworks_before_parse (void);
static void gldshelf_vxworks_before_plugin_all_symbols_read
  (void);
static void gldshelf_vxworks_after_open (void);
static void gldshelf_vxworks_before_allocation (void);
static void gldshelf_vxworks_after_allocation (void);
...
static void
gldshelf_vxworks_before_parse (void)
{
...
static void
gldshelf_vxworks_before_plugin_all_symbols_read (void)
{
...
static void
gldshelf_vxworks_after_open (void)
{
...
static void
gldshelf_vxworks_before_allocation (void)
{
...
static void
gldshelf_vxworks_after_allocation (void)
{
...
static char *
gldshelf_vxworks_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/shelf_vxworks.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/shelf_vxworks.xr";
  else if (!config.text_read_only)
    return "ldscripts/shelf_vxworks.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/shelf_vxworks.xn";
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/shelf_vxworks.xswe";
      else
	return "ldscripts/shelf_vxworks.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/shelf_vxworks.xsce";
      else
	return "ldscripts/shelf_vxworks.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/shelf_vxworks.xse";
      else
	return "ldscripts/shelf_vxworks.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/shelf_vxworks.xwe";
      else
	return "ldscripts/shelf_vxworks.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/shelf_vxworks.xce";
      else
	return "ldscripts/shelf_vxworks.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/shelf_vxworks.xe";
      else
	return "ldscripts/shelf_vxworks.x";
    }
}
...
static bool
gldshelf_vxworks_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldshelf_vxworks_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_shelf_vxworks_emulation =
{
  vxworks_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldshelf_vxworks_before_plugin_all_symbols_read,
  vxworks_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldshelf_vxworks_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldshelf_vxworks_before_allocation,
  gldshelf_vxworks_get_script,
  "shelf_vxworks",
  "elf32-sh-vxworks",
  finish_default,
  NULL,
  ...
  NULL,
  gldshelf_vxworks_add_options,
  gldshelf_vxworks_handle_option,
  NULL,
  gldshelf_vxworks_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
