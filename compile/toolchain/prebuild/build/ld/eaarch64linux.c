...
static void gldaarch64linux_before_plugin_all_symbols_read
  (void);
...
static void
gldaarch64linux_before_plugin_all_symbols_read (void)
{
...
{
  ldelf_before_allocation (audit, depaudit, "/lib/ld-linux-aarch64.so.1");
}
...
gldaarch64linux_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/aarch64linux.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/aarch64linux.xr";
  else if (!config.text_read_only)
    return "ldscripts/aarch64linux.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/aarch64linux.xn";
	...
	return "ldscripts/aarch64linux.xdwe";
      else
	return "ldscripts/aarch64linux.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux.xdce";
      else
	return "ldscripts/aarch64linux.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux.xde";
      else
	return "ldscripts/aarch64linux.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux.xswe";
      else
	return "ldscripts/aarch64linux.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux.xsce";
      else
	return "ldscripts/aarch64linux.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux.xse";
      else
	return "ldscripts/aarch64linux.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux.xwe";
      else
	return "ldscripts/aarch64linux.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux.xce";
      else
	return "ldscripts/aarch64linux.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux.xe";
      else
	return "ldscripts/aarch64linux.x";
    }
}
...
struct ld_emulation_xfer_struct ld_aarch64linux_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldaarch64linux_before_plugin_all_symbols_read,
