...
/* 32 bit ELF emulation code for elf32frvfd
...
static void gldelf32frvfd_before_parse (void);
static void gldelf32frvfd_before_plugin_all_symbols_read
  (void);
static void gldelf32frvfd_after_open (void);
static void gldelf32frvfd_before_allocation (void);
static void gldelf32frvfd_after_allocation (void);


static void
gldelf32frvfd_before_parse (void)
{
  ldfile_set_output_arch ("frv", bfd_arch_frv);
...
static void
gldelf32frvfd_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32frvfd_before_allocation (void)
{
...
static void
gldelf32frvfd_after_allocation (void)
{
...
static char *
gldelf32frvfd_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32frvfd.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32frvfd.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32frvfd.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32frvfd.xn";
	...
	return "ldscripts/elf32frvfd.xdwe";
      else
	return "ldscripts/elf32frvfd.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32frvfd.xdce";
      else
	return "ldscripts/elf32frvfd.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32frvfd.xde";
      else
	return "ldscripts/elf32frvfd.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32frvfd.xswe";
      else
	return "ldscripts/elf32frvfd.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32frvfd.xsce";
      else
	return "ldscripts/elf32frvfd.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32frvfd.xse";
      else
	return "ldscripts/elf32frvfd.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32frvfd.xwe";
      else
	return "ldscripts/elf32frvfd.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32frvfd.xce";
      else
	return "ldscripts/elf32frvfd.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32frvfd.xe";
      else
	return "ldscripts/elf32frvfd.x";
    }
}
...
static bool
gldelf32frvfd_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf32frvfd_emulation =
{
  gldelf32frvfd_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32frvfd_before_plugin_all_symbols_read,
  gldelf32frvfd_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32frvfd_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32frvfd_before_allocation,
  gldelf32frvfd_get_script,
  "elf32frvfd",
  "elf32-frvfdpic",
  finish_default,
  NULL,
