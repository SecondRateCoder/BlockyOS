...
static void gldarmelfb_linux_eabi_before_plugin_all_symbols_read
  (void);
...
static void
gldarmelfb_linux_eabi_before_plugin_all_symbols_read (void)
{
...
gldarmelfb_linux_eabi_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/armelfb_linux_eabi.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/armelfb_linux_eabi.xr";
  else if (!config.text_read_only)
    return "ldscripts/armelfb_linux_eabi.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/armelfb_linux_eabi.xn";
	...
	return "ldscripts/armelfb_linux_eabi.xdwe";
      else
	return "ldscripts/armelfb_linux_eabi.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux_eabi.xdce";
      else
	return "ldscripts/armelfb_linux_eabi.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux_eabi.xde";
      else
	return "ldscripts/armelfb_linux_eabi.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux_eabi.xswe";
      else
	return "ldscripts/armelfb_linux_eabi.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux_eabi.xsce";
      else
	return "ldscripts/armelfb_linux_eabi.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux_eabi.xse";
      else
	return "ldscripts/armelfb_linux_eabi.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux_eabi.xwe";
      else
	return "ldscripts/armelfb_linux_eabi.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux_eabi.xce";
      else
	return "ldscripts/armelfb_linux_eabi.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux_eabi.xe";
      else
	return "ldscripts/armelfb_linux_eabi.x";
    }
}
...
struct ld_emulation_xfer_struct ld_armelfb_linux_eabi_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldarmelfb_linux_eabi_before_plugin_all_symbols_read,
