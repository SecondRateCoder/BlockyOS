...
gldaarch64linuxb_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/aarch64linuxb.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/aarch64linuxb.xr";
  else if (!config.text_read_only)
    return "ldscripts/aarch64linuxb.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/aarch64linuxb.xn";
	...
	return "ldscripts/aarch64linuxb.xdwe";
      else
	return "ldscripts/aarch64linuxb.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linuxb.xdce";
      else
	return "ldscripts/aarch64linuxb.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linuxb.xde";
      else
	return "ldscripts/aarch64linuxb.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linuxb.xswe";
      else
	return "ldscripts/aarch64linuxb.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linuxb.xsce";
      else
	return "ldscripts/aarch64linuxb.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linuxb.xse";
      else
	return "ldscripts/aarch64linuxb.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linuxb.xwe";
      else
	return "ldscripts/aarch64linuxb.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linuxb.xce";
      else
	return "ldscripts/aarch64linuxb.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linuxb.xe";
      else
	return "ldscripts/aarch64linuxb.x";
    }
}
