...
/* 32 bit ELF emulation code for armelfb_nbsd
...
static void gldarmelfb_nbsd_before_parse (void);
static void gldarmelfb_nbsd_before_plugin_all_symbols_read
  (void);
static void gldarmelfb_nbsd_after_open (void);
static void gldarmelfb_nbsd_before_allocation (void);
static void gldarmelfb_nbsd_after_allocation (void);
...
static void
gldarmelfb_nbsd_before_parse (void)
{
...
static void
gldarmelfb_nbsd_set_symbols (void)
{
...
arm_elf_before_allocation (void)
{
  ...
  gldarmelfb_nbsd_before_allocation ();
}
...
static void
gldarmelfb_nbsd_after_allocation (void)
{
  int ret;
...
static void
gldarmelfb_nbsd_before_plugin_all_symbols_read (void)
{
...
static void
gldarmelfb_nbsd_after_open (void)
{
...
static void
gldarmelfb_nbsd_before_allocation (void)
{
...
static char *
gldarmelfb_nbsd_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/armelfb_nbsd.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/armelfb_nbsd.xr";
  else if (!config.text_read_only)
    return "ldscripts/armelfb_nbsd.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/armelfb_nbsd.xn";
	...
	return "ldscripts/armelfb_nbsd.xdwe";
      else
	return "ldscripts/armelfb_nbsd.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_nbsd.xdce";
      else
	return "ldscripts/armelfb_nbsd.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_nbsd.xde";
      else
	return "ldscripts/armelfb_nbsd.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_nbsd.xswe";
      else
	return "ldscripts/armelfb_nbsd.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_nbsd.xsce";
      else
	return "ldscripts/armelfb_nbsd.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_nbsd.xse";
      else
	return "ldscripts/armelfb_nbsd.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_nbsd.xwe";
      else
	return "ldscripts/armelfb_nbsd.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_nbsd.xce";
      else
	return "ldscripts/armelfb_nbsd.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_nbsd.xe";
      else
	return "ldscripts/armelfb_nbsd.x";
    }
}
...
static bool
gldarmelfb_nbsd_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldarmelfb_nbsd_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_armelfb_nbsd_emulation =
{
  gldarmelfb_nbsd_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldarmelfb_nbsd_before_plugin_all_symbols_read,
  gldarmelfb_nbsd_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldarmelfb_nbsd_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  arm_elf_before_allocation,
  gldarmelfb_nbsd_get_script,
  "armelfb_nbsd",
  "elf32-bigarm",
  gldarmelfb_nbsd_finish,
  arm_elf_create_output_section_statements,
  ldelf_open_dynamic_archive,
  ldelf_place_orphan,
  gldarmelfb_nbsd_set_symbols,
  NULL,
  gldarmelfb_nbsd_add_options,
  gldarmelfb_nbsd_handle_option,
  NULL,
  gldarmelfb_nbsd_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
