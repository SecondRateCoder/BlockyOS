...
/* 32 bit ELF emulation code for h8300helf
...
static void gldh8300helf_before_parse (void);
static void gldh8300helf_before_plugin_all_symbols_read
  (void);
static void gldh8300helf_after_open (void);
static void gldh8300helf_before_allocation (void);
static void gldh8300helf_after_allocation (void);


static void
gldh8300helf_before_parse (void)
{
...
static void
gldh8300helf_before_plugin_all_symbols_read (void)
{
...
static void
gldh8300helf_before_allocation (void)
{
...
static void
gldh8300helf_after_allocation (void)
{
...
static char *
gldh8300helf_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/h8300helf.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/h8300helf.xr";
  else if (!config.text_read_only)
    return "ldscripts/h8300helf.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/h8300helf.xn";
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/h8300helf.xwe";
      else
	return "ldscripts/h8300helf.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/h8300helf.xce";
      else
	return "ldscripts/h8300helf.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/h8300helf.xe";
      else
	return "ldscripts/h8300helf.x";
    }
}
...
static bool
gldh8300helf_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_h8300helf_emulation =
{
  gldh8300helf_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldh8300helf_before_plugin_all_symbols_read,
  gldh8300helf_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldh8300helf_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldh8300helf_before_allocation,
  gldh8300helf_get_script,
  "h8300helf",
  "elf32-h8300",
  finish_default,
  NULL,
