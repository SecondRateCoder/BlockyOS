...
/* 32 bit ELF emulation code for armelfb_fuchsia
...
#define TARGET_IS_armelfb_fuchsia
...
static void gldarmelfb_fuchsia_before_parse (void);
static void gldarmelfb_fuchsia_before_plugin_all_symbols_read
  (void);
static void gldarmelfb_fuchsia_after_open (void);
static void gldarmelfb_fuchsia_before_allocation (void);
static void gldarmelfb_fuchsia_after_allocation (void);
...
static void
gldarmelfb_fuchsia_before_parse (void)
{
...
static void
gldarmelfb_fuchsia_set_symbols (void)
{
...
arm_elf_before_allocation (void)
{
  ...
  gldarmelfb_fuchsia_before_allocation ();
}
...
static void
gldarmelfb_fuchsia_after_allocation (void)
{
  int ret;
...
static void
gldarmelfb_fuchsia_finish (void)
{
...
static void
gldarmelfb_fuchsia_before_plugin_all_symbols_read (void)
{
...
static void
gldarmelfb_fuchsia_after_open (void)
{
...
static void
gldarmelfb_fuchsia_before_allocation (void)
{
...
static char *
gldarmelfb_fuchsia_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/armelfb_fuchsia.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/armelfb_fuchsia.xr";
  else if (!config.text_read_only)
    return "ldscripts/armelfb_fuchsia.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/armelfb_fuchsia.xn";
	...
	return "ldscripts/armelfb_fuchsia.xdwe";
      else
	return "ldscripts/armelfb_fuchsia.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_fuchsia.xdce";
      else
	return "ldscripts/armelfb_fuchsia.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_fuchsia.xde";
      else
	return "ldscripts/armelfb_fuchsia.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_fuchsia.xswe";
      else
	return "ldscripts/armelfb_fuchsia.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_fuchsia.xsce";
      else
	return "ldscripts/armelfb_fuchsia.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_fuchsia.xse";
      else
	return "ldscripts/armelfb_fuchsia.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_fuchsia.xwe";
      else
	return "ldscripts/armelfb_fuchsia.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_fuchsia.xce";
      else
	return "ldscripts/armelfb_fuchsia.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_fuchsia.xe";
      else
	return "ldscripts/armelfb_fuchsia.x";
    }
}
...
static void
gldarmelfb_fuchsia_add_options
...
static bool
gldarmelfb_fuchsia_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldarmelfb_fuchsia_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_armelfb_fuchsia_emulation =
{
  gldarmelfb_fuchsia_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldarmelfb_fuchsia_before_plugin_all_symbols_read,
  gldarmelfb_fuchsia_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldarmelfb_fuchsia_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  arm_elf_before_allocation,
  gldarmelfb_fuchsia_get_script,
  "armelfb_fuchsia",
  "elf32-bigarm",
  gldarmelfb_fuchsia_finish,
  arm_elf_create_output_section_statements,
  ldelf_open_dynamic_archive,
  ldelf_place_orphan,
  gldarmelfb_fuchsia_set_symbols,
  NULL,
  gldarmelfb_fuchsia_add_options,
  gldarmelfb_fuchsia_handle_option,
  NULL,
  gldarmelfb_fuchsia_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
