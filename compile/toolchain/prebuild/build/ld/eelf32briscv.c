...
gldelf32briscv_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32briscv.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32briscv.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32briscv.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32briscv.xn";
	...
	return "ldscripts/elf32briscv.xdwe";
      else
	return "ldscripts/elf32briscv.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32briscv.xdce";
      else
	return "ldscripts/elf32briscv.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32briscv.xde";
      else
	return "ldscripts/elf32briscv.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32briscv.xswe";
      else
	return "ldscripts/elf32briscv.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32briscv.xsce";
      else
	return "ldscripts/elf32briscv.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32briscv.xse";
      else
	return "ldscripts/elf32briscv.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32briscv.xwe";
      else
	return "ldscripts/elf32briscv.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32briscv.xce";
      else
	return "ldscripts/elf32briscv.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32briscv.xe";
      else
	return "ldscripts/elf32briscv.x";
    }
}
