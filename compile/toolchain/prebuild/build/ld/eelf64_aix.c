...
/* 64 bit ELF emulation code for elf64_aix
...
static void gldelf64_aix_before_parse (void);
static void gldelf64_aix_before_plugin_all_symbols_read
  (void);
static void gldelf64_aix_after_open (void);
static void gldelf64_aix_before_allocation (void);
static void gldelf64_aix_after_allocation (void);


static void
gldelf64_aix_before_parse (void)
{
...
static void
gldelf64_aix_before_plugin_all_symbols_read (void)
{
...
static void
gldelf64_aix_before_allocation (void)
{
...
static void
gldelf64_aix_after_allocation (void)
{
...
static char *
gldelf64_aix_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf64_aix.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf64_aix.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf64_aix.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf64_aix.xn";
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_aix.xswe";
      else
	return "ldscripts/elf64_aix.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_aix.xsce";
      else
	return "ldscripts/elf64_aix.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_aix.xse";
      else
	return "ldscripts/elf64_aix.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_aix.xwe";
      else
	return "ldscripts/elf64_aix.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_aix.xce";
      else
	return "ldscripts/elf64_aix.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_aix.xe";
      else
	return "ldscripts/elf64_aix.x";
    }
}
...
static bool
gldelf64_aix_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf64_aix_emulation =
{
  gldelf64_aix_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf64_aix_before_plugin_all_symbols_read,
  gldelf64_aix_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf64_aix_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf64_aix_before_allocation,
  gldelf64_aix_get_script,
  "elf64_aix",
