...
static void gldelf32lm32_before_plugin_all_symbols_read
  (void);
...
static void
gldelf32lm32_before_plugin_all_symbols_read (void)
{
...
gldelf32lm32_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32lm32.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32lm32.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32lm32.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32lm32.xn";
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lm32.xwe";
      else
	return "ldscripts/elf32lm32.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lm32.xce";
      else
	return "ldscripts/elf32lm32.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lm32.xe";
      else
	return "ldscripts/elf32lm32.x";
    }
}
...
static bool
gldelf32lm32_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf32lm32_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldelf32lm32_before_plugin_all_symbols_read,
