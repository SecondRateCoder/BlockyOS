...
/* 32 bit ELF emulation code for armelfb_linux
...
#define TARGET_IS_armelfb_linux
...
static void gldarmelfb_linux_before_parse (void);
static void gldarmelfb_linux_before_plugin_all_symbols_read
  (void);
static void gldarmelfb_linux_after_open (void);
static void gldarmelfb_linux_before_allocation (void);
static void gldarmelfb_linux_after_allocation (void);
...
static void
gldarmelfb_linux_before_parse (void)
{
...
static void
gldarmelfb_linux_set_symbols (void)
{
...
arm_elf_before_allocation (void)
{
  ...
  gldarmelfb_linux_before_allocation ();
}
...
static void
gldarmelfb_linux_after_allocation (void)
{
  int ret;
...
static void
gldarmelfb_linux_before_plugin_all_symbols_read (void)
{
...
static void
gldarmelfb_linux_after_open (void)
{
...
static void
gldarmelfb_linux_before_allocation (void)
{
...
static char *
gldarmelfb_linux_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/armelfb_linux.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/armelfb_linux.xr";
  else if (!config.text_read_only)
    return "ldscripts/armelfb_linux.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/armelfb_linux.xn";
	...
	return "ldscripts/armelfb_linux.xdwe";
      else
	return "ldscripts/armelfb_linux.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux.xdce";
      else
	return "ldscripts/armelfb_linux.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux.xde";
      else
	return "ldscripts/armelfb_linux.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux.xswe";
      else
	return "ldscripts/armelfb_linux.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux.xsce";
      else
	return "ldscripts/armelfb_linux.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux.xse";
      else
	return "ldscripts/armelfb_linux.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux.xwe";
      else
	return "ldscripts/armelfb_linux.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux.xce";
      else
	return "ldscripts/armelfb_linux.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux.xe";
      else
	return "ldscripts/armelfb_linux.x";
    }
}
...
static bool
gldarmelfb_linux_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldarmelfb_linux_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_armelfb_linux_emulation =
{
  gldarmelfb_linux_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldarmelfb_linux_before_plugin_all_symbols_read,
  gldarmelfb_linux_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldarmelfb_linux_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  arm_elf_before_allocation,
  gldarmelfb_linux_get_script,
  "armelfb_linux",
  "elf32-bigarm",
  gldarmelfb_linux_finish,
  arm_elf_create_output_section_statements,
  ldelf_open_dynamic_archive,
  ldelf_place_orphan,
  gldarmelfb_linux_set_symbols,
  NULL,
  gldarmelfb_linux_add_options,
  gldarmelfb_linux_handle_option,
  NULL,
  gldarmelfb_linux_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
