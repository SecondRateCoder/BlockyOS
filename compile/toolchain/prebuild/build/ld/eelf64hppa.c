...
/* 64 bit ELF emulation code for elf64hppa
...
static void gldelf64hppa_before_parse (void);
static void gldelf64hppa_before_plugin_all_symbols_read
  (void);
static void gldelf64hppa_after_open (void);
static void gldelf64hppa_before_allocation (void);
static void gldelf64hppa_after_allocation (void);


static void
gldelf64hppa_before_parse (void)
{
...
static void
gldelf64hppa_before_plugin_all_symbols_read (void)
{
...
static void
gldelf64hppa_before_allocation (void)
{
...
static void
gldelf64hppa_after_allocation (void)
{
...
static char *
gldelf64hppa_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf64hppa.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf64hppa.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf64hppa.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf64hppa.xn";
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64hppa.xse";
      else
	return "ldscripts/elf64hppa.xs";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf64hppa.xe";
      else
	return "ldscripts/elf64hppa.x";
    }
}
...
static bool
gldelf64hppa_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf64hppa_emulation =
{
  gldelf64hppa_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf64hppa_before_plugin_all_symbols_read,
  gldelf64hppa_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf64hppa_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf64hppa_before_allocation,
  gldelf64hppa_get_script,
  "elf64hppa",
  "elf64-hppa",
  finish_default,
  NULL,
