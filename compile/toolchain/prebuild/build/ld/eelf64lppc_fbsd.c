...
/* 64 bit ELF emulation code for elf64lppc_fbsd
...
#define TARGET_IS_elf64lppc_fbsd
...
static void gldelf64lppc_fbsd_before_parse (void);
static void gldelf64lppc_fbsd_before_plugin_all_symbols_read
  (void);
static void gldelf64lppc_fbsd_after_open (void);
static void gldelf64lppc_fbsd_before_allocation (void);
static void gldelf64lppc_fbsd_after_allocation (void);
...
ppc_before_allocation (void)
{
  ...
  gldelf64lppc_fbsd_before_allocation ();
}
...
/* Call the back-end function to set TOC base after we have placed all
   the sections.  */
static void
gldelf64lppc_fbsd_after_allocation (void)
{
  int ret;
...
gldelf64lppc_fbsd_new_vers_pattern (struct bfd_elf_version_expr *entry)
{
...
static void
gldelf64lppc_fbsd_before_parse (void)
{
...
static void
gldelf64lppc_fbsd_before_plugin_all_symbols_read (void)
{
...
static void
gldelf64lppc_fbsd_after_open (void)
{
...
static void
gldelf64lppc_fbsd_before_allocation (void)
{
...
static char *
gldelf64lppc_fbsd_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf64lppc_fbsd.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf64lppc_fbsd.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf64lppc_fbsd.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf64lppc_fbsd.xn";
	...
	return "ldscripts/elf64lppc_fbsd.xdwe";
      else
	return "ldscripts/elf64lppc_fbsd.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lppc_fbsd.xdce";
      else
	return "ldscripts/elf64lppc_fbsd.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lppc_fbsd.xde";
      else
	return "ldscripts/elf64lppc_fbsd.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lppc_fbsd.xswe";
      else
	return "ldscripts/elf64lppc_fbsd.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lppc_fbsd.xsce";
      else
	return "ldscripts/elf64lppc_fbsd.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lppc_fbsd.xse";
      else
	return "ldscripts/elf64lppc_fbsd.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lppc_fbsd.xwe";
      else
	return "ldscripts/elf64lppc_fbsd.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lppc_fbsd.xce";
      else
	return "ldscripts/elf64lppc_fbsd.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lppc_fbsd.xe";
      else
	return "ldscripts/elf64lppc_fbsd.x";
    }
}
...
static bool
gldelf64lppc_fbsd_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf64lppc_fbsd_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf64lppc_fbsd_emulation =
{
  gldelf64lppc_fbsd_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf64lppc_fbsd_before_plugin_all_symbols_read,
  ppc_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf64lppc_fbsd_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  ppc_before_allocation,
  gldelf64lppc_fbsd_get_script,
  "elf64lppc_fbsd",
  "elf64-powerpcle-freebsd",
  gldelf64lppc_fbsd_finish,
  ...
  NULL,
  gldelf64lppc_fbsd_add_options,
  gldelf64lppc_fbsd_handle_option,
  NULL,
  gldelf64lppc_fbsd_list_options,
  ppc64_recognized_file,
  NULL,
  gldelf64lppc_fbsd_new_vers_pattern,
  NULL,
