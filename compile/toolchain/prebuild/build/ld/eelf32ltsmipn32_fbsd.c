...
/* 32 bit ELF emulation code for elf32ltsmipn32_fbsd
...
#define TARGET_IS_elf32ltsmipn32_fbsd
...
static void gldelf32ltsmipn32_fbsd_before_parse (void);
static void gldelf32ltsmipn32_fbsd_before_plugin_all_symbols_read
  (void);
static void gldelf32ltsmipn32_fbsd_after_open (void);
static void gldelf32ltsmipn32_fbsd_before_allocation (void);
static void gldelf32ltsmipn32_fbsd_after_allocation (void);
...
mips_before_allocation (void)
{
  ...
  gldelf32ltsmipn32_fbsd_before_allocation ();
}


static void
gldelf32ltsmipn32_fbsd_before_parse (void)
{
...
static void
gldelf32ltsmipn32_fbsd_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32ltsmipn32_fbsd_after_open (void)
{
...
static void
gldelf32ltsmipn32_fbsd_before_allocation (void)
{
  ldelf_before_allocation (audit, depaudit, "/usr/libexec/ld-elf.so.1");
}


static void
gldelf32ltsmipn32_fbsd_after_allocation (void)
{
...
static char *
gldelf32ltsmipn32_fbsd_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32ltsmipn32_fbsd.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32ltsmipn32_fbsd.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32ltsmipn32_fbsd.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32ltsmipn32_fbsd.xn";
	...
	return "ldscripts/elf32ltsmipn32_fbsd.xdwe";
      else
	return "ldscripts/elf32ltsmipn32_fbsd.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmipn32_fbsd.xdce";
      else
	return "ldscripts/elf32ltsmipn32_fbsd.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmipn32_fbsd.xde";
      else
	return "ldscripts/elf32ltsmipn32_fbsd.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmipn32_fbsd.xswe";
      else
	return "ldscripts/elf32ltsmipn32_fbsd.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmipn32_fbsd.xsce";
      else
	return "ldscripts/elf32ltsmipn32_fbsd.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmipn32_fbsd.xse";
      else
	return "ldscripts/elf32ltsmipn32_fbsd.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmipn32_fbsd.xwe";
      else
	return "ldscripts/elf32ltsmipn32_fbsd.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmipn32_fbsd.xce";
      else
	return "ldscripts/elf32ltsmipn32_fbsd.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmipn32_fbsd.xe";
      else
	return "ldscripts/elf32ltsmipn32_fbsd.x";
    }
}
...
static void
gldelf32ltsmipn32_fbsd_add_options
...
static bool
gldelf32ltsmipn32_fbsd_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32ltsmipn32_fbsd_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32ltsmipn32_fbsd_emulation =
{
  gldelf32ltsmipn32_fbsd_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32ltsmipn32_fbsd_before_plugin_all_symbols_read,
  gldelf32ltsmipn32_fbsd_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32ltsmipn32_fbsd_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  mips_before_allocation,
  gldelf32ltsmipn32_fbsd_get_script,
  "elf32ltsmipn32_fbsd",
  "elf32-ntradlittlemips-freebsd",
  finish_default,
  ...
  NULL,
  gldelf32ltsmipn32_fbsd_add_options,
  gldelf32ltsmipn32_fbsd_handle_option,
  NULL,
  gldelf32ltsmipn32_fbsd_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
