...
static void gldh8300elf_before_plugin_all_symbols_read
  (void);
static void gldh8300elf_after_open (void);
static void gldh8300elf_before_allocation (void);
static void gldh8300elf_after_allocation (void);
...
static void
gldh8300elf_before_plugin_all_symbols_read (void)
{
...
gldh8300elf_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/h8300elf.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/h8300elf.xr";
  else if (!config.text_read_only)
    return "ldscripts/h8300elf.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/h8300elf.xn";
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/h8300elf.xwe";
      else
	return "ldscripts/h8300elf.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/h8300elf.xce";
      else
	return "ldscripts/h8300elf.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/h8300elf.xe";
      else
	return "ldscripts/h8300elf.x";
    }
}
...
static bool
gldh8300elf_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_h8300elf_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldh8300elf_before_plugin_all_symbols_read,
  gldh8300elf_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldh8300elf_after_allocation,
