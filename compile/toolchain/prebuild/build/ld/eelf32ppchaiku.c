...
/* 32 bit ELF emulation code for elf32ppchaiku
...
#define TARGET_IS_elf32ppchaiku
...
static void gldelf32ppchaiku_before_parse (void);
static void gldelf32ppchaiku_before_plugin_all_symbols_read
  (void);
static void gldelf32ppchaiku_after_open (void);
static void gldelf32ppchaiku_before_allocation (void);
static void gldelf32ppchaiku_after_allocation (void);
...
ppc_before_allocation (void)
{
  ...
  gldelf32ppchaiku_before_allocation ();
  ...
  /* Turn on relaxation if executable sections have addresses that
  ...
  else if (!RELAXATION_DISABLED_BY_USER)
    {
	 ...
	 up gldelf32ppchaiku_before_allocation sizing.  This
...
static void
gldelf32ppchaiku_before_parse (void)
{
...
static void
gldelf32ppchaiku_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32ppchaiku_after_open (void)
{
...
static void
gldelf32ppchaiku_before_allocation (void)
{
  ldelf_before_allocation (audit, depaudit, "/system/runtime_loader");
}


static void
gldelf32ppchaiku_after_allocation (void)
{
...
static char *
gldelf32ppchaiku_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32ppchaiku.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32ppchaiku.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32ppchaiku.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32ppchaiku.xn";
	...
	return "ldscripts/elf32ppchaiku.xdwe";
      else
	return "ldscripts/elf32ppchaiku.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppchaiku.xdce";
      else
	return "ldscripts/elf32ppchaiku.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppchaiku.xde";
      else
	return "ldscripts/elf32ppchaiku.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppchaiku.xswe";
      else
	return "ldscripts/elf32ppchaiku.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppchaiku.xsce";
      else
	return "ldscripts/elf32ppchaiku.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppchaiku.xse";
      else
	return "ldscripts/elf32ppchaiku.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppchaiku.xwe";
      else
	return "ldscripts/elf32ppchaiku.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppchaiku.xce";
      else
	return "ldscripts/elf32ppchaiku.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppchaiku.xe";
      else
	return "ldscripts/elf32ppchaiku.x";
    }
}
...
static bool
gldelf32ppchaiku_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32ppchaiku_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32ppchaiku_emulation =
{
  gldelf32ppchaiku_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32ppchaiku_before_plugin_all_symbols_read,
  gldelf32ppchaiku_after_open,
  ppc_after_check_relocs,
  ldelf_before_place_orphans,
  gldelf32ppchaiku_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  ppc_before_allocation,
  gldelf32ppchaiku_get_script,
  "elf32ppchaiku",
  "elf32-powerpc",
  ppc_finish,
  ...
  NULL,
  gldelf32ppchaiku_add_options,
  gldelf32ppchaiku_handle_option,
  NULL,
  gldelf32ppchaiku_list_options,
  ppc_recognized_file,
  NULL,
  NULL,
  NULL,
