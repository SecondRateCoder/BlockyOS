...
/* 32 bit ELF emulation code for avrxmega2
...
static void gldavrxmega2_before_parse (void);
static void gldavrxmega2_before_plugin_all_symbols_read
  (void);
static void gldavrxmega2_after_open (void);
static void gldavrxmega2_before_allocation (void);
static void gldavrxmega2_after_allocation (void);
...
static void
avr_elf_avrxmega2_before_allocation (void)
{
  int ret;

  gldavrxmega2_before_allocation ();
  ...
  if (strcmp ("avrxmega2", "avr6") != 0
      && strcmp ("avrxmega2", "avrxmega6") != 0
      && strcmp ("avrxmega2", "avrxmega7") != 0)
    avr_no_stubs = true;
...
static void
gldavrxmega2_before_parse (void)
{
...
static void
gldavrxmega2_before_plugin_all_symbols_read (void)
{
...
static void
gldavrxmega2_before_allocation (void)
{
...
static void
gldavrxmega2_after_allocation (void)
{
...
static char *
gldavrxmega2_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/avrxmega2.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/avrxmega2.xr";
  else if (!config.text_read_only)
    return "ldscripts/avrxmega2.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/avrxmega2.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/avrxmega2.xe";
      else
	return "ldscripts/avrxmega2.x";
    }
}
...
static bool
gldavrxmega2_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldavrxmega2_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_avrxmega2_emulation =
{
  avr_elf_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldavrxmega2_before_plugin_all_symbols_read,
  gldavrxmega2_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  avr_elf_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  avr_elf_avrxmega2_before_allocation,
  gldavrxmega2_get_script,
  "avrxmega2",
  "elf32-avr",
  avr_finish,
  ...
  NULL,
  gldavrxmega2_add_options,
  gldavrxmega2_handle_option,
  NULL,
  gldavrxmega2_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
