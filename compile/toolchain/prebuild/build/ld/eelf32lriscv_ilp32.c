...
/* 32 bit ELF emulation code for elf32lriscv_ilp32
...
#define TARGET_IS_elf32lriscv_ilp32
...
static void gldelf32lriscv_ilp32_before_parse (void);
static void gldelf32lriscv_ilp32_before_plugin_all_symbols_read
  (void);
static void gldelf32lriscv_ilp32_after_open (void);
static void gldelf32lriscv_ilp32_before_allocation (void);
static void gldelf32lriscv_ilp32_after_allocation (void);
...
{
  gldelf32lriscv_ilp32_before_allocation ();
...
static void
gldelf32lriscv_ilp32_after_allocation (void)
{
  int need_layout = 0;
...
static void
gldelf32lriscv_ilp32_before_parse (void)
{
...
static void
gldelf32lriscv_ilp32_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32lriscv_ilp32_after_open (void)
{
...
static void
gldelf32lriscv_ilp32_before_allocation (void)
{
...
static char *
gldelf32lriscv_ilp32_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32lriscv_ilp32.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32lriscv_ilp32.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32lriscv_ilp32.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32lriscv_ilp32.xn";
	...
	return "ldscripts/elf32lriscv_ilp32.xdwe";
      else
	return "ldscripts/elf32lriscv_ilp32.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lriscv_ilp32.xdce";
      else
	return "ldscripts/elf32lriscv_ilp32.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lriscv_ilp32.xde";
      else
	return "ldscripts/elf32lriscv_ilp32.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lriscv_ilp32.xswe";
      else
	return "ldscripts/elf32lriscv_ilp32.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lriscv_ilp32.xsce";
      else
	return "ldscripts/elf32lriscv_ilp32.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lriscv_ilp32.xse";
      else
	return "ldscripts/elf32lriscv_ilp32.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lriscv_ilp32.xwe";
      else
	return "ldscripts/elf32lriscv_ilp32.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lriscv_ilp32.xce";
      else
	return "ldscripts/elf32lriscv_ilp32.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lriscv_ilp32.xe";
      else
	return "ldscripts/elf32lriscv_ilp32.x";
    }
}
...
static void
gldelf32lriscv_ilp32_add_options
...
static bool
gldelf32lriscv_ilp32_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32lriscv_ilp32_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32lriscv_ilp32_emulation =
{
  gldelf32lriscv_ilp32_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32lriscv_ilp32_before_plugin_all_symbols_read,
  gldelf32lriscv_ilp32_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32lriscv_ilp32_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  riscv_elf_before_allocation,
  gldelf32lriscv_ilp32_get_script,
  "elf32lriscv_ilp32",
  "elf32-littleriscv",
  finish_default,
  ...
  NULL,
  gldelf32lriscv_ilp32_add_options,
  gldelf32lriscv_ilp32_handle_option,
  NULL,
  gldelf32lriscv_ilp32_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
