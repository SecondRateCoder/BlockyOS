...
/* 32 bit ELF emulation code for avr51
...
static void gldavr51_before_parse (void);
static void gldavr51_before_plugin_all_symbols_read
  (void);
static void gldavr51_after_open (void);
static void gldavr51_before_allocation (void);
static void gldavr51_after_allocation (void);
...
static void
avr_elf_avr51_before_allocation (void)
{
  int ret;

  gldavr51_before_allocation ();
  ...
  if (strcmp ("avr51", "avr6") != 0
      && strcmp ("avr51", "avrxmega6") != 0
      && strcmp ("avr51", "avrxmega7") != 0)
    avr_no_stubs = true;
...
static void
gldavr51_before_parse (void)
{
  ldfile_set_output_arch ("avr:51", bfd_arch_avr);
...
static void
gldavr51_before_plugin_all_symbols_read (void)
{
...
static void
gldavr51_before_allocation (void)
{
...
static void
gldavr51_after_allocation (void)
{
...
static char *
gldavr51_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/avr51.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/avr51.xr";
  else if (!config.text_read_only)
    return "ldscripts/avr51.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/avr51.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/avr51.xe";
      else
	return "ldscripts/avr51.x";
    }
}
...
static bool
gldavr51_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldavr51_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_avr51_emulation =
{
  avr_elf_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldavr51_before_plugin_all_symbols_read,
  gldavr51_after_open,
  ...
  avr_elf_avr51_before_allocation,
  gldavr51_get_script,
  "avr51",
  "elf32-avr",
  avr_finish,
  ...
  NULL,
  gldavr51_add_options,
  gldavr51_handle_option,
  NULL,
  gldavr51_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
