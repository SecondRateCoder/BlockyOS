...
/* 32 bit ELF emulation code for armelf_fuchsia
...
#define TARGET_IS_armelf_fuchsia
...
static void gldarmelf_fuchsia_before_parse (void);
static void gldarmelf_fuchsia_before_plugin_all_symbols_read
  (void);
static void gldarmelf_fuchsia_after_open (void);
static void gldarmelf_fuchsia_before_allocation (void);
static void gldarmelf_fuchsia_after_allocation (void);
...
static void
gldarmelf_fuchsia_before_parse (void)
{
...
static void
gldarmelf_fuchsia_set_symbols (void)
{
...
arm_elf_before_allocation (void)
{
  ...
  gldarmelf_fuchsia_before_allocation ();
}
...
static void
gldarmelf_fuchsia_after_allocation (void)
{
  int ret;
...
static void
gldarmelf_fuchsia_before_plugin_all_symbols_read (void)
{
...
static void
gldarmelf_fuchsia_after_open (void)
{
...
static void
gldarmelf_fuchsia_before_allocation (void)
{
...
static char *
gldarmelf_fuchsia_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/armelf_fuchsia.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/armelf_fuchsia.xr";
  else if (!config.text_read_only)
    return "ldscripts/armelf_fuchsia.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/armelf_fuchsia.xn";
	...
	return "ldscripts/armelf_fuchsia.xdwe";
      else
	return "ldscripts/armelf_fuchsia.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_fuchsia.xdce";
      else
	return "ldscripts/armelf_fuchsia.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_fuchsia.xde";
      else
	return "ldscripts/armelf_fuchsia.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_fuchsia.xswe";
      else
	return "ldscripts/armelf_fuchsia.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_fuchsia.xsce";
      else
	return "ldscripts/armelf_fuchsia.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_fuchsia.xse";
      else
	return "ldscripts/armelf_fuchsia.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_fuchsia.xwe";
      else
	return "ldscripts/armelf_fuchsia.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_fuchsia.xce";
      else
	return "ldscripts/armelf_fuchsia.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_fuchsia.xe";
      else
	return "ldscripts/armelf_fuchsia.x";
    }
}
...
static bool
gldarmelf_fuchsia_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldarmelf_fuchsia_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_armelf_fuchsia_emulation =
{
  gldarmelf_fuchsia_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldarmelf_fuchsia_before_plugin_all_symbols_read,
  gldarmelf_fuchsia_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldarmelf_fuchsia_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  arm_elf_before_allocation,
  gldarmelf_fuchsia_get_script,
  "armelf_fuchsia",
  "elf32-littlearm",
  gldarmelf_fuchsia_finish,
  arm_elf_create_output_section_statements,
  ldelf_open_dynamic_archive,
  ldelf_place_orphan,
  gldarmelf_fuchsia_set_symbols,
  NULL,
  gldarmelf_fuchsia_add_options,
  gldarmelf_fuchsia_handle_option,
  NULL,
  gldarmelf_fuchsia_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
