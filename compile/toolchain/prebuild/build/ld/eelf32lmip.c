...
/* 32 bit ELF emulation code for elf32lmip
...
static void gldelf32lmip_before_parse (void);
static void gldelf32lmip_before_plugin_all_symbols_read
  (void);
static void gldelf32lmip_after_open (void);
static void gldelf32lmip_before_allocation (void);
static void gldelf32lmip_after_allocation (void);
...
mips_before_allocation (void)
{
  ...
  gldelf32lmip_before_allocation ();
}


static void
gldelf32lmip_before_parse (void)
{
...
static void
gldelf32lmip_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32lmip_before_allocation (void)
{
...
static void
gldelf32lmip_after_allocation (void)
{
...
static char *
gldelf32lmip_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32lmip.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32lmip.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32lmip.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32lmip.xn";
	...
	return "ldscripts/elf32lmip.xdwe";
      else
	return "ldscripts/elf32lmip.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lmip.xdce";
      else
	return "ldscripts/elf32lmip.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lmip.xde";
      else
	return "ldscripts/elf32lmip.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lmip.xswe";
      else
	return "ldscripts/elf32lmip.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lmip.xsce";
      else
	return "ldscripts/elf32lmip.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lmip.xse";
      else
	return "ldscripts/elf32lmip.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lmip.xwe";
      else
	return "ldscripts/elf32lmip.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lmip.xce";
      else
	return "ldscripts/elf32lmip.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lmip.xe";
      else
	return "ldscripts/elf32lmip.x";
    }
}
...
static bool
gldelf32lmip_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32lmip_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32lmip_emulation =
{
  gldelf32lmip_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32lmip_before_plugin_all_symbols_read,
  gldelf32lmip_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32lmip_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  mips_before_allocation,
  gldelf32lmip_get_script,
  "elf32lmip",
  "elf32-littlemips",
  finish_default,
  ...
  NULL,
  gldelf32lmip_add_options,
  gldelf32lmip_handle_option,
  NULL,
  gldelf32lmip_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
