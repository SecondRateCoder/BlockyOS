...
/* 32 bit ELF emulation code for elf32microblazeel
...
#define TARGET_IS_elf32microblazeel
...
static void gldelf32microblazeel_before_parse (void);
static void gldelf32microblazeel_before_plugin_all_symbols_read
  (void);
static void gldelf32microblazeel_after_open (void);
static void gldelf32microblazeel_before_allocation (void);
static void gldelf32microblazeel_after_allocation (void);


static void
gldelf32microblazeel_before_parse (void)
{
...
static void
gldelf32microblazeel_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32microblazeel_after_open (void)
{
...
static void
gldelf32microblazeel_before_allocation (void)
{
...
static void
gldelf32microblazeel_after_allocation (void)
{
...
static char *
gldelf32microblazeel_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32microblazeel.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32microblazeel.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32microblazeel.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32microblazeel.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32microblazeel.xe";
      else
	return "ldscripts/elf32microblazeel.x";
    }
}
...
static void
gldelf32microblazeel_add_options
...
static bool
gldelf32microblazeel_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf32microblazeel_emulation =
{
  gldelf32microblazeel_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32microblazeel_before_plugin_all_symbols_read,
  gldelf32microblazeel_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32microblazeel_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32microblazeel_before_allocation,
  gldelf32microblazeel_get_script,
  "elf32microblazeel",
  "elf32-microblazeel",
  finish_default,
  NULL,
  ...
  NULL,
  gldelf32microblazeel_add_options,
  gldelf32microblazeel_handle_option,
  NULL,
  NULL,
  ldelf_load_symbols,
  NULL,
