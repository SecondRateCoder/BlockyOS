...
/* 32 bit ELF emulation code for elf32_sparc
...
static void gldelf32_sparc_before_parse (void);
static void gldelf32_sparc_before_plugin_all_symbols_read
  (void);
static void gldelf32_sparc_after_open (void);
static void gldelf32_sparc_before_allocation (void);
static void gldelf32_sparc_after_allocation (void);


static void
gldelf32_sparc_before_parse (void)
{
...
static void
gldelf32_sparc_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32_sparc_after_open (void)
{
...
static void
gldelf32_sparc_before_allocation (void)
{
...
static void
gldelf32_sparc_after_allocation (void)
{
...
static char *
gldelf32_sparc_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32_sparc.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32_sparc.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32_sparc.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32_sparc.xn";
	...
	return "ldscripts/elf32_sparc.xdwe";
      else
	return "ldscripts/elf32_sparc.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_sparc.xdce";
      else
	return "ldscripts/elf32_sparc.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_sparc.xde";
      else
	return "ldscripts/elf32_sparc.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_sparc.xswe";
      else
	return "ldscripts/elf32_sparc.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_sparc.xsce";
      else
	return "ldscripts/elf32_sparc.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_sparc.xse";
      else
	return "ldscripts/elf32_sparc.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_sparc.xwe";
      else
	return "ldscripts/elf32_sparc.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_sparc.xce";
      else
	return "ldscripts/elf32_sparc.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_sparc.xe";
      else
	return "ldscripts/elf32_sparc.x";
    }
}
...
static bool
gldelf32_sparc_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf32_sparc_emulation =
{
  gldelf32_sparc_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32_sparc_before_plugin_all_symbols_read,
  gldelf32_sparc_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32_sparc_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32_sparc_before_allocation,
  gldelf32_sparc_get_script,
  "elf32_sparc",
  "elf32-sparc",
  finish_default,
  NULL,
