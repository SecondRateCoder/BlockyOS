...
/* 32 bit ELF emulation code for elf32elmipvxworks
...
#define TARGET_IS_elf32elmipvxworks
...
static void gldelf32elmipvxworks_before_parse (void);
static void gldelf32elmipvxworks_before_plugin_all_symbols_read
  (void);
static void gldelf32elmipvxworks_after_open (void);
static void gldelf32elmipvxworks_before_allocation (void);
static void gldelf32elmipvxworks_after_allocation (void);
...
mips_before_allocation (void)
{
  ...
  gldelf32elmipvxworks_before_allocation ();
}
...
{
  gldelf32elmipvxworks_before_parse ();
...
{
  gldelf32elmipvxworks_after_open ();
...
static void
gldelf32elmipvxworks_before_parse (void)
{
...
static void
gldelf32elmipvxworks_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32elmipvxworks_after_open (void)
{
...
static void
gldelf32elmipvxworks_before_allocation (void)
{
...
static void
gldelf32elmipvxworks_after_allocation (void)
{
...
static char *
gldelf32elmipvxworks_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32elmipvxworks.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32elmipvxworks.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32elmipvxworks.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32elmipvxworks.xn";
	...
	return "ldscripts/elf32elmipvxworks.xdwe";
      else
	return "ldscripts/elf32elmipvxworks.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32elmipvxworks.xdce";
      else
	return "ldscripts/elf32elmipvxworks.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32elmipvxworks.xde";
      else
	return "ldscripts/elf32elmipvxworks.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32elmipvxworks.xswe";
      else
	return "ldscripts/elf32elmipvxworks.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32elmipvxworks.xsce";
      else
	return "ldscripts/elf32elmipvxworks.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32elmipvxworks.xse";
      else
	return "ldscripts/elf32elmipvxworks.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32elmipvxworks.xwe";
      else
	return "ldscripts/elf32elmipvxworks.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32elmipvxworks.xce";
      else
	return "ldscripts/elf32elmipvxworks.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32elmipvxworks.xe";
      else
	return "ldscripts/elf32elmipvxworks.x";
    }
}
...
static void
gldelf32elmipvxworks_add_options
...
static bool
gldelf32elmipvxworks_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32elmipvxworks_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32elmipvxworks_emulation =
{
  vxworks_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32elmipvxworks_before_plugin_all_symbols_read,
  vxworks_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32elmipvxworks_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  mips_before_allocation,
  gldelf32elmipvxworks_get_script,
  "elf32elmipvxworks",
  ...
  NULL,
  gldelf32elmipvxworks_add_options,
  gldelf32elmipvxworks_handle_option,
  NULL,
  gldelf32elmipvxworks_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
