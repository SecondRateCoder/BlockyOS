...
/* 32 bit ELF emulation code for avr25
...
static void gldavr25_before_parse (void);
static void gldavr25_before_plugin_all_symbols_read
  (void);
static void gldavr25_after_open (void);
static void gldavr25_before_allocation (void);
static void gldavr25_after_allocation (void);
...
static void
avr_elf_avr25_before_allocation (void)
{
  int ret;

  gldavr25_before_allocation ();
  ...
  if (strcmp ("avr25", "avr6") != 0
      && strcmp ("avr25", "avrxmega6") != 0
      && strcmp ("avr25", "avrxmega7") != 0)
    avr_no_stubs = true;
...
static void
gldavr25_before_parse (void)
{
  ldfile_set_output_arch ("avr:25", bfd_arch_avr);
...
static void
gldavr25_before_plugin_all_symbols_read (void)
{
...
static void
gldavr25_before_allocation (void)
{
...
static void
gldavr25_after_allocation (void)
{
...
static char *
gldavr25_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/avr25.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/avr25.xr";
  else if (!config.text_read_only)
    return "ldscripts/avr25.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/avr25.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/avr25.xe";
      else
	return "ldscripts/avr25.x";
    }
}
...
static bool
gldavr25_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldavr25_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_avr25_emulation =
{
  avr_elf_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldavr25_before_plugin_all_symbols_read,
  gldavr25_after_open,
  ...
  avr_elf_avr25_before_allocation,
  gldavr25_get_script,
  "avr25",
  "elf32-avr",
  avr_finish,
  ...
  NULL,
  gldavr25_add_options,
  gldavr25_handle_option,
  NULL,
  gldavr25_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
