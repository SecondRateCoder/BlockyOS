...
/* 32 bit ELF emulation code for h8300hnelf
...
static void gldh8300hnelf_before_parse (void);
static void gldh8300hnelf_before_plugin_all_symbols_read
  (void);
static void gldh8300hnelf_after_open (void);
static void gldh8300hnelf_before_allocation (void);
static void gldh8300hnelf_after_allocation (void);


static void
gldh8300hnelf_before_parse (void)
{
  ldfile_set_output_arch ("h8300:h8300hn", bfd_arch_h8300);
...
static void
gldh8300hnelf_before_plugin_all_symbols_read (void)
{
...
static void
gldh8300hnelf_before_allocation (void)
{
...
static void
gldh8300hnelf_after_allocation (void)
{
...
static char *
gldh8300hnelf_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/h8300hnelf.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/h8300hnelf.xr";
  else if (!config.text_read_only)
    return "ldscripts/h8300hnelf.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/h8300hnelf.xn";
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/h8300hnelf.xwe";
      else
	return "ldscripts/h8300hnelf.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/h8300hnelf.xce";
      else
	return "ldscripts/h8300hnelf.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/h8300hnelf.xe";
      else
	return "ldscripts/h8300hnelf.x";
    }
}
...
static bool
gldh8300hnelf_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_h8300hnelf_emulation =
{
  gldh8300hnelf_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldh8300hnelf_before_plugin_all_symbols_read,
  gldh8300hnelf_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldh8300hnelf_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldh8300hnelf_before_allocation,
  gldh8300hnelf_get_script,
  "h8300hnelf",
  "elf32-h8300",
  finish_default,
  NULL,
