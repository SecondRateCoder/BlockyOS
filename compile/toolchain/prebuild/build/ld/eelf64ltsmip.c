...
static void gldelf64ltsmip_before_plugin_all_symbols_read
  (void);
static void gldelf64ltsmip_after_open (void);
static void gldelf64ltsmip_before_allocation (void);
static void gldelf64ltsmip_after_allocation (void);
...
static void
gldelf64ltsmip_before_plugin_all_symbols_read (void)
{
...
static void
gldelf64ltsmip_after_allocation (void)
{
...
gldelf64ltsmip_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
	...
	return "ldscripts/elf64ltsmip.xdwe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf64ltsmip.xdce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf64ltsmip.xde";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf64ltsmip.xswe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf64ltsmip.xsce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf64ltsmip.xse";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf64ltsmip.xwe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf64ltsmip.xce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf64ltsmip.xe";
      else
...
struct ld_emulation_xfer_struct ld_elf64ltsmip_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldelf64ltsmip_before_plugin_all_symbols_read,
  gldelf64ltsmip_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf64ltsmip_after_allocation,
