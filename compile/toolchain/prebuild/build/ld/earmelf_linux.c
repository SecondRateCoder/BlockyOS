...
/* 32 bit ELF emulation code for armelf_linux
...
static void gldarmelf_linux_before_parse (void);
static void gldarmelf_linux_before_plugin_all_symbols_read
  (void);
static void gldarmelf_linux_after_open (void);
static void gldarmelf_linux_before_allocation (void);
static void gldarmelf_linux_after_allocation (void);
...
static void
gldarmelf_linux_before_parse (void)
{
...
static void
gldarmelf_linux_set_symbols (void)
{
...
arm_elf_before_allocation (void)
{
  ...
  gldarmelf_linux_before_allocation ();
}
...
static void
gldarmelf_linux_after_allocation (void)
{
  int ret;
...
static void
gldarmelf_linux_before_plugin_all_symbols_read (void)
{
...
static void
gldarmelf_linux_after_open (void)
{
...
static void
gldarmelf_linux_before_allocation (void)
{
...
static char *
gldarmelf_linux_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/armelf_linux.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/armelf_linux.xr";
  else if (!config.text_read_only)
    return "ldscripts/armelf_linux.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/armelf_linux.xn";
	...
	return "ldscripts/armelf_linux.xdwe";
      else
	return "ldscripts/armelf_linux.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_linux.xdce";
      else
	return "ldscripts/armelf_linux.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_linux.xde";
      else
	return "ldscripts/armelf_linux.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_linux.xswe";
      else
	return "ldscripts/armelf_linux.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_linux.xsce";
      else
	return "ldscripts/armelf_linux.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_linux.xse";
      else
	return "ldscripts/armelf_linux.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_linux.xwe";
      else
	return "ldscripts/armelf_linux.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_linux.xce";
      else
	return "ldscripts/armelf_linux.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_linux.xe";
      else
	return "ldscripts/armelf_linux.x";
    }
}
...
static bool
gldarmelf_linux_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldarmelf_linux_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_armelf_linux_emulation =
{
  gldarmelf_linux_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldarmelf_linux_before_plugin_all_symbols_read,
  gldarmelf_linux_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldarmelf_linux_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  arm_elf_before_allocation,
  gldarmelf_linux_get_script,
  "armelf_linux",
  "elf32-littlearm",
  gldarmelf_linux_finish,
  arm_elf_create_output_section_statements,
  ldelf_open_dynamic_archive,
  ldelf_place_orphan,
  gldarmelf_linux_set_symbols,
  NULL,
  gldarmelf_linux_add_options,
  gldarmelf_linux_handle_option,
  NULL,
  gldarmelf_linux_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
