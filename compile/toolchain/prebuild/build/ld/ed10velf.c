...
/* 32 bit ELF emulation code for d10velf
...
static void gldd10velf_before_parse (void);
static void gldd10velf_before_plugin_all_symbols_read
  (void);
static void gldd10velf_after_open (void);
static void gldd10velf_before_allocation (void);
static void gldd10velf_after_allocation (void);


static void
gldd10velf_before_parse (void)
{
  ldfile_set_output_arch ("d10v", bfd_arch_d10v);
...
static void
gldd10velf_before_plugin_all_symbols_read (void)
{
...
static void
gldd10velf_before_allocation (void)
{
...
static void
gldd10velf_after_allocation (void)
{
...
static char *
gldd10velf_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/d10velf.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/d10velf.xr";
  else if (!config.text_read_only)
    return "ldscripts/d10velf.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/d10velf.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/d10velf.xe";
      else
	return "ldscripts/d10velf.x";
    }
}
...
static bool
gldd10velf_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_d10velf_emulation =
{
  gldd10velf_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldd10velf_before_plugin_all_symbols_read,
  gldd10velf_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldd10velf_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldd10velf_before_allocation,
  gldd10velf_get_script,
  "d10velf",
  "elf32-d10v",
  finish_default,
  NULL,
