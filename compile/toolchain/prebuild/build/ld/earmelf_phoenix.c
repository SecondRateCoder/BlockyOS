...
/* 32 bit ELF emulation code for armelf_phoenix
...
#define TARGET_IS_armelf_phoenix
...
static void gldarmelf_phoenix_before_parse (void);
static void gldarmelf_phoenix_before_plugin_all_symbols_read
  (void);
static void gldarmelf_phoenix_after_open (void);
static void gldarmelf_phoenix_before_allocation (void);
static void gldarmelf_phoenix_after_allocation (void);
...
static void
gldarmelf_phoenix_before_parse (void)
{
...
static void
gldarmelf_phoenix_set_symbols (void)
{
...
arm_elf_before_allocation (void)
{
  ...
  gldarmelf_phoenix_before_allocation ();
}
...
static void
gldarmelf_phoenix_after_allocation (void)
{
  int ret;
...
static void
gldarmelf_phoenix_before_plugin_all_symbols_read (void)
{
...
static void
gldarmelf_phoenix_after_open (void)
{
...
static void
gldarmelf_phoenix_before_allocation (void)
{
...
static char *
gldarmelf_phoenix_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/armelf_phoenix.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/armelf_phoenix.xr";
  else if (!config.text_read_only)
    return "ldscripts/armelf_phoenix.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/armelf_phoenix.xn";
	...
	return "ldscripts/armelf_phoenix.xdwe";
      else
	return "ldscripts/armelf_phoenix.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_phoenix.xdce";
      else
	return "ldscripts/armelf_phoenix.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_phoenix.xde";
      else
	return "ldscripts/armelf_phoenix.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_phoenix.xswe";
      else
	return "ldscripts/armelf_phoenix.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_phoenix.xsce";
      else
	return "ldscripts/armelf_phoenix.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_phoenix.xse";
      else
	return "ldscripts/armelf_phoenix.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_phoenix.xwe";
      else
	return "ldscripts/armelf_phoenix.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_phoenix.xce";
      else
	return "ldscripts/armelf_phoenix.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_phoenix.xe";
      else
	return "ldscripts/armelf_phoenix.x";
    }
}
...
static bool
gldarmelf_phoenix_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldarmelf_phoenix_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_armelf_phoenix_emulation =
{
  gldarmelf_phoenix_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldarmelf_phoenix_before_plugin_all_symbols_read,
  gldarmelf_phoenix_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldarmelf_phoenix_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  arm_elf_before_allocation,
  gldarmelf_phoenix_get_script,
  "armelf_phoenix",
  "elf32-littlearm",
  gldarmelf_phoenix_finish,
  arm_elf_create_output_section_statements,
  ldelf_open_dynamic_archive,
  ldelf_place_orphan,
  gldarmelf_phoenix_set_symbols,
  NULL,
  gldarmelf_phoenix_add_options,
  gldarmelf_phoenix_handle_option,
  NULL,
  gldarmelf_phoenix_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
