...
/* 32 bit ELF emulation code for elf32mcore
...
static void gldelf32mcore_before_parse (void);
static void gldelf32mcore_before_plugin_all_symbols_read
  (void);
static void gldelf32mcore_after_open (void);
static void gldelf32mcore_before_allocation (void);
static void gldelf32mcore_after_allocation (void);


static void
gldelf32mcore_before_parse (void)
{
...
static void
gldelf32mcore_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32mcore_before_allocation (void)
{
...
static void
gldelf32mcore_after_allocation (void)
{
...
static char *
gldelf32mcore_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32mcore.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32mcore.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32mcore.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32mcore.xn";
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32mcore.xwe";
      else
	return "ldscripts/elf32mcore.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32mcore.xce";
      else
	return "ldscripts/elf32mcore.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32mcore.xe";
      else
	return "ldscripts/elf32mcore.x";
    }
}
...
static bool
gldelf32mcore_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32mcore_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32mcore_emulation =
{
  gldelf32mcore_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32mcore_before_plugin_all_symbols_read,
  gldelf32mcore_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32mcore_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32mcore_before_allocation,
  gldelf32mcore_get_script,
  "elf32mcore",
  "elf32-mcore-little",
  finish_default,
  NULL,
  ...
  NULL,
  gldelf32mcore_add_options,
  gldelf32mcore_handle_option,
  NULL,
  gldelf32mcore_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
