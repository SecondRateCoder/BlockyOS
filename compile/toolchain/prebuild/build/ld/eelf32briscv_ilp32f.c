...
/* 32 bit ELF emulation code for elf32briscv_ilp32f
...
#define TARGET_IS_elf32briscv_ilp32f
...
static void gldelf32briscv_ilp32f_before_parse (void);
static void gldelf32briscv_ilp32f_before_plugin_all_symbols_read
  (void);
static void gldelf32briscv_ilp32f_after_open (void);
static void gldelf32briscv_ilp32f_before_allocation (void);
static void gldelf32briscv_ilp32f_after_allocation (void);
...
{
  gldelf32briscv_ilp32f_before_allocation ();
...
static void
gldelf32briscv_ilp32f_after_allocation (void)
{
  int need_layout = 0;
...
static void
gldelf32briscv_ilp32f_before_parse (void)
{
...
static void
gldelf32briscv_ilp32f_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32briscv_ilp32f_after_open (void)
{
...
static void
gldelf32briscv_ilp32f_before_allocation (void)
{
...
static char *
gldelf32briscv_ilp32f_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32briscv_ilp32f.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32briscv_ilp32f.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32briscv_ilp32f.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32briscv_ilp32f.xn";
	...
	return "ldscripts/elf32briscv_ilp32f.xdwe";
      else
	return "ldscripts/elf32briscv_ilp32f.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32briscv_ilp32f.xdce";
      else
	return "ldscripts/elf32briscv_ilp32f.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32briscv_ilp32f.xde";
      else
	return "ldscripts/elf32briscv_ilp32f.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32briscv_ilp32f.xswe";
      else
	return "ldscripts/elf32briscv_ilp32f.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32briscv_ilp32f.xsce";
      else
	return "ldscripts/elf32briscv_ilp32f.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32briscv_ilp32f.xse";
      else
	return "ldscripts/elf32briscv_ilp32f.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32briscv_ilp32f.xwe";
      else
	return "ldscripts/elf32briscv_ilp32f.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32briscv_ilp32f.xce";
      else
	return "ldscripts/elf32briscv_ilp32f.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32briscv_ilp32f.xe";
      else
	return "ldscripts/elf32briscv_ilp32f.x";
    }
}
...
static void
gldelf32briscv_ilp32f_add_options
...
static bool
gldelf32briscv_ilp32f_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32briscv_ilp32f_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32briscv_ilp32f_emulation =
{
  gldelf32briscv_ilp32f_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32briscv_ilp32f_before_plugin_all_symbols_read,
  gldelf32briscv_ilp32f_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32briscv_ilp32f_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  riscv_elf_before_allocation,
  gldelf32briscv_ilp32f_get_script,
  "elf32briscv_ilp32f",
  "elf32-bigriscv",
  finish_default,
  ...
  NULL,
  gldelf32briscv_ilp32f_add_options,
  gldelf32briscv_ilp32f_handle_option,
  NULL,
  gldelf32briscv_ilp32f_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
