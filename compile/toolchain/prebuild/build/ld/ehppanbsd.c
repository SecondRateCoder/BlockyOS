...
/* 32 bit ELF emulation code for hppanbsd
...
static void gldhppanbsd_before_parse (void);
static void gldhppanbsd_before_plugin_all_symbols_read
  (void);
static void gldhppanbsd_after_open (void);
static void gldhppanbsd_before_allocation (void);
static void gldhppanbsd_after_allocation (void);
...
static void
gldhppanbsd_after_allocation (void)
{
  int ret;
...
static void
gldhppanbsd_before_plugin_all_symbols_read (void)
{
...
static void
gldhppanbsd_before_allocation (void)
{
...
static char *
gldhppanbsd_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/hppanbsd.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/hppanbsd.xr";
  else if (!config.text_read_only)
    return "ldscripts/hppanbsd.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/hppanbsd.xn";
	...
	return "ldscripts/hppanbsd.xdwe";
      else
	return "ldscripts/hppanbsd.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/hppanbsd.xdce";
      else
	return "ldscripts/hppanbsd.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/hppanbsd.xde";
      else
	return "ldscripts/hppanbsd.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/hppanbsd.xswe";
      else
	return "ldscripts/hppanbsd.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/hppanbsd.xsce";
      else
	return "ldscripts/hppanbsd.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/hppanbsd.xse";
      else
	return "ldscripts/hppanbsd.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/hppanbsd.xwe";
      else
	return "ldscripts/hppanbsd.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/hppanbsd.xce";
      else
	return "ldscripts/hppanbsd.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/hppanbsd.xe";
      else
	return "ldscripts/hppanbsd.x";
    }
}
...
static bool
gldhppanbsd_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldhppanbsd_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_hppanbsd_emulation =
{
  gldhppanbsd_before_parse,
  syslib_default,
  hll_default,
  hppaelf_after_parse,
  gldhppanbsd_before_plugin_all_symbols_read,
  gldhppanbsd_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldhppanbsd_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldhppanbsd_before_allocation,
  gldhppanbsd_get_script,
  "hppanbsd",
  "elf32-hppa-netbsd",
  finish_default,
  ...
  NULL,
  gldhppanbsd_add_options,
  gldhppanbsd_handle_option,
  NULL,
  gldhppanbsd_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
