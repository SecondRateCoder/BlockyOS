...
/* 32 bit ELF emulation code for arcv2elfx
...
static void gldarcv2elfx_before_parse (void);
static void gldarcv2elfx_before_plugin_all_symbols_read
  (void);
static void gldarcv2elfx_after_open (void);
static void gldarcv2elfx_before_allocation (void);
static void gldarcv2elfx_after_allocation (void);


static void
gldarcv2elfx_before_parse (void)
{
...
static void
gldarcv2elfx_before_plugin_all_symbols_read (void)
{
...
static void
gldarcv2elfx_before_allocation (void)
{
...
static void
gldarcv2elfx_after_allocation (void)
{
...
static char *
gldarcv2elfx_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/arcv2elfx.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/arcv2elfx.xr";
  else if (!config.text_read_only)
    return "ldscripts/arcv2elfx.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/arcv2elfx.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/arcv2elfx.xe";
      else
	return "ldscripts/arcv2elfx.x";
    }
}
...
static bool
gldarcv2elfx_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_arcv2elfx_emulation =
{
  gldarcv2elfx_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldarcv2elfx_before_plugin_all_symbols_read,
  gldarcv2elfx_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldarcv2elfx_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldarcv2elfx_before_allocation,
  gldarcv2elfx_get_script,
  "arcv2elfx",
  "elf32-littlearc",
  finish_default,
  NULL,
