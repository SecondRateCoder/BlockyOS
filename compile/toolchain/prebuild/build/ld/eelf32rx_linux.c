...
/* 32 bit ELF emulation code for elf32rx_linux
...
#define TARGET_IS_elf32rx_linux
...
static void gldelf32rx_linux_before_parse (void);
static void gldelf32rx_linux_before_plugin_all_symbols_read
  (void);
static void gldelf32rx_linux_after_open (void);
static void gldelf32rx_linux_before_allocation (void);
static void gldelf32rx_linux_after_allocation (void);
...
static void
gldelf32rx_linux_before_parse (void)
{
...
static void
gldelf32rx_linux_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32rx_linux_after_open (void)
{
...
static void
gldelf32rx_linux_before_allocation (void)
{
...
static void
gldelf32rx_linux_after_allocation (void)
{
...
static char *
gldelf32rx_linux_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32rx_linux.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32rx_linux.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32rx_linux.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32rx_linux.xn";
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32rx_linux.xwe";
      else
	return "ldscripts/elf32rx_linux.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32rx_linux.xce";
      else
	return "ldscripts/elf32rx_linux.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32rx_linux.xe";
      else
	return "ldscripts/elf32rx_linux.x";
    }
}
...
static bool
gldelf32rx_linux_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf32rx_linux_emulation =
{
  gldelf32rx_linux_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32rx_linux_before_plugin_all_symbols_read,
  gldelf32rx_linux_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32rx_linux_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32rx_linux_before_allocation,
  gldelf32rx_linux_get_script,
  "elf32rx_linux",
  "elf32-rx-linux",
  finish_default,
  ...
  NULL,
  gldelf32rx_linux_add_options,
  gldelf32rx_linux_handle_option,
  NULL,
  NULL,
  ldelf_load_symbols,
  NULL,
