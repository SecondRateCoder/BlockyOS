...
/* 32 bit ELF emulation code for score3_elf
...
static void gldscore3_elf_before_parse (void);
static void gldscore3_elf_before_plugin_all_symbols_read
  (void);
static void gldscore3_elf_after_open (void);
static void gldscore3_elf_before_allocation (void);
static void gldscore3_elf_after_allocation (void);


#include "elf32-score.h"

static void
gldscore3_elf_before_parse (void)
{
#ifndef TARGET_			/* I.e., if not generic.  */
  ldfile_set_output_arch ("score3", bfd_arch_unknown);
#endif /* not TARGET_ */
...
static void
gldscore3_elf_before_plugin_all_symbols_read (void)
{
...
static void
gldscore3_elf_before_allocation (void)
{
...
static void
gldscore3_elf_after_allocation (void)
{
...
static char *
gldscore3_elf_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/score3_elf.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/score3_elf.xr";
  else if (!config.text_read_only)
    return "ldscripts/score3_elf.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/score3_elf.xn";
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/score3_elf.xswe";
      else
	return "ldscripts/score3_elf.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/score3_elf.xsce";
      else
	return "ldscripts/score3_elf.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/score3_elf.xse";
      else
	return "ldscripts/score3_elf.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/score3_elf.xwe";
      else
	return "ldscripts/score3_elf.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/score3_elf.xce";
      else
	return "ldscripts/score3_elf.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/score3_elf.xe";
      else
	return "ldscripts/score3_elf.x";
    }
}
...
static bool
gldscore3_elf_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_score3_elf_emulation =
{
  gldscore3_elf_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldscore3_elf_before_plugin_all_symbols_read,
  score_elf_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldscore3_elf_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldscore3_elf_before_allocation,
  gldscore3_elf_get_script,
  "score3_elf",
  "elf32-bigscore",
  finish_default,
  NULL,
