...
static void gldelf32btsmip_before_plugin_all_symbols_read
  (void);
static void gldelf32btsmip_after_open (void);
static void gldelf32btsmip_before_allocation (void);
static void gldelf32btsmip_after_allocation (void);
...
static void
gldelf32btsmip_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32btsmip_after_allocation (void)
{
...
gldelf32btsmip_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32btsmip.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32btsmip.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32btsmip.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32btsmip.xn";
	...
	return "ldscripts/elf32btsmip.xdwe";
      else
	return "ldscripts/elf32btsmip.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32btsmip.xdce";
      else
	return "ldscripts/elf32btsmip.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32btsmip.xde";
      else
	return "ldscripts/elf32btsmip.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32btsmip.xswe";
      else
	return "ldscripts/elf32btsmip.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32btsmip.xsce";
      else
	return "ldscripts/elf32btsmip.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32btsmip.xse";
      else
	return "ldscripts/elf32btsmip.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32btsmip.xwe";
      else
	return "ldscripts/elf32btsmip.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32btsmip.xce";
      else
	return "ldscripts/elf32btsmip.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32btsmip.xe";
      else
	return "ldscripts/elf32btsmip.x";
    }
}
...
struct ld_emulation_xfer_struct ld_elf32btsmip_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldelf32btsmip_before_plugin_all_symbols_read,
  gldelf32btsmip_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32btsmip_after_allocation,
