...
/* 32 bit ELF emulation code for elf32lppcsim
...
static void gldelf32lppcsim_before_parse (void);
static void gldelf32lppcsim_before_plugin_all_symbols_read
  (void);
static void gldelf32lppcsim_after_open (void);
static void gldelf32lppcsim_before_allocation (void);
static void gldelf32lppcsim_after_allocation (void);
...
ppc_before_allocation (void)
{
  ...
  gldelf32lppcsim_before_allocation ();
  ...
  /* Turn on relaxation if executable sections have addresses that
  ...
  else if (!RELAXATION_DISABLED_BY_USER)
    {
	 ...
	 up gldelf32lppcsim_before_allocation sizing.  This
...
static void
gldelf32lppcsim_before_parse (void)
{
...
static void
gldelf32lppcsim_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32lppcsim_after_open (void)
{
...
static void
gldelf32lppcsim_before_allocation (void)
{
...
static void
gldelf32lppcsim_after_allocation (void)
{
...
static char *
gldelf32lppcsim_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32lppcsim.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32lppcsim.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32lppcsim.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32lppcsim.xn";
	...
	return "ldscripts/elf32lppcsim.xdwe";
      else
	return "ldscripts/elf32lppcsim.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppcsim.xdce";
      else
	return "ldscripts/elf32lppcsim.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppcsim.xde";
      else
	return "ldscripts/elf32lppcsim.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppcsim.xswe";
      else
	return "ldscripts/elf32lppcsim.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppcsim.xsce";
      else
	return "ldscripts/elf32lppcsim.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppcsim.xse";
      else
	return "ldscripts/elf32lppcsim.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppcsim.xwe";
      else
	return "ldscripts/elf32lppcsim.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppcsim.xce";
      else
	return "ldscripts/elf32lppcsim.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppcsim.xe";
      else
	return "ldscripts/elf32lppcsim.x";
    }
}
...
static bool
gldelf32lppcsim_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32lppcsim_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32lppcsim_emulation =
{
  gldelf32lppcsim_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32lppcsim_before_plugin_all_symbols_read,
  gldelf32lppcsim_after_open,
  ...
  NULL,
  gldelf32lppcsim_add_options,
  gldelf32lppcsim_handle_option,
  NULL,
  gldelf32lppcsim_list_options,
  ppc_recognized_file,
  NULL,
  NULL,
  NULL,
