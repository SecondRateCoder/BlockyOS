...
/* 32 bit ELF emulation code for armelfb_nacl
...
static void gldarmelfb_nacl_before_parse (void);
static void gldarmelfb_nacl_before_plugin_all_symbols_read
  (void);
static void gldarmelfb_nacl_after_open (void);
static void gldarmelfb_nacl_before_allocation (void);
static void gldarmelfb_nacl_after_allocation (void);
...
static void
gldarmelfb_nacl_before_parse (void)
{
...
static void
gldarmelfb_nacl_set_symbols (void)
{
...
arm_elf_before_allocation (void)
{
  ...
  gldarmelfb_nacl_before_allocation ();
}
...
static void
gldarmelfb_nacl_after_allocation (void)
{
  int ret;
...
static void
gldarmelfb_nacl_before_plugin_all_symbols_read (void)
{
...
static void
gldarmelfb_nacl_after_open (void)
{
...
static void
gldarmelfb_nacl_before_allocation (void)
{
...
static char *
gldarmelfb_nacl_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/armelfb_nacl.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/armelfb_nacl.xr";
  else if (!config.text_read_only)
    return "ldscripts/armelfb_nacl.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/armelfb_nacl.xn";
	...
	return "ldscripts/armelfb_nacl.xdwe";
      else
	return "ldscripts/armelfb_nacl.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_nacl.xdce";
      else
	return "ldscripts/armelfb_nacl.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_nacl.xde";
      else
	return "ldscripts/armelfb_nacl.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_nacl.xswe";
      else
	return "ldscripts/armelfb_nacl.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_nacl.xsce";
      else
	return "ldscripts/armelfb_nacl.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_nacl.xse";
      else
	return "ldscripts/armelfb_nacl.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_nacl.xwe";
      else
	return "ldscripts/armelfb_nacl.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_nacl.xce";
      else
	return "ldscripts/armelfb_nacl.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_nacl.xe";
      else
	return "ldscripts/armelfb_nacl.x";
    }
}
...
static bool
gldarmelfb_nacl_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldarmelfb_nacl_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_armelfb_nacl_emulation =
{
  gldarmelfb_nacl_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldarmelfb_nacl_before_plugin_all_symbols_read,
  gldarmelfb_nacl_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldarmelfb_nacl_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  arm_elf_before_allocation,
  gldarmelfb_nacl_get_script,
  "armelfb_nacl",
  "elf32-bigarm-nacl",
  gldarmelfb_nacl_finish,
  arm_elf_create_output_section_statements,
  ldelf_open_dynamic_archive,
  ldelf_place_orphan,
  gldarmelfb_nacl_set_symbols,
  NULL,
  gldarmelfb_nacl_add_options,
  gldarmelfb_nacl_handle_option,
  NULL,
  gldarmelfb_nacl_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
