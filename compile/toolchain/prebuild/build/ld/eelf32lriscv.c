...
static void gldelf32lriscv_before_plugin_all_symbols_read
  (void);
...
static void
gldelf32lriscv_before_plugin_all_symbols_read (void)
{
...
gldelf32lriscv_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32lriscv.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32lriscv.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32lriscv.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32lriscv.xn";
	...
	return "ldscripts/elf32lriscv.xdwe";
      else
	return "ldscripts/elf32lriscv.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lriscv.xdce";
      else
	return "ldscripts/elf32lriscv.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lriscv.xde";
      else
	return "ldscripts/elf32lriscv.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lriscv.xswe";
      else
	return "ldscripts/elf32lriscv.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lriscv.xsce";
      else
	return "ldscripts/elf32lriscv.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lriscv.xse";
      else
	return "ldscripts/elf32lriscv.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lriscv.xwe";
      else
	return "ldscripts/elf32lriscv.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lriscv.xce";
      else
	return "ldscripts/elf32lriscv.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lriscv.xe";
      else
	return "ldscripts/elf32lriscv.x";
    }
}
...
static void
gldelf32lriscv_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32lriscv_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldelf32lriscv_before_plugin_all_symbols_read,
