...
/* 32 bit ELF emulation code for arclinux
...
static void gldarclinux_before_parse (void);
static void gldarclinux_before_plugin_all_symbols_read
  (void);
static void gldarclinux_after_open (void);
static void gldarclinux_before_allocation (void);
static void gldarclinux_after_allocation (void);


static void
gldarclinux_before_parse (void)
{
...
static void
gldarclinux_before_plugin_all_symbols_read (void)
{
...
static void
gldarclinux_before_allocation (void)
{
...
static void
gldarclinux_after_allocation (void)
{
...
static char *
gldarclinux_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/arclinux.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/arclinux.xr";
  else if (!config.text_read_only)
    return "ldscripts/arclinux.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/arclinux.xn";
	...
	return "ldscripts/arclinux.xdwe";
      else
	return "ldscripts/arclinux.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/arclinux.xdce";
      else
	return "ldscripts/arclinux.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/arclinux.xde";
      else
	return "ldscripts/arclinux.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/arclinux.xswe";
      else
	return "ldscripts/arclinux.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/arclinux.xsce";
      else
	return "ldscripts/arclinux.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/arclinux.xse";
      else
	return "ldscripts/arclinux.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/arclinux.xwe";
      else
	return "ldscripts/arclinux.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/arclinux.xce";
      else
	return "ldscripts/arclinux.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/arclinux.xe";
      else
	return "ldscripts/arclinux.x";
    }
}
...
static bool
gldarclinux_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_arclinux_emulation =
{
  gldarclinux_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldarclinux_before_plugin_all_symbols_read,
  gldarclinux_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldarclinux_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldarclinux_before_allocation,
  gldarclinux_get_script,
  "arclinux",
  "elf32-littlearc",
  finish_default,
  NULL,
