...
/* 32 bit ELF emulation code for hppaobsd
...
static void gldhppaobsd_before_parse (void);
static void gldhppaobsd_before_plugin_all_symbols_read
  (void);
static void gldhppaobsd_after_open (void);
static void gldhppaobsd_before_allocation (void);
static void gldhppaobsd_after_allocation (void);
...
static void
gldhppaobsd_after_allocation (void)
{
  int ret;
...
static void
gldhppaobsd_before_plugin_all_symbols_read (void)
{
...
static void
gldhppaobsd_before_allocation (void)
{
...
static char *
gldhppaobsd_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/hppaobsd.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/hppaobsd.xr";
  else if (!config.text_read_only)
    return "ldscripts/hppaobsd.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/hppaobsd.xn";
	...
	return "ldscripts/hppaobsd.xdwe";
      else
	return "ldscripts/hppaobsd.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/hppaobsd.xdce";
      else
	return "ldscripts/hppaobsd.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/hppaobsd.xde";
      else
	return "ldscripts/hppaobsd.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/hppaobsd.xswe";
      else
	return "ldscripts/hppaobsd.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/hppaobsd.xsce";
      else
	return "ldscripts/hppaobsd.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/hppaobsd.xse";
      else
	return "ldscripts/hppaobsd.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/hppaobsd.xwe";
      else
	return "ldscripts/hppaobsd.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/hppaobsd.xce";
      else
	return "ldscripts/hppaobsd.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/hppaobsd.xe";
      else
	return "ldscripts/hppaobsd.x";
    }
}
...
static bool
gldhppaobsd_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldhppaobsd_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_hppaobsd_emulation =
{
  gldhppaobsd_before_parse,
  syslib_default,
  hll_default,
  hppaelf_after_parse,
  gldhppaobsd_before_plugin_all_symbols_read,
  gldhppaobsd_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldhppaobsd_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldhppaobsd_before_allocation,
  gldhppaobsd_get_script,
  "hppaobsd",
  "elf32-hppa",
  finish_default,
  ...
  NULL,
  gldhppaobsd_add_options,
  gldhppaobsd_handle_option,
  NULL,
  gldhppaobsd_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
