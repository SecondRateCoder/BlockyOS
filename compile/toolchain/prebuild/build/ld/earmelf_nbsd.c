...
/* 32 bit ELF emulation code for armelf_nbsd
...
static void gldarmelf_nbsd_before_parse (void);
static void gldarmelf_nbsd_before_plugin_all_symbols_read
  (void);
static void gldarmelf_nbsd_after_open (void);
static void gldarmelf_nbsd_before_allocation (void);
static void gldarmelf_nbsd_after_allocation (void);
...
static void
gldarmelf_nbsd_before_parse (void)
{
...
static void
gldarmelf_nbsd_set_symbols (void)
{
...
arm_elf_before_allocation (void)
{
  ...
  gldarmelf_nbsd_before_allocation ();
}
...
static void
gldarmelf_nbsd_after_allocation (void)
{
  int ret;
...
static void
gldarmelf_nbsd_before_plugin_all_symbols_read (void)
{
...
static void
gldarmelf_nbsd_after_open (void)
{
...
static void
gldarmelf_nbsd_before_allocation (void)
{
...
static char *
gldarmelf_nbsd_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/armelf_nbsd.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/armelf_nbsd.xr";
  else if (!config.text_read_only)
    return "ldscripts/armelf_nbsd.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/armelf_nbsd.xn";
	...
	return "ldscripts/armelf_nbsd.xdwe";
      else
	return "ldscripts/armelf_nbsd.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_nbsd.xdce";
      else
	return "ldscripts/armelf_nbsd.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_nbsd.xde";
      else
	return "ldscripts/armelf_nbsd.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_nbsd.xswe";
      else
	return "ldscripts/armelf_nbsd.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_nbsd.xsce";
      else
	return "ldscripts/armelf_nbsd.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_nbsd.xse";
      else
	return "ldscripts/armelf_nbsd.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_nbsd.xwe";
      else
	return "ldscripts/armelf_nbsd.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_nbsd.xce";
      else
	return "ldscripts/armelf_nbsd.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_nbsd.xe";
      else
	return "ldscripts/armelf_nbsd.x";
    }
}
...
static bool
gldarmelf_nbsd_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldarmelf_nbsd_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_armelf_nbsd_emulation =
{
  gldarmelf_nbsd_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldarmelf_nbsd_before_plugin_all_symbols_read,
  gldarmelf_nbsd_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldarmelf_nbsd_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  arm_elf_before_allocation,
  gldarmelf_nbsd_get_script,
  "armelf_nbsd",
  "elf32-littlearm",
  gldarmelf_nbsd_finish,
  arm_elf_create_output_section_statements,
  ldelf_open_dynamic_archive,
  ldelf_place_orphan,
  gldarmelf_nbsd_set_symbols,
  NULL,
  gldarmelf_nbsd_add_options,
  gldarmelf_nbsd_handle_option,
  NULL,
  gldarmelf_nbsd_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
