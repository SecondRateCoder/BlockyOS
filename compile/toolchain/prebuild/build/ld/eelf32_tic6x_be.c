...
/* 32 bit ELF emulation code for elf32_tic6x_be
...
#define TARGET_IS_elf32_tic6x_be
...
static void gldelf32_tic6x_be_before_parse (void);
static void gldelf32_tic6x_be_before_plugin_all_symbols_read
  (void);
static void gldelf32_tic6x_be_after_open (void);
static void gldelf32_tic6x_be_before_allocation (void);
static void gldelf32_tic6x_be_after_allocation (void);
...
static void
gldelf32_tic6x_be_after_allocation (void)
{
...
static void
gldelf32_tic6x_be_before_parse (void)
{
...
static void
gldelf32_tic6x_be_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32_tic6x_be_after_open (void)
{
...
static void
gldelf32_tic6x_be_before_allocation (void)
{
...
static char *
gldelf32_tic6x_be_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32_tic6x_be.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32_tic6x_be.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32_tic6x_be.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32_tic6x_be.xn";
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_tic6x_be.xswe";
      else
	return "ldscripts/elf32_tic6x_be.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_tic6x_be.xsce";
      else
	return "ldscripts/elf32_tic6x_be.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_tic6x_be.xse";
      else
	return "ldscripts/elf32_tic6x_be.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_tic6x_be.xwe";
      else
	return "ldscripts/elf32_tic6x_be.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_tic6x_be.xce";
      else
	return "ldscripts/elf32_tic6x_be.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_tic6x_be.xe";
      else
	return "ldscripts/elf32_tic6x_be.x";
    }
}
...
static bool
gldelf32_tic6x_be_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32_tic6x_be_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32_tic6x_be_emulation =
{
  gldelf32_tic6x_be_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32_tic6x_be_before_plugin_all_symbols_read,
  tic6x_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32_tic6x_be_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32_tic6x_be_before_allocation,
  gldelf32_tic6x_be_get_script,
  "elf32_tic6x_be",
  "elf32-tic6x-be",
  finish_default,
  NULL,
  ...
  NULL,
  gldelf32_tic6x_be_add_options,
  gldelf32_tic6x_be_handle_option,
  NULL,
  gldelf32_tic6x_be_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
