...
static void gldaarch64linux32b_before_plugin_all_symbols_read
  (void);
...
static void
gldaarch64linux32b_before_plugin_all_symbols_read (void)
{
...
{
  ldelf_before_allocation (audit, depaudit, "/lib/ld-linux-aarch64_be_ilp32.so.1");
}
...
gldaarch64linux32b_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/aarch64linux32b.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/aarch64linux32b.xr";
  else if (!config.text_read_only)
    return "ldscripts/aarch64linux32b.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/aarch64linux32b.xn";
	...
	return "ldscripts/aarch64linux32b.xdwe";
      else
	return "ldscripts/aarch64linux32b.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux32b.xdce";
      else
	return "ldscripts/aarch64linux32b.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux32b.xde";
      else
	return "ldscripts/aarch64linux32b.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux32b.xswe";
      else
	return "ldscripts/aarch64linux32b.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux32b.xsce";
      else
	return "ldscripts/aarch64linux32b.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux32b.xse";
      else
	return "ldscripts/aarch64linux32b.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux32b.xwe";
      else
	return "ldscripts/aarch64linux32b.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux32b.xce";
      else
	return "ldscripts/aarch64linux32b.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64linux32b.xe";
      else
	return "ldscripts/aarch64linux32b.x";
    }
}
...
struct ld_emulation_xfer_struct ld_aarch64linux32b_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldaarch64linux32b_before_plugin_all_symbols_read,
