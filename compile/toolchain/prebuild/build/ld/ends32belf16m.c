...
/* 32 bit ELF emulation code for nds32belf16m
...
static void gldnds32belf16m_before_parse (void);
static void gldnds32belf16m_before_plugin_all_symbols_read
  (void);
static void gldnds32belf16m_after_open (void);
static void gldnds32belf16m_before_allocation (void);
static void gldnds32belf16m_after_allocation (void);
...
nds32_elf_after_allocation (void)
{
  ...
  gldnds32belf16m_after_allocation ();
}


static void
gldnds32belf16m_before_parse (void)
{
...
static void
gldnds32belf16m_before_plugin_all_symbols_read (void)
{
...
static void
gldnds32belf16m_after_open (void)
{
...
static void
gldnds32belf16m_before_allocation (void)
{
...
static void
gldnds32belf16m_after_allocation (void)
{
...
static char *
gldnds32belf16m_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/nds32belf16m.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/nds32belf16m.xr";
  else if (!config.text_read_only)
    return "ldscripts/nds32belf16m.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/nds32belf16m.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/nds32belf16m.xe";
      else
	return "ldscripts/nds32belf16m.x";
    }
}
...
static bool
gldnds32belf16m_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldnds32belf16m_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_nds32belf16m_emulation =
{
  gldnds32belf16m_before_parse,
  syslib_default,
  hll_default,
  nds32_elf_after_parse,
  gldnds32belf16m_before_plugin_all_symbols_read,
  ...
  gldnds32belf16m_before_allocation,
  gldnds32belf16m_get_script,
  "nds32belf16m",
  "elf32-nds32be",
  finish_default,
  ...
  NULL,
  gldnds32belf16m_add_options,
  gldnds32belf16m_handle_option,
  NULL,
  gldnds32belf16m_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
