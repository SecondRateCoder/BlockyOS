...
/* 64 bit ELF emulation code for aarch64haiku
...
static void gldaarch64haiku_before_parse (void);
static void gldaarch64haiku_before_plugin_all_symbols_read
  (void);
static void gldaarch64haiku_after_open (void);
static void gldaarch64haiku_before_allocation (void);
static void gldaarch64haiku_after_allocation (void);
...
static void
gldaarch64haiku_before_parse (void)
{
...
aarch64_elf_before_allocation (void)
{
  ...
  gldaarch64haiku_before_allocation ();
}
...
static void
gldaarch64haiku_after_allocation (void)
{
  int ret;
...
static void
gldaarch64haiku_before_plugin_all_symbols_read (void)
{
...
static void
gldaarch64haiku_after_open (void)
{
...
static void
gldaarch64haiku_before_allocation (void)
{
...
static char *
gldaarch64haiku_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/aarch64haiku.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/aarch64haiku.xr";
  else if (!config.text_read_only)
    return "ldscripts/aarch64haiku.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/aarch64haiku.xn";
	...
	return "ldscripts/aarch64haiku.xdwe";
      else
	return "ldscripts/aarch64haiku.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64haiku.xdce";
      else
	return "ldscripts/aarch64haiku.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64haiku.xde";
      else
	return "ldscripts/aarch64haiku.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64haiku.xswe";
      else
	return "ldscripts/aarch64haiku.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64haiku.xsce";
      else
	return "ldscripts/aarch64haiku.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64haiku.xse";
      else
	return "ldscripts/aarch64haiku.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64haiku.xwe";
      else
	return "ldscripts/aarch64haiku.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64haiku.xce";
      else
	return "ldscripts/aarch64haiku.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64haiku.xe";
      else
	return "ldscripts/aarch64haiku.x";
    }
}
...
static bool
gldaarch64haiku_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldaarch64haiku_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_aarch64haiku_emulation =
{
  gldaarch64haiku_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldaarch64haiku_before_plugin_all_symbols_read,
  gldaarch64haiku_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldaarch64haiku_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  aarch64_elf_before_allocation,
  gldaarch64haiku_get_script,
  "aarch64haiku",
  "elf64-littleaarch64",
  gldaarch64haiku_finish,
  ...
  NULL,
  gldaarch64haiku_add_options,
  gldaarch64haiku_handle_option,
  NULL,
  gldaarch64haiku_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
