...
static void gldelf_i386_fbsd_before_plugin_all_symbols_read
  (void);
static void gldelf_i386_fbsd_after_open (void);
static void gldelf_i386_fbsd_before_allocation (void);
static void gldelf_i386_fbsd_after_allocation (void);
...
static void
gldelf_i386_fbsd_before_plugin_all_symbols_read (void)
{
...
static void
gldelf_i386_fbsd_after_allocation (void)
{
...
gldelf_i386_fbsd_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf_i386_fbsd.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf_i386_fbsd.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf_i386_fbsd.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf_i386_fbsd.xn";
	...
	return "ldscripts/elf_i386_fbsd.xdwe";
      else
	return "ldscripts/elf_i386_fbsd.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_fbsd.xdce";
      else
	return "ldscripts/elf_i386_fbsd.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_fbsd.xde";
      else
	return "ldscripts/elf_i386_fbsd.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_fbsd.xswe";
      else
	return "ldscripts/elf_i386_fbsd.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_fbsd.xsce";
      else
	return "ldscripts/elf_i386_fbsd.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_fbsd.xse";
      else
	return "ldscripts/elf_i386_fbsd.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_fbsd.xwe";
      else
	return "ldscripts/elf_i386_fbsd.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_fbsd.xce";
      else
	return "ldscripts/elf_i386_fbsd.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_fbsd.xe";
      else
	return "ldscripts/elf_i386_fbsd.x";
    }
}
...
struct ld_emulation_xfer_struct ld_elf_i386_fbsd_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldelf_i386_fbsd_before_plugin_all_symbols_read,
  gldelf_i386_fbsd_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf_i386_fbsd_after_allocation,
