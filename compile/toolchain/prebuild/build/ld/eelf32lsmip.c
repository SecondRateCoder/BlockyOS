...
/* 32 bit ELF emulation code for elf32lsmip
...
static void gldelf32lsmip_before_parse (void);
static void gldelf32lsmip_before_plugin_all_symbols_read
  (void);
static void gldelf32lsmip_after_open (void);
static void gldelf32lsmip_before_allocation (void);
static void gldelf32lsmip_after_allocation (void);
...
mips_before_allocation (void)
{
  ...
  gldelf32lsmip_before_allocation ();
}


static void
gldelf32lsmip_before_parse (void)
{
...
static void
gldelf32lsmip_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32lsmip_before_allocation (void)
{
...
static void
gldelf32lsmip_after_allocation (void)
{
...
static char *
gldelf32lsmip_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32lsmip.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32lsmip.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32lsmip.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32lsmip.xn";
	...
	return "ldscripts/elf32lsmip.xdwe";
      else
	return "ldscripts/elf32lsmip.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lsmip.xdce";
      else
	return "ldscripts/elf32lsmip.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lsmip.xde";
      else
	return "ldscripts/elf32lsmip.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lsmip.xswe";
      else
	return "ldscripts/elf32lsmip.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lsmip.xsce";
      else
	return "ldscripts/elf32lsmip.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lsmip.xse";
      else
	return "ldscripts/elf32lsmip.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lsmip.xwe";
      else
	return "ldscripts/elf32lsmip.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lsmip.xce";
      else
	return "ldscripts/elf32lsmip.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lsmip.xe";
      else
	return "ldscripts/elf32lsmip.x";
    }
}
...
static bool
gldelf32lsmip_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32lsmip_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32lsmip_emulation =
{
  gldelf32lsmip_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32lsmip_before_plugin_all_symbols_read,
  gldelf32lsmip_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32lsmip_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  mips_before_allocation,
  gldelf32lsmip_get_script,
  "elf32lsmip",
  "elf32-littlemips",
  finish_default,
  ...
  NULL,
  gldelf32lsmip_add_options,
  gldelf32lsmip_handle_option,
  NULL,
  gldelf32lsmip_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
