...
/* 32 bit ELF emulation code for shlelf_nbsd
...
static void gldshlelf_nbsd_before_parse (void);
static void gldshlelf_nbsd_before_plugin_all_symbols_read
  (void);
static void gldshlelf_nbsd_after_open (void);
static void gldshlelf_nbsd_before_allocation (void);
static void gldshlelf_nbsd_after_allocation (void);


static void
gldshlelf_nbsd_before_parse (void)
{
...
static void
gldshlelf_nbsd_before_plugin_all_symbols_read (void)
{
...
static void
gldshlelf_nbsd_after_open (void)
{
...
static void
gldshlelf_nbsd_before_allocation (void)
{
...
static void
gldshlelf_nbsd_after_allocation (void)
{
...
static char *
gldshlelf_nbsd_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/shlelf_nbsd.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/shlelf_nbsd.xr";
  else if (!config.text_read_only)
    return "ldscripts/shlelf_nbsd.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/shlelf_nbsd.xn";
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_nbsd.xswe";
      else
	return "ldscripts/shlelf_nbsd.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_nbsd.xsce";
      else
	return "ldscripts/shlelf_nbsd.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_nbsd.xse";
      else
	return "ldscripts/shlelf_nbsd.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_nbsd.xwe";
      else
	return "ldscripts/shlelf_nbsd.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_nbsd.xce";
      else
	return "ldscripts/shlelf_nbsd.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_nbsd.xe";
      else
	return "ldscripts/shlelf_nbsd.x";
    }
}
...
static bool
gldshlelf_nbsd_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_shlelf_nbsd_emulation =
{
  gldshlelf_nbsd_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldshlelf_nbsd_before_plugin_all_symbols_read,
  gldshlelf_nbsd_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldshlelf_nbsd_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldshlelf_nbsd_before_allocation,
  gldshlelf_nbsd_get_script,
  "shlelf_nbsd",
  "elf32-shl-nbsd",
  finish_default,
  NULL,
