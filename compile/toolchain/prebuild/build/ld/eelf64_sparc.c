...
/* 64 bit ELF emulation code for elf64_sparc
...
static void gldelf64_sparc_before_parse (void);
static void gldelf64_sparc_before_plugin_all_symbols_read
  (void);
static void gldelf64_sparc_after_open (void);
static void gldelf64_sparc_before_allocation (void);
static void gldelf64_sparc_after_allocation (void);


static void
gldelf64_sparc_before_parse (void)
{
...
static void
gldelf64_sparc_before_plugin_all_symbols_read (void)
{
...
static void
gldelf64_sparc_after_open (void)
{
...
static void
gldelf64_sparc_before_allocation (void)
{
...
static void
gldelf64_sparc_after_allocation (void)
{
...
static char *
gldelf64_sparc_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf64_sparc.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf64_sparc.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf64_sparc.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf64_sparc.xn";
	...
	return "ldscripts/elf64_sparc.xdwe";
      else
	return "ldscripts/elf64_sparc.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc.xdce";
      else
	return "ldscripts/elf64_sparc.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc.xde";
      else
	return "ldscripts/elf64_sparc.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc.xswe";
      else
	return "ldscripts/elf64_sparc.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc.xsce";
      else
	return "ldscripts/elf64_sparc.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc.xse";
      else
	return "ldscripts/elf64_sparc.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc.xwe";
      else
	return "ldscripts/elf64_sparc.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc.xce";
      else
	return "ldscripts/elf64_sparc.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf64_sparc.xe";
      else
	return "ldscripts/elf64_sparc.x";
    }
}
...
static bool
gldelf64_sparc_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf64_sparc_emulation =
{
  gldelf64_sparc_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf64_sparc_before_plugin_all_symbols_read,
  gldelf64_sparc_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf64_sparc_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf64_sparc_before_allocation,
  gldelf64_sparc_get_script,
  "elf64_sparc",
  "elf64-sparc",
  finish_default,
  NULL,
