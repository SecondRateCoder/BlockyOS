...
/* 32 bit ELF emulation code for elf_i386_haiku
...
#define TARGET_IS_elf_i386_haiku
...
static void gldelf_i386_haiku_before_parse (void);
static void gldelf_i386_haiku_before_plugin_all_symbols_read
  (void);
static void gldelf_i386_haiku_after_open (void);
static void gldelf_i386_haiku_before_allocation (void);
static void gldelf_i386_haiku_after_allocation (void);
...
elf_x86_before_parse (void)
{
  ...
  gldelf_i386_haiku_before_parse ();
}


static void
gldelf_i386_haiku_before_parse (void)
{
...
static void
gldelf_i386_haiku_before_plugin_all_symbols_read (void)
{
...
static void
gldelf_i386_haiku_after_open (void)
{
...
static void
gldelf_i386_haiku_before_allocation (void)
{
...
static void
gldelf_i386_haiku_after_allocation (void)
{
...
static char *
gldelf_i386_haiku_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf_i386_haiku.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf_i386_haiku.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf_i386_haiku.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf_i386_haiku.xn";
	...
	return "ldscripts/elf_i386_haiku.xdwe";
      else
	return "ldscripts/elf_i386_haiku.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_haiku.xdce";
      else
	return "ldscripts/elf_i386_haiku.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_haiku.xde";
      else
	return "ldscripts/elf_i386_haiku.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_haiku.xswe";
      else
	return "ldscripts/elf_i386_haiku.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_haiku.xsce";
      else
	return "ldscripts/elf_i386_haiku.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_haiku.xse";
      else
	return "ldscripts/elf_i386_haiku.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_haiku.xwe";
      else
	return "ldscripts/elf_i386_haiku.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_haiku.xce";
      else
	return "ldscripts/elf_i386_haiku.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_haiku.xe";
      else
	return "ldscripts/elf_i386_haiku.x";
    }
}
...
static bool
gldelf_i386_haiku_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf_i386_haiku_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf_i386_haiku_emulation =
{
  elf_x86_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf_i386_haiku_before_plugin_all_symbols_read,
  gldelf_i386_haiku_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf_i386_haiku_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf_i386_haiku_before_allocation,
  gldelf_i386_haiku_get_script,
  "elf_i386_haiku",
  "elf32-i386",
  finish_default,
  ...
  NULL,
  gldelf_i386_haiku_add_options,
  gldelf_i386_haiku_handle_option,
  NULL,
  gldelf_i386_haiku_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
