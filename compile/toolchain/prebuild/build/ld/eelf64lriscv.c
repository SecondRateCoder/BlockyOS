...
static void gldelf64lriscv_before_plugin_all_symbols_read
  (void);
...
static void
gldelf64lriscv_before_plugin_all_symbols_read (void)
{
...
gldelf64lriscv_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf64lriscv.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf64lriscv.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf64lriscv.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf64lriscv.xn";
	...
	return "ldscripts/elf64lriscv.xdwe";
      else
	return "ldscripts/elf64lriscv.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lriscv.xdce";
      else
	return "ldscripts/elf64lriscv.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lriscv.xde";
      else
	return "ldscripts/elf64lriscv.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lriscv.xswe";
      else
	return "ldscripts/elf64lriscv.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lriscv.xsce";
      else
	return "ldscripts/elf64lriscv.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lriscv.xse";
      else
	return "ldscripts/elf64lriscv.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lriscv.xwe";
      else
	return "ldscripts/elf64lriscv.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lriscv.xce";
      else
	return "ldscripts/elf64lriscv.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lriscv.xe";
      else
	return "ldscripts/elf64lriscv.x";
    }
}
...
static void
gldelf64lriscv_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf64lriscv_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldelf64lriscv_before_plugin_all_symbols_read,
