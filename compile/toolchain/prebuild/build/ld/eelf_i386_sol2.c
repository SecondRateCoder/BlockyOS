...
/* 32 bit ELF emulation code for elf_i386_sol2
...
#define TARGET_IS_elf_i386_sol2
...
static void gldelf_i386_sol2_before_parse (void);
static void gldelf_i386_sol2_before_plugin_all_symbols_read
  (void);
static void gldelf_i386_sol2_after_open (void);
static void gldelf_i386_sol2_before_allocation (void);
static void gldelf_i386_sol2_after_allocation (void);
...
elf_x86_before_parse (void)
{
  ...
  gldelf_i386_sol2_before_parse ();
}

/* This file is generated by a shell script.  DO NOT EDIT! */

/* Solaris 2 emulation code for elf_i386_sol2
...
elf_solaris2_before_allocation (void)
{
  ...
  gldelf_i386_sol2_before_allocation ();
}


static void
gldelf_i386_sol2_before_parse (void)
{
...
static void
gldelf_i386_sol2_before_plugin_all_symbols_read (void)
{
...
static void
gldelf_i386_sol2_after_open (void)
{
...
static void
gldelf_i386_sol2_before_allocation (void)
{
  ldelf_before_allocation (audit, depaudit, "/usr/lib/ld.so.1");
}


static void
gldelf_i386_sol2_after_allocation (void)
{
...
static char *
gldelf_i386_sol2_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf_i386_sol2.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf_i386_sol2.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf_i386_sol2.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf_i386_sol2.xn";
	...
	return "ldscripts/elf_i386_sol2.xdwe";
      else
	return "ldscripts/elf_i386_sol2.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_sol2.xdce";
      else
	return "ldscripts/elf_i386_sol2.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_sol2.xde";
      else
	return "ldscripts/elf_i386_sol2.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_sol2.xswe";
      else
	return "ldscripts/elf_i386_sol2.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_sol2.xsce";
      else
	return "ldscripts/elf_i386_sol2.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_sol2.xse";
      else
	return "ldscripts/elf_i386_sol2.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_sol2.xwe";
      else
	return "ldscripts/elf_i386_sol2.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_sol2.xce";
      else
	return "ldscripts/elf_i386_sol2.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386_sol2.xe";
      else
	return "ldscripts/elf_i386_sol2.x";
    }
}
...
static bool
gldelf_i386_sol2_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf_i386_sol2_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf_i386_sol2_emulation =
{
  elf_x86_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf_i386_sol2_before_plugin_all_symbols_read,
  gldelf_i386_sol2_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf_i386_sol2_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  elf_solaris2_before_allocation,
  gldelf_i386_sol2_get_script,
  "elf_i386_sol2",
  "elf32-i386-sol2",
  finish_default,
  ...
  NULL,
  gldelf_i386_sol2_add_options,
  gldelf_i386_sol2_handle_option,
  NULL,
  gldelf_i386_sol2_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
