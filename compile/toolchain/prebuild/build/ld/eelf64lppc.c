...
gldelf64lppc_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf64lppc.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf64lppc.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf64lppc.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf64lppc.xn";
	...
	return "ldscripts/elf64lppc.xdwe";
      else
	return "ldscripts/elf64lppc.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lppc.xdce";
      else
	return "ldscripts/elf64lppc.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lppc.xde";
      else
	return "ldscripts/elf64lppc.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lppc.xswe";
      else
	return "ldscripts/elf64lppc.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lppc.xsce";
      else
	return "ldscripts/elf64lppc.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lppc.xse";
      else
	return "ldscripts/elf64lppc.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lppc.xwe";
      else
	return "ldscripts/elf64lppc.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lppc.xce";
      else
	return "ldscripts/elf64lppc.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf64lppc.xe";
      else
	return "ldscripts/elf64lppc.x";
    }
}
