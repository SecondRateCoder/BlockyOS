...
static void gldelf32ltsmipn32_before_plugin_all_symbols_read
  (void);
static void gldelf32ltsmipn32_after_open (void);
static void gldelf32ltsmipn32_before_allocation (void);
static void gldelf32ltsmipn32_after_allocation (void);
...
static void
gldelf32ltsmipn32_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32ltsmipn32_after_allocation (void)
{
...
gldelf32ltsmipn32_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
	...
	return "ldscripts/elf32ltsmipn32.xdwe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmipn32.xdce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmipn32.xde";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmipn32.xswe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmipn32.xsce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmipn32.xse";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmipn32.xwe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmipn32.xce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmipn32.xe";
      else
...
struct ld_emulation_xfer_struct ld_elf32ltsmipn32_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldelf32ltsmipn32_before_plugin_all_symbols_read,
  gldelf32ltsmipn32_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32ltsmipn32_after_allocation,
