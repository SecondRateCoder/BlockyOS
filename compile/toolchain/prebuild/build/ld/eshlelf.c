...
/* 32 bit ELF emulation code for shlelf
...
static void gldshlelf_before_parse (void);
static void gldshlelf_before_plugin_all_symbols_read
  (void);
static void gldshlelf_after_open (void);
static void gldshlelf_before_allocation (void);
static void gldshlelf_after_allocation (void);


static void
gldshlelf_before_parse (void)
{
...
static void
gldshlelf_before_plugin_all_symbols_read (void)
{
...
static void
gldshlelf_before_allocation (void)
{
...
static void
gldshlelf_after_allocation (void)
{
...
static char *
gldshlelf_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/shlelf.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/shlelf.xr";
  else if (!config.text_read_only)
    return "ldscripts/shlelf.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/shlelf.xn";
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf.xswe";
      else
	return "ldscripts/shlelf.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf.xsce";
      else
	return "ldscripts/shlelf.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf.xse";
      else
	return "ldscripts/shlelf.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf.xwe";
      else
	return "ldscripts/shlelf.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf.xce";
      else
	return "ldscripts/shlelf.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf.xe";
      else
	return "ldscripts/shlelf.x";
    }
}
...
static bool
gldshlelf_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_shlelf_emulation =
{
  gldshlelf_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldshlelf_before_plugin_all_symbols_read,
  gldshlelf_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldshlelf_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldshlelf_before_allocation,
  gldshlelf_get_script,
  "shlelf",
  "elf32-shl",
  finish_default,
  NULL,
