...
/* 32 bit ELF emulation code for elf32epiphany_4x4
...
#define TARGET_IS_elf32epiphany_4x4
...
static void gldelf32epiphany_4x4_before_parse (void);
static void gldelf32epiphany_4x4_before_plugin_all_symbols_read
  (void);
static void gldelf32epiphany_4x4_after_open (void);
static void gldelf32epiphany_4x4_before_allocation (void);
static void gldelf32epiphany_4x4_after_allocation (void);




static void
gldelf32epiphany_4x4_before_parse (void)
{
...
static void
gldelf32epiphany_4x4_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32epiphany_4x4_after_open (void)
{
...
static void
gldelf32epiphany_4x4_before_allocation (void)
{
...
static void
gldelf32epiphany_4x4_after_allocation (void)
{
...
static char *
gldelf32epiphany_4x4_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32epiphany_4x4.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32epiphany_4x4.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32epiphany_4x4.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32epiphany_4x4.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32epiphany_4x4.xe";
      else
	return "ldscripts/elf32epiphany_4x4.x";
    }
}
...
static void
gldelf32epiphany_4x4_add_options
...
static bool
gldelf32epiphany_4x4_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf32epiphany_4x4_emulation =
{
  gldelf32epiphany_4x4_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32epiphany_4x4_before_plugin_all_symbols_read,
  gldelf32epiphany_4x4_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32epiphany_4x4_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32epiphany_4x4_before_allocation,
  gldelf32epiphany_4x4_get_script,
  "elf32epiphany_4x4",
  "elf32-epiphany",
  finish_default,
  NULL,
  ...
  NULL,
  gldelf32epiphany_4x4_add_options,
  gldelf32epiphany_4x4_handle_option,
  NULL,
  NULL,
  ldelf_load_symbols,
  NULL,
