...
/* 64 bit ELF emulation code for elf64bmip
...
static void gldelf64bmip_before_parse (void);
static void gldelf64bmip_before_plugin_all_symbols_read
  (void);
static void gldelf64bmip_after_open (void);
static void gldelf64bmip_before_allocation (void);
static void gldelf64bmip_after_allocation (void);
...
mips_before_allocation (void)
{
  ...
  gldelf64bmip_before_allocation ();
}


static void
gldelf64bmip_before_parse (void)
{
...
static void
gldelf64bmip_before_plugin_all_symbols_read (void)
{
...
static void
gldelf64bmip_before_allocation (void)
{
...
static void
gldelf64bmip_after_allocation (void)
{
...
static char *
gldelf64bmip_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf64bmip.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf64bmip.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf64bmip.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf64bmip.xn";
	...
	return "ldscripts/elf64bmip.xdwe";
      else
	return "ldscripts/elf64bmip.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64bmip.xdce";
      else
	return "ldscripts/elf64bmip.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64bmip.xde";
      else
	return "ldscripts/elf64bmip.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64bmip.xswe";
      else
	return "ldscripts/elf64bmip.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64bmip.xsce";
      else
	return "ldscripts/elf64bmip.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64bmip.xse";
      else
	return "ldscripts/elf64bmip.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64bmip.xwe";
      else
	return "ldscripts/elf64bmip.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64bmip.xce";
      else
	return "ldscripts/elf64bmip.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf64bmip.xe";
      else
	return "ldscripts/elf64bmip.x";
    }
}
...
static bool
gldelf64bmip_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf64bmip_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf64bmip_emulation =
{
  gldelf64bmip_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf64bmip_before_plugin_all_symbols_read,
  irix_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf64bmip_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  mips_before_allocation,
  gldelf64bmip_get_script,
  "elf64bmip",
  "elf64-bigmips",
  finish_default,
  ...
  NULL,
  gldelf64bmip_add_options,
  gldelf64bmip_handle_option,
  NULL,
  gldelf64bmip_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
