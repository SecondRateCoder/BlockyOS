...
/* 64 bit ELF emulation code for aarch64cloudabib
...
#define TARGET_IS_aarch64cloudabib
...
static void gldaarch64cloudabib_before_parse (void);
static void gldaarch64cloudabib_before_plugin_all_symbols_read
  (void);
static void gldaarch64cloudabib_after_open (void);
static void gldaarch64cloudabib_before_allocation (void);
static void gldaarch64cloudabib_after_allocation (void);
...
static void
gldaarch64cloudabib_before_parse (void)
{
...
aarch64_elf_before_allocation (void)
{
  ...
  gldaarch64cloudabib_before_allocation ();
}
...
static void
gldaarch64cloudabib_after_allocation (void)
{
  int ret;
...
static void
gldaarch64cloudabib_finish (void)
{
...
static void
gldaarch64cloudabib_before_plugin_all_symbols_read (void)
{
...
static void
gldaarch64cloudabib_after_open (void)
{
...
static void
gldaarch64cloudabib_before_allocation (void)
{
...
static char *
gldaarch64cloudabib_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/aarch64cloudabib.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/aarch64cloudabib.xr";
  else if (!config.text_read_only)
    return "ldscripts/aarch64cloudabib.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/aarch64cloudabib.xn";
	...
	return "ldscripts/aarch64cloudabib.xdwe";
      else
	return "ldscripts/aarch64cloudabib.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64cloudabib.xdce";
      else
	return "ldscripts/aarch64cloudabib.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64cloudabib.xde";
      else
	return "ldscripts/aarch64cloudabib.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64cloudabib.xswe";
      else
	return "ldscripts/aarch64cloudabib.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64cloudabib.xsce";
      else
	return "ldscripts/aarch64cloudabib.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64cloudabib.xse";
      else
	return "ldscripts/aarch64cloudabib.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64cloudabib.xwe";
      else
	return "ldscripts/aarch64cloudabib.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64cloudabib.xce";
      else
	return "ldscripts/aarch64cloudabib.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64cloudabib.xe";
      else
	return "ldscripts/aarch64cloudabib.x";
    }
}
...
static void
gldaarch64cloudabib_add_options
...
static bool
gldaarch64cloudabib_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldaarch64cloudabib_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_aarch64cloudabib_emulation =
{
  gldaarch64cloudabib_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldaarch64cloudabib_before_plugin_all_symbols_read,
  gldaarch64cloudabib_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldaarch64cloudabib_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  aarch64_elf_before_allocation,
  gldaarch64cloudabib_get_script,
  "aarch64cloudabib",
  "elf64-bigaarch64-cloudabi",
  gldaarch64cloudabib_finish,
  ...
  NULL,
  gldaarch64cloudabib_add_options,
  gldaarch64cloudabib_handle_option,
  NULL,
  gldaarch64cloudabib_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
