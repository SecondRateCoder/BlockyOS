...
/* 32 bit ELF emulation code for elf32lr5900
...
static void gldelf32lr5900_before_parse (void);
static void gldelf32lr5900_before_plugin_all_symbols_read
  (void);
static void gldelf32lr5900_after_open (void);
static void gldelf32lr5900_before_allocation (void);
static void gldelf32lr5900_after_allocation (void);
...
mips_before_allocation (void)
{
  ...
  gldelf32lr5900_before_allocation ();
}


static void
gldelf32lr5900_before_parse (void)
{
...
static void
gldelf32lr5900_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32lr5900_after_open (void)
{
...
static void
gldelf32lr5900_before_allocation (void)
{
...
static void
gldelf32lr5900_after_allocation (void)
{
...
static char *
gldelf32lr5900_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32lr5900.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32lr5900.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32lr5900.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32lr5900.xn";
	...
	return "ldscripts/elf32lr5900.xdwe";
      else
	return "ldscripts/elf32lr5900.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lr5900.xdce";
      else
	return "ldscripts/elf32lr5900.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lr5900.xde";
      else
	return "ldscripts/elf32lr5900.xd";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lr5900.xwe";
      else
	return "ldscripts/elf32lr5900.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lr5900.xce";
      else
	return "ldscripts/elf32lr5900.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lr5900.xe";
      else
	return "ldscripts/elf32lr5900.x";
    }
}
...
static bool
gldelf32lr5900_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32lr5900_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32lr5900_emulation =
{
  gldelf32lr5900_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32lr5900_before_plugin_all_symbols_read,
  gldelf32lr5900_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32lr5900_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  mips_before_allocation,
  gldelf32lr5900_get_script,
  "elf32lr5900",
  "elf32-littlemips",
  finish_default,
  ...
  NULL,
  gldelf32lr5900_add_options,
  gldelf32lr5900_handle_option,
  NULL,
  gldelf32lr5900_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
