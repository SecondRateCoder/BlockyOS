...
gldelf32ltsmip_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
	...
	return "ldscripts/elf32ltsmip.xdwe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmip.xdce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmip.xde";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmip.xswe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmip.xsce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmip.xse";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmip.xwe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmip.xce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ltsmip.xe";
      else
