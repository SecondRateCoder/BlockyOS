...
/* 64 bit ELF emulation code for aarch64fbsd
...
static void gldaarch64fbsd_before_parse (void);
static void gldaarch64fbsd_before_plugin_all_symbols_read
  (void);
static void gldaarch64fbsd_after_open (void);
static void gldaarch64fbsd_before_allocation (void);
static void gldaarch64fbsd_after_allocation (void);
...
static void
gldaarch64fbsd_before_parse (void)
{
...
aarch64_elf_before_allocation (void)
{
  ...
  gldaarch64fbsd_before_allocation ();
}
...
static void
gldaarch64fbsd_after_allocation (void)
{
  int ret;
...
static void
gldaarch64fbsd_before_plugin_all_symbols_read (void)
{
...
static void
gldaarch64fbsd_after_open (void)
{
...
static void
gldaarch64fbsd_before_allocation (void)
{
...
static char *
gldaarch64fbsd_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/aarch64fbsd.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/aarch64fbsd.xr";
  else if (!config.text_read_only)
    return "ldscripts/aarch64fbsd.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/aarch64fbsd.xn";
	...
	return "ldscripts/aarch64fbsd.xdwe";
      else
	return "ldscripts/aarch64fbsd.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64fbsd.xdce";
      else
	return "ldscripts/aarch64fbsd.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64fbsd.xde";
      else
	return "ldscripts/aarch64fbsd.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64fbsd.xswe";
      else
	return "ldscripts/aarch64fbsd.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64fbsd.xsce";
      else
	return "ldscripts/aarch64fbsd.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64fbsd.xse";
      else
	return "ldscripts/aarch64fbsd.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64fbsd.xwe";
      else
	return "ldscripts/aarch64fbsd.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64fbsd.xce";
      else
	return "ldscripts/aarch64fbsd.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64fbsd.xe";
      else
	return "ldscripts/aarch64fbsd.x";
    }
}
...
static bool
gldaarch64fbsd_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldaarch64fbsd_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_aarch64fbsd_emulation =
{
  gldaarch64fbsd_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldaarch64fbsd_before_plugin_all_symbols_read,
  gldaarch64fbsd_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldaarch64fbsd_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  aarch64_elf_before_allocation,
  gldaarch64fbsd_get_script,
  "aarch64fbsd",
  "elf64-littleaarch64",
  gldaarch64fbsd_finish,
  ...
  NULL,
  gldaarch64fbsd_add_options,
  gldaarch64fbsd_handle_option,
  NULL,
  gldaarch64fbsd_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
