...
/* 32 bit ELF emulation code for armelf_vxworks
...
#define TARGET_IS_armelf_vxworks
...
static void gldarmelf_vxworks_before_parse (void);
static void gldarmelf_vxworks_before_plugin_all_symbols_read
  (void);
static void gldarmelf_vxworks_after_open (void);
static void gldarmelf_vxworks_before_allocation (void);
static void gldarmelf_vxworks_after_allocation (void);
...
static void
gldarmelf_vxworks_before_parse (void)
{
...
static void
gldarmelf_vxworks_set_symbols (void)
{
...
arm_elf_before_allocation (void)
{
  ...
  gldarmelf_vxworks_before_allocation ();
}
...
static void
gldarmelf_vxworks_after_allocation (void)
{
  int ret;
...
#define gldarmelf_vxworks_before_parse vxworks_before_parse
...
static void
gldarmelf_vxworks_before_plugin_all_symbols_read (void)
{
...
static void
gldarmelf_vxworks_after_open (void)
{
...
static void
gldarmelf_vxworks_before_allocation (void)
{
...
static char *
gldarmelf_vxworks_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/armelf_vxworks.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/armelf_vxworks.xr";
  else if (!config.text_read_only)
    return "ldscripts/armelf_vxworks.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/armelf_vxworks.xn";
	...
	return "ldscripts/armelf_vxworks.xdwe";
      else
	return "ldscripts/armelf_vxworks.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_vxworks.xdce";
      else
	return "ldscripts/armelf_vxworks.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_vxworks.xde";
      else
	return "ldscripts/armelf_vxworks.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_vxworks.xswe";
      else
	return "ldscripts/armelf_vxworks.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_vxworks.xsce";
      else
	return "ldscripts/armelf_vxworks.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_vxworks.xse";
      else
	return "ldscripts/armelf_vxworks.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_vxworks.xwe";
      else
	return "ldscripts/armelf_vxworks.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_vxworks.xce";
      else
	return "ldscripts/armelf_vxworks.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_vxworks.xe";
      else
	return "ldscripts/armelf_vxworks.x";
    }
}
...
static bool
gldarmelf_vxworks_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldarmelf_vxworks_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_armelf_vxworks_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldarmelf_vxworks_before_plugin_all_symbols_read,
  vxworks_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldarmelf_vxworks_after_allocation,
