...
/* 32 bit ELF emulation code for elf32bfinfd
...
static void gldelf32bfinfd_before_parse (void);
static void gldelf32bfinfd_before_plugin_all_symbols_read
  (void);
static void gldelf32bfinfd_after_open (void);
static void gldelf32bfinfd_before_allocation (void);
static void gldelf32bfinfd_after_allocation (void);
...
static void
gldelf32bfinfd_before_parse (void)
{
  ldfile_set_output_arch ("bfin", bfd_arch_bfin);
...
static void
gldelf32bfinfd_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32bfinfd_after_open (void)
{
...
static void
gldelf32bfinfd_before_allocation (void)
{
...
static void
gldelf32bfinfd_after_allocation (void)
{
...
static char *
gldelf32bfinfd_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32bfinfd.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32bfinfd.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32bfinfd.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32bfinfd.xn";
	...
	return "ldscripts/elf32bfinfd.xdwe";
      else
	return "ldscripts/elf32bfinfd.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bfinfd.xdce";
      else
	return "ldscripts/elf32bfinfd.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bfinfd.xde";
      else
	return "ldscripts/elf32bfinfd.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bfinfd.xswe";
      else
	return "ldscripts/elf32bfinfd.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bfinfd.xsce";
      else
	return "ldscripts/elf32bfinfd.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bfinfd.xse";
      else
	return "ldscripts/elf32bfinfd.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bfinfd.xwe";
      else
	return "ldscripts/elf32bfinfd.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bfinfd.xce";
      else
	return "ldscripts/elf32bfinfd.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bfinfd.xe";
      else
	return "ldscripts/elf32bfinfd.x";
    }
}
...
static bool
gldelf32bfinfd_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32bfinfd_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32bfinfd_emulation =
{
  gldelf32bfinfd_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32bfinfd_before_plugin_all_symbols_read,
  gldelf32bfinfd_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32bfinfd_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32bfinfd_before_allocation,
  gldelf32bfinfd_get_script,
  "elf32bfinfd",
  "elf32-bfinfdpic",
  finish_default,
  NULL,
  ...
  NULL,
  gldelf32bfinfd_add_options,
  gldelf32bfinfd_handle_option,
  NULL,
  gldelf32bfinfd_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
