...
/* 32 bit ELF emulation code for shlelf_vxworks
...
#define TARGET_IS_shlelf_vxworks
...
static void gldshlelf_vxworks_before_parse (void);
static void gldshlelf_vxworks_before_plugin_all_symbols_read
  (void);
static void gldshlelf_vxworks_after_open (void);
static void gldshlelf_vxworks_before_allocation (void);
static void gldshlelf_vxworks_after_allocation (void);
...
{
  gldshlelf_vxworks_before_parse ();
...
static void
gldshlelf_vxworks_before_parse (void)
{
...
static void
gldshlelf_vxworks_before_plugin_all_symbols_read (void)
{
...
static void
gldshlelf_vxworks_after_open (void)
{
...
static void
gldshlelf_vxworks_before_allocation (void)
{
...
static void
gldshlelf_vxworks_after_allocation (void)
{
...
static char *
gldshlelf_vxworks_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/shlelf_vxworks.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/shlelf_vxworks.xr";
  else if (!config.text_read_only)
    return "ldscripts/shlelf_vxworks.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/shlelf_vxworks.xn";
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_vxworks.xswe";
      else
	return "ldscripts/shlelf_vxworks.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_vxworks.xsce";
      else
	return "ldscripts/shlelf_vxworks.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_vxworks.xse";
      else
	return "ldscripts/shlelf_vxworks.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_vxworks.xwe";
      else
	return "ldscripts/shlelf_vxworks.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_vxworks.xce";
      else
	return "ldscripts/shlelf_vxworks.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/shlelf_vxworks.xe";
      else
	return "ldscripts/shlelf_vxworks.x";
    }
}
...
static bool
gldshlelf_vxworks_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldshlelf_vxworks_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_shlelf_vxworks_emulation =
{
  vxworks_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldshlelf_vxworks_before_plugin_all_symbols_read,
  vxworks_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldshlelf_vxworks_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldshlelf_vxworks_before_allocation,
  gldshlelf_vxworks_get_script,
  "shlelf_vxworks",
  "elf32-shl-vxworks",
  finish_default,
  NULL,
  ...
  NULL,
  gldshlelf_vxworks_add_options,
  gldshlelf_vxworks_handle_option,
  NULL,
  gldshlelf_vxworks_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
