...
static void gldelf32lm32fd_before_plugin_all_symbols_read
  (void);
...
static void
gldelf32lm32fd_before_plugin_all_symbols_read (void)
{
...
gldelf32lm32fd_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
	...
	return "ldscripts/elf32lm32fd.xdwe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lm32fd.xdce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lm32fd.xde";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lm32fd.xswe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lm32fd.xsce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lm32fd.xse";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lm32fd.xwe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lm32fd.xce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lm32fd.xe";
      else
...
struct ld_emulation_xfer_struct ld_elf32lm32fd_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldelf32lm32fd_before_plugin_all_symbols_read,
