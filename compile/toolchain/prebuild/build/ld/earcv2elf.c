...
/* 32 bit ELF emulation code for arcv2elf
...
static void gldarcv2elf_before_parse (void);
static void gldarcv2elf_before_plugin_all_symbols_read
  (void);
static void gldarcv2elf_after_open (void);
static void gldarcv2elf_before_allocation (void);
static void gldarcv2elf_after_allocation (void);


static void
gldarcv2elf_before_parse (void)
{
...
static void
gldarcv2elf_before_plugin_all_symbols_read (void)
{
...
static void
gldarcv2elf_before_allocation (void)
{
...
static void
gldarcv2elf_after_allocation (void)
{
...
static char *
gldarcv2elf_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/arcv2elf.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/arcv2elf.xr";
  else if (!config.text_read_only)
    return "ldscripts/arcv2elf.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/arcv2elf.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/arcv2elf.xe";
      else
	return "ldscripts/arcv2elf.x";
    }
}
...
static bool
gldarcv2elf_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_arcv2elf_emulation =
{
  gldarcv2elf_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldarcv2elf_before_plugin_all_symbols_read,
  gldarcv2elf_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldarcv2elf_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldarcv2elf_before_allocation,
  gldarcv2elf_get_script,
  "arcv2elf",
  "elf32-littlearc",
  finish_default,
  NULL,
