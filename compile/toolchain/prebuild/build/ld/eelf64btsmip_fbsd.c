...
/* 64 bit ELF emulation code for elf64btsmip_fbsd
...
#define TARGET_IS_elf64btsmip_fbsd
...
static void gldelf64btsmip_fbsd_before_parse (void);
static void gldelf64btsmip_fbsd_before_plugin_all_symbols_read
  (void);
static void gldelf64btsmip_fbsd_after_open (void);
static void gldelf64btsmip_fbsd_before_allocation (void);
static void gldelf64btsmip_fbsd_after_allocation (void);
...
mips_before_allocation (void)
{
  ...
  gldelf64btsmip_fbsd_before_allocation ();
}


static void
gldelf64btsmip_fbsd_before_parse (void)
{
...
static void
gldelf64btsmip_fbsd_before_plugin_all_symbols_read (void)
{
...
static void
gldelf64btsmip_fbsd_after_open (void)
{
...
static void
gldelf64btsmip_fbsd_before_allocation (void)
{
...
static void
gldelf64btsmip_fbsd_after_allocation (void)
{
...
static char *
gldelf64btsmip_fbsd_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf64btsmip_fbsd.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf64btsmip_fbsd.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf64btsmip_fbsd.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf64btsmip_fbsd.xn";
	...
	return "ldscripts/elf64btsmip_fbsd.xdwe";
      else
	return "ldscripts/elf64btsmip_fbsd.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64btsmip_fbsd.xdce";
      else
	return "ldscripts/elf64btsmip_fbsd.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64btsmip_fbsd.xde";
      else
	return "ldscripts/elf64btsmip_fbsd.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64btsmip_fbsd.xswe";
      else
	return "ldscripts/elf64btsmip_fbsd.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64btsmip_fbsd.xsce";
      else
	return "ldscripts/elf64btsmip_fbsd.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64btsmip_fbsd.xse";
      else
	return "ldscripts/elf64btsmip_fbsd.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64btsmip_fbsd.xwe";
      else
	return "ldscripts/elf64btsmip_fbsd.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64btsmip_fbsd.xce";
      else
	return "ldscripts/elf64btsmip_fbsd.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf64btsmip_fbsd.xe";
      else
	return "ldscripts/elf64btsmip_fbsd.x";
    }
}
...
static void
gldelf64btsmip_fbsd_add_options
...
static bool
gldelf64btsmip_fbsd_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf64btsmip_fbsd_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf64btsmip_fbsd_emulation =
{
  gldelf64btsmip_fbsd_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf64btsmip_fbsd_before_plugin_all_symbols_read,
  gldelf64btsmip_fbsd_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf64btsmip_fbsd_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  mips_before_allocation,
  gldelf64btsmip_fbsd_get_script,
  "elf64btsmip_fbsd",
  "elf64-tradbigmips-freebsd",
  finish_default,
  ...
  NULL,
  gldelf64btsmip_fbsd_add_options,
  gldelf64btsmip_fbsd_handle_option,
  NULL,
  gldelf64btsmip_fbsd_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
