...
/* 32 bit ELF emulation code for elf32loongarch
...
#define TARGET_IS_elf32loongarch
...
static void gldelf32loongarch_before_parse (void);
static void gldelf32loongarch_before_plugin_all_symbols_read
  (void);
static void gldelf32loongarch_after_open (void);
static void gldelf32loongarch_before_allocation (void);
static void gldelf32loongarch_after_allocation (void);
...
{
  gldelf32loongarch_before_allocation ();
...
static void
gldelf32loongarch_after_allocation (void)
{
  int need_layout = 0;
  ...
  bfd_elf32_loongarch_set_data_segment_info (&link_info, (int *) phase);
  /* gldelf32loongarch_map_segments (need_layout); */
...
static void
gldelf32loongarch_before_parse (void)
{
...
static void
gldelf32loongarch_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32loongarch_after_open (void)
{
...
static void
gldelf32loongarch_before_allocation (void)
{
...
static char *
gldelf32loongarch_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32loongarch.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32loongarch.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32loongarch.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32loongarch.xn";
	...
	return "ldscripts/elf32loongarch.xdwe";
      else
	return "ldscripts/elf32loongarch.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32loongarch.xdce";
      else
	return "ldscripts/elf32loongarch.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32loongarch.xde";
      else
	return "ldscripts/elf32loongarch.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32loongarch.xswe";
      else
	return "ldscripts/elf32loongarch.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32loongarch.xsce";
      else
	return "ldscripts/elf32loongarch.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32loongarch.xse";
      else
	return "ldscripts/elf32loongarch.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32loongarch.xwe";
      else
	return "ldscripts/elf32loongarch.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32loongarch.xce";
      else
	return "ldscripts/elf32loongarch.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32loongarch.xe";
      else
	return "ldscripts/elf32loongarch.x";
    }
}
...
static bool
gldelf32loongarch_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf32loongarch_emulation =
{
  gldelf32loongarch_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32loongarch_before_plugin_all_symbols_read,
  gldelf32loongarch_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32loongarch_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  larch_elf_before_allocation,
  gldelf32loongarch_get_script,
  "elf32loongarch",
  "elf32-loongarch",
  finish_default,
  ...
  NULL,
  gldelf32loongarch_add_options,
  gldelf32loongarch_handle_option,
  NULL,
  NULL,
  ldelf_load_symbols,
  NULL,
