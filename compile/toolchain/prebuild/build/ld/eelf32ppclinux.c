...
/* 32 bit ELF emulation code for elf32ppclinux
...
#define TARGET_IS_elf32ppclinux
...
static void gldelf32ppclinux_before_parse (void);
static void gldelf32ppclinux_before_plugin_all_symbols_read
  (void);
static void gldelf32ppclinux_after_open (void);
static void gldelf32ppclinux_before_allocation (void);
static void gldelf32ppclinux_after_allocation (void);
...
ppc_before_allocation (void)
{
  ...
  gldelf32ppclinux_before_allocation ();
  ...
  /* Turn on relaxation if executable sections have addresses that
  ...
  else if (!RELAXATION_DISABLED_BY_USER)
    {
	 ...
	 up gldelf32ppclinux_before_allocation sizing.  This
...
static void
gldelf32ppclinux_before_parse (void)
{
...
static void
gldelf32ppclinux_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32ppclinux_after_open (void)
{
...
static void
gldelf32ppclinux_before_allocation (void)
{
...
static void
gldelf32ppclinux_after_allocation (void)
{
...
static char *
gldelf32ppclinux_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32ppclinux.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32ppclinux.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32ppclinux.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32ppclinux.xn";
	...
	return "ldscripts/elf32ppclinux.xdwe";
      else
	return "ldscripts/elf32ppclinux.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppclinux.xdce";
      else
	return "ldscripts/elf32ppclinux.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppclinux.xde";
      else
	return "ldscripts/elf32ppclinux.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppclinux.xswe";
      else
	return "ldscripts/elf32ppclinux.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppclinux.xsce";
      else
	return "ldscripts/elf32ppclinux.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppclinux.xse";
      else
	return "ldscripts/elf32ppclinux.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppclinux.xwe";
      else
	return "ldscripts/elf32ppclinux.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppclinux.xce";
      else
	return "ldscripts/elf32ppclinux.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppclinux.xe";
      else
	return "ldscripts/elf32ppclinux.x";
    }
}
...
static bool
gldelf32ppclinux_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32ppclinux_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32ppclinux_emulation =
{
  gldelf32ppclinux_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32ppclinux_before_plugin_all_symbols_read,
  gldelf32ppclinux_after_open,
  ppc_after_check_relocs,
  ldelf_before_place_orphans,
  gldelf32ppclinux_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  ppc_before_allocation,
  gldelf32ppclinux_get_script,
  "elf32ppclinux",
  "elf32-powerpc",
  ppc_finish,
  ...
  NULL,
  gldelf32ppclinux_add_options,
  gldelf32ppclinux_handle_option,
  NULL,
  gldelf32ppclinux_list_options,
  ppc_recognized_file,
  NULL,
  NULL,
  NULL,
