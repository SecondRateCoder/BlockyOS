...
/* 64 bit ELF emulation code for elf64briscv_lp64
...
#define TARGET_IS_elf64briscv_lp64
...
static void gldelf64briscv_lp64_before_parse (void);
static void gldelf64briscv_lp64_before_plugin_all_symbols_read
  (void);
static void gldelf64briscv_lp64_after_open (void);
static void gldelf64briscv_lp64_before_allocation (void);
static void gldelf64briscv_lp64_after_allocation (void);
...
{
  gldelf64briscv_lp64_before_allocation ();
...
static void
gldelf64briscv_lp64_after_allocation (void)
{
  int need_layout = 0;
...
static void
gldelf64briscv_lp64_before_parse (void)
{
...
static void
gldelf64briscv_lp64_before_plugin_all_symbols_read (void)
{
...
static void
gldelf64briscv_lp64_after_open (void)
{
...
static void
gldelf64briscv_lp64_before_allocation (void)
{
...
static char *
gldelf64briscv_lp64_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf64briscv_lp64.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf64briscv_lp64.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf64briscv_lp64.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf64briscv_lp64.xn";
	...
	return "ldscripts/elf64briscv_lp64.xdwe";
      else
	return "ldscripts/elf64briscv_lp64.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64briscv_lp64.xdce";
      else
	return "ldscripts/elf64briscv_lp64.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64briscv_lp64.xde";
      else
	return "ldscripts/elf64briscv_lp64.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64briscv_lp64.xswe";
      else
	return "ldscripts/elf64briscv_lp64.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64briscv_lp64.xsce";
      else
	return "ldscripts/elf64briscv_lp64.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64briscv_lp64.xse";
      else
	return "ldscripts/elf64briscv_lp64.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64briscv_lp64.xwe";
      else
	return "ldscripts/elf64briscv_lp64.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64briscv_lp64.xce";
      else
	return "ldscripts/elf64briscv_lp64.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf64briscv_lp64.xe";
      else
	return "ldscripts/elf64briscv_lp64.x";
    }
}
...
static void
gldelf64briscv_lp64_add_options
...
static bool
gldelf64briscv_lp64_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf64briscv_lp64_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf64briscv_lp64_emulation =
{
  gldelf64briscv_lp64_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf64briscv_lp64_before_plugin_all_symbols_read,
  gldelf64briscv_lp64_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf64briscv_lp64_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  riscv_elf_before_allocation,
  gldelf64briscv_lp64_get_script,
  "elf64briscv_lp64",
  "elf64-bigriscv",
  finish_default,
  ...
  NULL,
  gldelf64briscv_lp64_add_options,
  gldelf64briscv_lp64_handle_option,
  NULL,
  gldelf64briscv_lp64_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
