...
/* 32 bit ELF emulation code for elf32_tic6x_elf_le
...
#define TARGET_IS_elf32_tic6x_elf_le
...
static void gldelf32_tic6x_elf_le_before_parse (void);
static void gldelf32_tic6x_elf_le_before_plugin_all_symbols_read
  (void);
static void gldelf32_tic6x_elf_le_after_open (void);
static void gldelf32_tic6x_elf_le_before_allocation (void);
static void gldelf32_tic6x_elf_le_after_allocation (void);
...
tic6x_after_open (void)
{
  ...
  gldelf32_tic6x_elf_le_after_open ();
}
...
static void
gldelf32_tic6x_elf_le_after_allocation (void)
{
...
static void
gldelf32_tic6x_elf_le_before_parse (void)
{
...
static void
gldelf32_tic6x_elf_le_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32_tic6x_elf_le_after_open (void)
{
...
static void
gldelf32_tic6x_elf_le_before_allocation (void)
{
...
static char *
gldelf32_tic6x_elf_le_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32_tic6x_elf_le.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32_tic6x_elf_le.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32_tic6x_elf_le.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32_tic6x_elf_le.xn";
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_tic6x_elf_le.xswe";
      else
	return "ldscripts/elf32_tic6x_elf_le.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_tic6x_elf_le.xsce";
      else
	return "ldscripts/elf32_tic6x_elf_le.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_tic6x_elf_le.xse";
      else
	return "ldscripts/elf32_tic6x_elf_le.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_tic6x_elf_le.xwe";
      else
	return "ldscripts/elf32_tic6x_elf_le.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_tic6x_elf_le.xce";
      else
	return "ldscripts/elf32_tic6x_elf_le.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32_tic6x_elf_le.xe";
      else
	return "ldscripts/elf32_tic6x_elf_le.x";
    }
}
...
static void
gldelf32_tic6x_elf_le_add_options
...
static bool
gldelf32_tic6x_elf_le_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32_tic6x_elf_le_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32_tic6x_elf_le_emulation =
{
  gldelf32_tic6x_elf_le_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32_tic6x_elf_le_before_plugin_all_symbols_read,
  tic6x_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32_tic6x_elf_le_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32_tic6x_elf_le_before_allocation,
  gldelf32_tic6x_elf_le_get_script,
  "elf32_tic6x_elf_le",
  "elf32-tic6x-elf-le",
  finish_default,
  NULL,
  ...
  NULL,
  gldelf32_tic6x_elf_le_add_options,
  gldelf32_tic6x_elf_le_handle_option,
  NULL,
  gldelf32_tic6x_elf_le_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
