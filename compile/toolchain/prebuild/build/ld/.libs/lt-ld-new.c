...
/* ./.libs/lt-ld-new.c - temporary wrapper executable for .libs/ld-new.exe
   ...
   Currently, it simply execs the wrapper *script* "/bin/bash ld-new",
   but could eventually absorb all of the scripts functionality and
   exec .libs/ld-new.exe directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "ld-new.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# ld-new - temporary wrapper script for .libs/ld-new.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a\n", f);
  fputs ("#\n", f);
  fputs ("# The ld-new program cannot be directly executed until all the libtool\n", f);
