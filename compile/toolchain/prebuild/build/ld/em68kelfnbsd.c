...
gldm68kelfnbsd_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/m68kelfnbsd.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/m68kelfnbsd.xr";
  else if (!config.text_read_only)
    return "ldscripts/m68kelfnbsd.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/m68kelfnbsd.xn";
	...
	return "ldscripts/m68kelfnbsd.xdwe";
      else
	return "ldscripts/m68kelfnbsd.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/m68kelfnbsd.xdce";
      else
	return "ldscripts/m68kelfnbsd.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/m68kelfnbsd.xde";
      else
	return "ldscripts/m68kelfnbsd.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/m68kelfnbsd.xswe";
      else
	return "ldscripts/m68kelfnbsd.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/m68kelfnbsd.xsce";
      else
	return "ldscripts/m68kelfnbsd.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/m68kelfnbsd.xse";
      else
	return "ldscripts/m68kelfnbsd.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/m68kelfnbsd.xwe";
      else
	return "ldscripts/m68kelfnbsd.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/m68kelfnbsd.xce";
      else
	return "ldscripts/m68kelfnbsd.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/m68kelfnbsd.xe";
      else
	return "ldscripts/m68kelfnbsd.x";
    }
}
