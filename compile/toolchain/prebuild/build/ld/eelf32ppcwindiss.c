...
/* 32 bit ELF emulation code for elf32ppcwindiss
...
#define TARGET_IS_elf32ppcwindiss
...
static void gldelf32ppcwindiss_before_parse (void);
static void gldelf32ppcwindiss_before_plugin_all_symbols_read
  (void);
static void gldelf32ppcwindiss_after_open (void);
static void gldelf32ppcwindiss_before_allocation (void);
static void gldelf32ppcwindiss_after_allocation (void);
...
ppc_before_allocation (void)
{
  ...
  gldelf32ppcwindiss_before_allocation ();
  ...
  /* Turn on relaxation if executable sections have addresses that
  ...
  else if (!RELAXATION_DISABLED_BY_USER)
    {
	 ...
	 up gldelf32ppcwindiss_before_allocation sizing.  This
...
static void
gldelf32ppcwindiss_before_parse (void)
{
...
static void
gldelf32ppcwindiss_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32ppcwindiss_after_open (void)
{
...
static void
gldelf32ppcwindiss_before_allocation (void)
{
...
static void
gldelf32ppcwindiss_after_allocation (void)
{
...
static char *
gldelf32ppcwindiss_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32ppcwindiss.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32ppcwindiss.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32ppcwindiss.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32ppcwindiss.xn";
	...
	return "ldscripts/elf32ppcwindiss.xdwe";
      else
	return "ldscripts/elf32ppcwindiss.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcwindiss.xdce";
      else
	return "ldscripts/elf32ppcwindiss.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcwindiss.xde";
      else
	return "ldscripts/elf32ppcwindiss.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcwindiss.xswe";
      else
	return "ldscripts/elf32ppcwindiss.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcwindiss.xsce";
      else
	return "ldscripts/elf32ppcwindiss.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcwindiss.xse";
      else
	return "ldscripts/elf32ppcwindiss.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcwindiss.xwe";
      else
	return "ldscripts/elf32ppcwindiss.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcwindiss.xce";
      else
	return "ldscripts/elf32ppcwindiss.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcwindiss.xe";
      else
	return "ldscripts/elf32ppcwindiss.x";
    }
}
...
static void
gldelf32ppcwindiss_add_options
...
static bool
gldelf32ppcwindiss_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32ppcwindiss_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32ppcwindiss_emulation =
{
  gldelf32ppcwindiss_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32ppcwindiss_before_plugin_all_symbols_read,
  gldelf32ppcwindiss_after_open,
  ppc_after_check_relocs,
  ldelf_before_place_orphans,
  gldelf32ppcwindiss_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  ppc_before_allocation,
  gldelf32ppcwindiss_get_script,
  "elf32ppcwindiss",
  "elf32-powerpc",
  ppc_finish,
  ...
  NULL,
  gldelf32ppcwindiss_add_options,
  gldelf32ppcwindiss_handle_option,
  NULL,
  gldelf32ppcwindiss_list_options,
  ppc_recognized_file,
  NULL,
  NULL,
  NULL,
