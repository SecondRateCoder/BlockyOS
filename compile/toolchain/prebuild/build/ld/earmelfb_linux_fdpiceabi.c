...
/* 32 bit ELF emulation code for armelfb_linux_fdpiceabi
...
#define TARGET_IS_armelfb_linux_fdpiceabi
...
static void gldarmelfb_linux_fdpiceabi_before_parse (void);
static void gldarmelfb_linux_fdpiceabi_before_plugin_all_symbols_read
  (void);
static void gldarmelfb_linux_fdpiceabi_after_open (void);
static void gldarmelfb_linux_fdpiceabi_before_allocation (void);
static void gldarmelfb_linux_fdpiceabi_after_allocation (void);
...
static void
gldarmelfb_linux_fdpiceabi_before_parse (void)
{
...
static void
gldarmelfb_linux_fdpiceabi_set_symbols (void)
{
...
arm_elf_before_allocation (void)
{
  ...
  gldarmelfb_linux_fdpiceabi_before_allocation ();
}
...
static void
gldarmelfb_linux_fdpiceabi_after_allocation (void)
{
  int ret;
...
static void
gldarmelfb_linux_fdpiceabi_finish (void)
{
...
static void
gldarmelfb_linux_fdpiceabi_before_plugin_all_symbols_read (void)
{
...
static void
gldarmelfb_linux_fdpiceabi_after_open (void)
{
...
static void
gldarmelfb_linux_fdpiceabi_before_allocation (void)
{
...
static char *
gldarmelfb_linux_fdpiceabi_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/armelfb_linux_fdpiceabi.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/armelfb_linux_fdpiceabi.xr";
  else if (!config.text_read_only)
    return "ldscripts/armelfb_linux_fdpiceabi.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/armelfb_linux_fdpiceabi.xn";
	...
	return "ldscripts/armelfb_linux_fdpiceabi.xdwe";
      else
	return "ldscripts/armelfb_linux_fdpiceabi.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux_fdpiceabi.xdce";
      else
	return "ldscripts/armelfb_linux_fdpiceabi.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux_fdpiceabi.xde";
      else
	return "ldscripts/armelfb_linux_fdpiceabi.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux_fdpiceabi.xswe";
      else
	return "ldscripts/armelfb_linux_fdpiceabi.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux_fdpiceabi.xsce";
      else
	return "ldscripts/armelfb_linux_fdpiceabi.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux_fdpiceabi.xse";
      else
	return "ldscripts/armelfb_linux_fdpiceabi.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux_fdpiceabi.xwe";
      else
	return "ldscripts/armelfb_linux_fdpiceabi.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux_fdpiceabi.xce";
      else
	return "ldscripts/armelfb_linux_fdpiceabi.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/armelfb_linux_fdpiceabi.xe";
      else
	return "ldscripts/armelfb_linux_fdpiceabi.x";
    }
}
...
static void
gldarmelfb_linux_fdpiceabi_add_options
...
static bool
gldarmelfb_linux_fdpiceabi_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldarmelfb_linux_fdpiceabi_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_armelfb_linux_fdpiceabi_emulation =
{
  gldarmelfb_linux_fdpiceabi_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldarmelfb_linux_fdpiceabi_before_plugin_all_symbols_read,
  gldarmelfb_linux_fdpiceabi_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldarmelfb_linux_fdpiceabi_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  arm_elf_before_allocation,
  gldarmelfb_linux_fdpiceabi_get_script,
  "armelfb_linux_fdpiceabi",
  "elf32-bigarm-fdpic",
  gldarmelfb_linux_fdpiceabi_finish,
  arm_elf_create_output_section_statements,
  ldelf_open_dynamic_archive,
  ldelf_place_orphan,
  gldarmelfb_linux_fdpiceabi_set_symbols,
  NULL,
  gldarmelfb_linux_fdpiceabi_add_options,
  gldarmelfb_linux_fdpiceabi_handle_option,
  NULL,
  gldarmelfb_linux_fdpiceabi_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
