...
/* 32 bit ELF emulation code for h8300helf_linux
...
#define TARGET_IS_h8300helf_linux
...
static void gldh8300helf_linux_before_parse (void);
static void gldh8300helf_linux_before_plugin_all_symbols_read
  (void);
static void gldh8300helf_linux_after_open (void);
static void gldh8300helf_linux_before_allocation (void);
static void gldh8300helf_linux_after_allocation (void);


static void
gldh8300helf_linux_before_parse (void)
{
  ldfile_set_output_arch ("h8300:h8300h", bfd_arch_h8300);
...
static void
gldh8300helf_linux_before_plugin_all_symbols_read (void)
{
...
static void
gldh8300helf_linux_after_open (void)
{
...
static void
gldh8300helf_linux_before_allocation (void)
{
...
static void
gldh8300helf_linux_after_allocation (void)
{
...
static char *
gldh8300helf_linux_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/h8300helf_linux.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/h8300helf_linux.xr";
  else if (!config.text_read_only)
    return "ldscripts/h8300helf_linux.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/h8300helf_linux.xn";
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/h8300helf_linux.xwe";
      else
	return "ldscripts/h8300helf_linux.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/h8300helf_linux.xce";
      else
	return "ldscripts/h8300helf_linux.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/h8300helf_linux.xe";
      else
	return "ldscripts/h8300helf_linux.x";
    }
}
...
static void
gldh8300helf_linux_add_options
...
static bool
gldh8300helf_linux_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_h8300helf_linux_emulation =
{
  gldh8300helf_linux_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldh8300helf_linux_before_plugin_all_symbols_read,
  gldh8300helf_linux_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldh8300helf_linux_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldh8300helf_linux_before_allocation,
  gldh8300helf_linux_get_script,
  "h8300helf_linux",
  "elf32-h8300-linux",
  finish_default,
  NULL,
  ...
  NULL,
  gldh8300helf_linux_add_options,
  gldh8300helf_linux_handle_option,
  NULL,
  NULL,
  ldelf_load_symbols,
  NULL,
