...
/* 32 bit ELF emulation code for elf32z80
...
static void gldelf32z80_before_parse (void);
static void gldelf32z80_before_plugin_all_symbols_read
  (void);
static void gldelf32z80_after_open (void);
static void gldelf32z80_before_allocation (void);
static void gldelf32z80_after_allocation (void);
...
z80_after_open (void)
{
  ...
  gldelf32z80_after_open ();
}

/* --- \end{z80.em} */

static void
gldelf32z80_before_parse (void)
{
  ldfile_set_output_arch ("z80", bfd_arch_z80);
...
static void
gldelf32z80_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32z80_before_allocation (void)
{
...
static void
gldelf32z80_after_allocation (void)
{
...
static char *
gldelf32z80_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32z80.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32z80.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32z80.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32z80.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32z80.xe";
      else
	return "ldscripts/elf32z80.x";
    }
}
...
static bool
gldelf32z80_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf32z80_emulation =
{
  gldelf32z80_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32z80_before_plugin_all_symbols_read,
  z80_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32z80_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32z80_before_allocation,
  gldelf32z80_get_script,
  "elf32z80",
  "elf32-z80",
  finish_default,
  NULL,
