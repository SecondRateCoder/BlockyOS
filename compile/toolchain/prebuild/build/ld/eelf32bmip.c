...
/* 32 bit ELF emulation code for elf32bmip
...
static void gldelf32bmip_before_parse (void);
static void gldelf32bmip_before_plugin_all_symbols_read
  (void);
static void gldelf32bmip_after_open (void);
static void gldelf32bmip_before_allocation (void);
static void gldelf32bmip_after_allocation (void);
...
mips_before_allocation (void)
{
  ...
  gldelf32bmip_before_allocation ();
}


static void
gldelf32bmip_before_parse (void)
{
...
static void
gldelf32bmip_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32bmip_before_allocation (void)
{
...
static void
gldelf32bmip_after_allocation (void)
{
...
static char *
gldelf32bmip_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32bmip.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32bmip.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32bmip.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32bmip.xn";
	...
	return "ldscripts/elf32bmip.xdwe";
      else
	return "ldscripts/elf32bmip.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bmip.xdce";
      else
	return "ldscripts/elf32bmip.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bmip.xde";
      else
	return "ldscripts/elf32bmip.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bmip.xswe";
      else
	return "ldscripts/elf32bmip.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bmip.xsce";
      else
	return "ldscripts/elf32bmip.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bmip.xse";
      else
	return "ldscripts/elf32bmip.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bmip.xwe";
      else
	return "ldscripts/elf32bmip.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bmip.xce";
      else
	return "ldscripts/elf32bmip.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32bmip.xe";
      else
	return "ldscripts/elf32bmip.x";
    }
}
...
static bool
gldelf32bmip_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32bmip_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32bmip_emulation =
{
  gldelf32bmip_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32bmip_before_plugin_all_symbols_read,
  gldelf32bmip_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32bmip_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  mips_before_allocation,
  gldelf32bmip_get_script,
  "elf32bmip",
  "elf32-bigmips",
  finish_default,
  ...
  NULL,
  gldelf32bmip_add_options,
  gldelf32bmip_handle_option,
  NULL,
  gldelf32bmip_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
