...
static void gldelf_x86_64_fbsd_before_plugin_all_symbols_read
  (void);
static void gldelf_x86_64_fbsd_after_open (void);
static void gldelf_x86_64_fbsd_before_allocation (void);
static void gldelf_x86_64_fbsd_after_allocation (void);
...
static void
gldelf_x86_64_fbsd_before_plugin_all_symbols_read (void)
{
...
static void
gldelf_x86_64_fbsd_after_allocation (void)
{
...
gldelf_x86_64_fbsd_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
	...
	return "ldscripts/elf_x86_64_fbsd.xdwe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf_x86_64_fbsd.xdce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf_x86_64_fbsd.xde";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf_x86_64_fbsd.xswe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf_x86_64_fbsd.xsce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf_x86_64_fbsd.xse";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf_x86_64_fbsd.xwe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf_x86_64_fbsd.xce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf_x86_64_fbsd.xe";
      else
...
struct ld_emulation_xfer_struct ld_elf_x86_64_fbsd_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldelf_x86_64_fbsd_before_plugin_all_symbols_read,
  gldelf_x86_64_fbsd_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf_x86_64_fbsd_after_allocation,
