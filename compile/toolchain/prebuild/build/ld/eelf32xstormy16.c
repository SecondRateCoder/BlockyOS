...
/* 32 bit ELF emulation code for elf32xstormy16
...
#define TARGET_IS_elf32xstormy16
...
static void gldelf32xstormy16_before_parse (void);
static void gldelf32xstormy16_before_plugin_all_symbols_read
  (void);
static void gldelf32xstormy16_after_open (void);
static void gldelf32xstormy16_before_allocation (void);
static void gldelf32xstormy16_after_allocation (void);


static void
need_relax_elf32xstormy16_before_allocation (void)
{
  /* Call main function; we're just extending it.  */
  gldelf32xstormy16_before_allocation ();
...
static void
gldelf32xstormy16_before_parse (void)
{
  ldfile_set_output_arch ("xstormy16", bfd_arch_xstormy16);
...
static void
gldelf32xstormy16_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32xstormy16_after_open (void)
{
...
static void
gldelf32xstormy16_before_allocation (void)
{
...
static void
gldelf32xstormy16_after_allocation (void)
{
...
static char *
gldelf32xstormy16_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32xstormy16.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32xstormy16.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32xstormy16.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32xstormy16.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32xstormy16.xe";
      else
	return "ldscripts/elf32xstormy16.x";
    }
}
...
static bool
gldelf32xstormy16_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf32xstormy16_emulation =
{
  gldelf32xstormy16_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32xstormy16_before_plugin_all_symbols_read,
  gldelf32xstormy16_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32xstormy16_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  need_relax_elf32xstormy16_before_allocation,
  gldelf32xstormy16_get_script,
  "elf32xstormy16",
  "elf32-xstormy16",
  finish_default,
  NULL,
  ...
  NULL,
  gldelf32xstormy16_add_options,
  gldelf32xstormy16_handle_option,
  NULL,
  NULL,
  ldelf_load_symbols,
  NULL,
