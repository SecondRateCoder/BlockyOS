...
/* 32 bit ELF emulation code for elf32metag
...
static void gldelf32metag_before_parse (void);
static void gldelf32metag_before_plugin_all_symbols_read
  (void);
static void gldelf32metag_after_open (void);
static void gldelf32metag_before_allocation (void);
static void gldelf32metag_after_allocation (void);
...
static void
gldelf32metag_after_allocation (void)
{
  int ret;
...
static void
gldelf32metag_before_parse (void)
{
  ldfile_set_output_arch ("metag", bfd_arch_metag);
...
static void
gldelf32metag_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32metag_before_allocation (void)
{
...
static char *
gldelf32metag_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32metag.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32metag.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32metag.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32metag.xn";
	...
	return "ldscripts/elf32metag.xdwe";
      else
	return "ldscripts/elf32metag.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32metag.xdce";
      else
	return "ldscripts/elf32metag.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32metag.xde";
      else
	return "ldscripts/elf32metag.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32metag.xswe";
      else
	return "ldscripts/elf32metag.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32metag.xsce";
      else
	return "ldscripts/elf32metag.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32metag.xse";
      else
	return "ldscripts/elf32metag.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32metag.xwe";
      else
	return "ldscripts/elf32metag.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32metag.xce";
      else
	return "ldscripts/elf32metag.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32metag.xe";
      else
	return "ldscripts/elf32metag.x";
    }
}
...
static bool
gldelf32metag_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32metag_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32metag_emulation =
{
  gldelf32metag_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32metag_before_plugin_all_symbols_read,
  gldelf32metag_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32metag_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32metag_before_allocation,
  gldelf32metag_get_script,
  "elf32metag",
  "elf32-metag",
  finish_default,
  ...
  NULL,
  gldelf32metag_add_options,
  gldelf32metag_handle_option,
  NULL,
  gldelf32metag_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
