...
/* 64 bit ELF emulation code for aarch64cloudabi
...
#define TARGET_IS_aarch64cloudabi
...
static void gldaarch64cloudabi_before_parse (void);
static void gldaarch64cloudabi_before_plugin_all_symbols_read
  (void);
static void gldaarch64cloudabi_after_open (void);
static void gldaarch64cloudabi_before_allocation (void);
static void gldaarch64cloudabi_after_allocation (void);
...
static void
gldaarch64cloudabi_before_parse (void)
{
...
aarch64_elf_before_allocation (void)
{
  ...
  gldaarch64cloudabi_before_allocation ();
}
...
static void
gldaarch64cloudabi_after_allocation (void)
{
  int ret;
...
static void
gldaarch64cloudabi_finish (void)
{
...
static void
gldaarch64cloudabi_before_plugin_all_symbols_read (void)
{
...
static void
gldaarch64cloudabi_after_open (void)
{
...
static void
gldaarch64cloudabi_before_allocation (void)
{
...
static char *
gldaarch64cloudabi_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/aarch64cloudabi.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/aarch64cloudabi.xr";
  else if (!config.text_read_only)
    return "ldscripts/aarch64cloudabi.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/aarch64cloudabi.xn";
	...
	return "ldscripts/aarch64cloudabi.xdwe";
      else
	return "ldscripts/aarch64cloudabi.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64cloudabi.xdce";
      else
	return "ldscripts/aarch64cloudabi.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64cloudabi.xde";
      else
	return "ldscripts/aarch64cloudabi.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64cloudabi.xswe";
      else
	return "ldscripts/aarch64cloudabi.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64cloudabi.xsce";
      else
	return "ldscripts/aarch64cloudabi.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64cloudabi.xse";
      else
	return "ldscripts/aarch64cloudabi.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64cloudabi.xwe";
      else
	return "ldscripts/aarch64cloudabi.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64cloudabi.xce";
      else
	return "ldscripts/aarch64cloudabi.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64cloudabi.xe";
      else
	return "ldscripts/aarch64cloudabi.x";
    }
}
...
static void
gldaarch64cloudabi_add_options
...
static bool
gldaarch64cloudabi_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldaarch64cloudabi_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_aarch64cloudabi_emulation =
{
  gldaarch64cloudabi_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldaarch64cloudabi_before_plugin_all_symbols_read,
  gldaarch64cloudabi_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldaarch64cloudabi_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  aarch64_elf_before_allocation,
  gldaarch64cloudabi_get_script,
  "aarch64cloudabi",
  "elf64-littleaarch64-cloudabi",
  gldaarch64cloudabi_finish,
  ...
  NULL,
  gldaarch64cloudabi_add_options,
  gldaarch64cloudabi_handle_option,
  NULL,
  gldaarch64cloudabi_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
