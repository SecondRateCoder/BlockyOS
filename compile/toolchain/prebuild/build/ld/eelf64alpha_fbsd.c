...
/* 64 bit ELF emulation code for elf64alpha_fbsd
...
#define TARGET_IS_elf64alpha_fbsd
...
static void gldelf64alpha_fbsd_before_parse (void);
static void gldelf64alpha_fbsd_before_plugin_all_symbols_read
  (void);
static void gldelf64alpha_fbsd_after_open (void);
static void gldelf64alpha_fbsd_before_allocation (void);
static void gldelf64alpha_fbsd_after_allocation (void);
...
alpha_before_allocation (void)
{
  ...
  gldelf64alpha_fbsd_before_allocation ();
...
static void
gldelf64alpha_fbsd_before_parse (void)
{
...
static void
gldelf64alpha_fbsd_before_plugin_all_symbols_read (void)
{
...
static void
gldelf64alpha_fbsd_after_open (void)
{
...
static void
gldelf64alpha_fbsd_before_allocation (void)
{
...
static void
gldelf64alpha_fbsd_after_allocation (void)
{
...
static char *
gldelf64alpha_fbsd_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf64alpha_fbsd.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf64alpha_fbsd.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf64alpha_fbsd.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf64alpha_fbsd.xn";
	...
	return "ldscripts/elf64alpha_fbsd.xdwe";
      else
	return "ldscripts/elf64alpha_fbsd.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64alpha_fbsd.xdce";
      else
	return "ldscripts/elf64alpha_fbsd.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64alpha_fbsd.xde";
      else
	return "ldscripts/elf64alpha_fbsd.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64alpha_fbsd.xswe";
      else
	return "ldscripts/elf64alpha_fbsd.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64alpha_fbsd.xsce";
      else
	return "ldscripts/elf64alpha_fbsd.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64alpha_fbsd.xse";
      else
	return "ldscripts/elf64alpha_fbsd.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64alpha_fbsd.xwe";
      else
	return "ldscripts/elf64alpha_fbsd.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64alpha_fbsd.xce";
      else
	return "ldscripts/elf64alpha_fbsd.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf64alpha_fbsd.xe";
      else
	return "ldscripts/elf64alpha_fbsd.x";
    }
}
...
static void
gldelf64alpha_fbsd_add_options
...
static bool
gldelf64alpha_fbsd_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf64alpha_fbsd_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf64alpha_fbsd_emulation =
{
  gldelf64alpha_fbsd_before_parse,
  syslib_default,
  hll_default,
  alpha_after_parse,
  gldelf64alpha_fbsd_before_plugin_all_symbols_read,
  alpha_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf64alpha_fbsd_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  alpha_before_allocation,
  gldelf64alpha_fbsd_get_script,
  "elf64alpha_fbsd",
  "elf64-alpha-freebsd",
  alpha_finish,
  NULL,
  ...
  NULL,
  gldelf64alpha_fbsd_add_options,
  gldelf64alpha_fbsd_handle_option,
  NULL,
  gldelf64alpha_fbsd_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
