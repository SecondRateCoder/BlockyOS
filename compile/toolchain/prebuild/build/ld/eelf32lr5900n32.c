...
/* 32 bit ELF emulation code for elf32lr5900n32
...
#define TARGET_IS_elf32lr5900n32
...
static void gldelf32lr5900n32_before_parse (void);
static void gldelf32lr5900n32_before_plugin_all_symbols_read
  (void);
static void gldelf32lr5900n32_after_open (void);
static void gldelf32lr5900n32_before_allocation (void);
static void gldelf32lr5900n32_after_allocation (void);
...
mips_before_allocation (void)
{
  ...
  gldelf32lr5900n32_before_allocation ();
}


static void
gldelf32lr5900n32_before_parse (void)
{
  ldfile_set_output_arch ("mips:5900", bfd_arch_mips);
...
static void
gldelf32lr5900n32_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32lr5900n32_after_open (void)
{
...
static void
gldelf32lr5900n32_before_allocation (void)
{
...
static void
gldelf32lr5900n32_after_allocation (void)
{
...
static char *
gldelf32lr5900n32_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32lr5900n32.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32lr5900n32.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32lr5900n32.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32lr5900n32.xn";
	...
	return "ldscripts/elf32lr5900n32.xdwe";
      else
	return "ldscripts/elf32lr5900n32.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lr5900n32.xdce";
      else
	return "ldscripts/elf32lr5900n32.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lr5900n32.xde";
      else
	return "ldscripts/elf32lr5900n32.xd";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lr5900n32.xwe";
      else
	return "ldscripts/elf32lr5900n32.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lr5900n32.xce";
      else
	return "ldscripts/elf32lr5900n32.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lr5900n32.xe";
      else
	return "ldscripts/elf32lr5900n32.x";
    }
}
...
static bool
gldelf32lr5900n32_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32lr5900n32_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32lr5900n32_emulation =
{
  gldelf32lr5900n32_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32lr5900n32_before_plugin_all_symbols_read,
  gldelf32lr5900n32_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32lr5900n32_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  mips_before_allocation,
  gldelf32lr5900n32_get_script,
  "elf32lr5900n32",
  "elf32-nlittlemips",
  finish_default,
  ...
  NULL,
  gldelf32lr5900n32_add_options,
  gldelf32lr5900n32_handle_option,
  NULL,
  gldelf32lr5900n32_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
