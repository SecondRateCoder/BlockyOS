...
/* 32 bit ELF emulation code for elf32l4300
...
static void gldelf32l4300_before_parse (void);
static void gldelf32l4300_before_plugin_all_symbols_read
  (void);
static void gldelf32l4300_after_open (void);
static void gldelf32l4300_before_allocation (void);
static void gldelf32l4300_after_allocation (void);
...
mips_before_allocation (void)
{
  ...
  gldelf32l4300_before_allocation ();
}


static void
gldelf32l4300_before_parse (void)
{
...
static void
gldelf32l4300_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32l4300_before_allocation (void)
{
...
static void
gldelf32l4300_after_allocation (void)
{
...
static char *
gldelf32l4300_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32l4300.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32l4300.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32l4300.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32l4300.xn";
	...
	return "ldscripts/elf32l4300.xdwe";
      else
	return "ldscripts/elf32l4300.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32l4300.xdce";
      else
	return "ldscripts/elf32l4300.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32l4300.xde";
      else
	return "ldscripts/elf32l4300.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32l4300.xswe";
      else
	return "ldscripts/elf32l4300.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32l4300.xsce";
      else
	return "ldscripts/elf32l4300.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32l4300.xse";
      else
	return "ldscripts/elf32l4300.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32l4300.xwe";
      else
	return "ldscripts/elf32l4300.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32l4300.xce";
      else
	return "ldscripts/elf32l4300.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32l4300.xe";
      else
	return "ldscripts/elf32l4300.x";
    }
}
...
static bool
gldelf32l4300_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32l4300_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32l4300_emulation =
{
  gldelf32l4300_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32l4300_before_plugin_all_symbols_read,
  gldelf32l4300_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32l4300_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  mips_before_allocation,
  gldelf32l4300_get_script,
  "elf32l4300",
  "elf32-littlemips",
  finish_default,
  ...
  NULL,
  gldelf32l4300_add_options,
  gldelf32l4300_handle_option,
  NULL,
  gldelf32l4300_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
