...
static void gldelf32ebmip_before_plugin_all_symbols_read
  (void);
static void gldelf32ebmip_after_open (void);
static void gldelf32ebmip_before_allocation (void);
static void gldelf32ebmip_after_allocation (void);
...
static void
gldelf32ebmip_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32ebmip_after_allocation (void)
{
...
gldelf32ebmip_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32ebmip.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32ebmip.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32ebmip.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32ebmip.xn";
	...
	return "ldscripts/elf32ebmip.xdwe";
      else
	return "ldscripts/elf32ebmip.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ebmip.xdce";
      else
	return "ldscripts/elf32ebmip.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ebmip.xde";
      else
	return "ldscripts/elf32ebmip.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ebmip.xswe";
      else
	return "ldscripts/elf32ebmip.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ebmip.xsce";
      else
	return "ldscripts/elf32ebmip.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ebmip.xse";
      else
	return "ldscripts/elf32ebmip.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ebmip.xwe";
      else
	return "ldscripts/elf32ebmip.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ebmip.xce";
      else
	return "ldscripts/elf32ebmip.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ebmip.xe";
      else
	return "ldscripts/elf32ebmip.x";
    }
}
...
struct ld_emulation_xfer_struct ld_elf32ebmip_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldelf32ebmip_before_plugin_all_symbols_read,
  gldelf32ebmip_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32ebmip_after_allocation,
