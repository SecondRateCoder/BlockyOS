...
/* 32 bit ELF emulation code for elf32ppcvxworks
...
#define TARGET_IS_elf32ppcvxworks
...
static void gldelf32ppcvxworks_before_parse (void);
static void gldelf32ppcvxworks_before_plugin_all_symbols_read
  (void);
static void gldelf32ppcvxworks_after_open (void);
static void gldelf32ppcvxworks_before_allocation (void);
static void gldelf32ppcvxworks_after_allocation (void);
...
ppc_before_allocation (void)
{
  ...
  gldelf32ppcvxworks_before_allocation ();
  ...
  /* Turn on relaxation if executable sections have addresses that
  ...
  else if (!RELAXATION_DISABLED_BY_USER)
    {
	 ...
	 up gldelf32ppcvxworks_before_allocation sizing.  This
...
{
  gldelf32ppcvxworks_before_parse ();
...
static void
gldelf32ppcvxworks_before_parse (void)
{
...
static void
gldelf32ppcvxworks_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32ppcvxworks_after_open (void)
{
...
static void
gldelf32ppcvxworks_before_allocation (void)
{
...
static void
gldelf32ppcvxworks_after_allocation (void)
{
...
static char *
gldelf32ppcvxworks_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32ppcvxworks.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32ppcvxworks.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32ppcvxworks.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32ppcvxworks.xn";
	...
	return "ldscripts/elf32ppcvxworks.xdwe";
      else
	return "ldscripts/elf32ppcvxworks.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcvxworks.xdce";
      else
	return "ldscripts/elf32ppcvxworks.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcvxworks.xde";
      else
	return "ldscripts/elf32ppcvxworks.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcvxworks.xswe";
      else
	return "ldscripts/elf32ppcvxworks.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcvxworks.xsce";
      else
	return "ldscripts/elf32ppcvxworks.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcvxworks.xse";
      else
	return "ldscripts/elf32ppcvxworks.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcvxworks.xwe";
      else
	return "ldscripts/elf32ppcvxworks.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcvxworks.xce";
      else
	return "ldscripts/elf32ppcvxworks.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32ppcvxworks.xe";
      else
	return "ldscripts/elf32ppcvxworks.x";
    }
}
...
static void
gldelf32ppcvxworks_add_options
...
static bool
gldelf32ppcvxworks_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32ppcvxworks_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32ppcvxworks_emulation =
{
  vxworks_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32ppcvxworks_before_plugin_all_symbols_read,
  vxworks_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32ppcvxworks_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  ppc_before_allocation,
  gldelf32ppcvxworks_get_script,
  "elf32ppcvxworks",
  ...
  NULL,
  gldelf32ppcvxworks_add_options,
  gldelf32ppcvxworks_handle_option,
  NULL,
  gldelf32ppcvxworks_list_options,
  ppc_recognized_file,
  NULL,
  NULL,
  NULL,
