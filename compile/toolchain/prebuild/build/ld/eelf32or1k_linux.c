...
/* 32 bit ELF emulation code for elf32or1k_linux
...
#define TARGET_IS_elf32or1k_linux
...
static void gldelf32or1k_linux_before_parse (void);
static void gldelf32or1k_linux_before_plugin_all_symbols_read
  (void);
static void gldelf32or1k_linux_after_open (void);
static void gldelf32or1k_linux_before_allocation (void);
static void gldelf32or1k_linux_after_allocation (void);


static void
gldelf32or1k_linux_before_parse (void)
{
  ldfile_set_output_arch ("or1k", bfd_arch_or1k);
...
static void
gldelf32or1k_linux_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32or1k_linux_after_open (void)
{
...
static void
gldelf32or1k_linux_before_allocation (void)
{
...
static void
gldelf32or1k_linux_after_allocation (void)
{
...
static char *
gldelf32or1k_linux_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32or1k_linux.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32or1k_linux.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32or1k_linux.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32or1k_linux.xn";
	...
	return "ldscripts/elf32or1k_linux.xdwe";
      else
	return "ldscripts/elf32or1k_linux.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32or1k_linux.xdce";
      else
	return "ldscripts/elf32or1k_linux.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32or1k_linux.xde";
      else
	return "ldscripts/elf32or1k_linux.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32or1k_linux.xswe";
      else
	return "ldscripts/elf32or1k_linux.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32or1k_linux.xsce";
      else
	return "ldscripts/elf32or1k_linux.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32or1k_linux.xse";
      else
	return "ldscripts/elf32or1k_linux.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32or1k_linux.xwe";
      else
	return "ldscripts/elf32or1k_linux.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32or1k_linux.xce";
      else
	return "ldscripts/elf32or1k_linux.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32or1k_linux.xe";
      else
	return "ldscripts/elf32or1k_linux.x";
    }
}
...
static void
gldelf32or1k_linux_add_options
...
static bool
gldelf32or1k_linux_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf32or1k_linux_emulation =
{
  gldelf32or1k_linux_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32or1k_linux_before_plugin_all_symbols_read,
  gldelf32or1k_linux_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32or1k_linux_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32or1k_linux_before_allocation,
  gldelf32or1k_linux_get_script,
  "elf32or1k_linux",
  "elf32-or1k",
  finish_default,
  NULL,
  ...
  NULL,
  gldelf32or1k_linux_add_options,
  gldelf32or1k_linux_handle_option,
  NULL,
  NULL,
  ldelf_load_symbols,
  NULL,
