...
/* 32 bit ELF emulation code for armelf_haiku
...
static void gldarmelf_haiku_before_parse (void);
static void gldarmelf_haiku_before_plugin_all_symbols_read
  (void);
static void gldarmelf_haiku_after_open (void);
static void gldarmelf_haiku_before_allocation (void);
static void gldarmelf_haiku_after_allocation (void);
...
static void
gldarmelf_haiku_before_parse (void)
{
...
static void
gldarmelf_haiku_set_symbols (void)
{
...
arm_elf_before_allocation (void)
{
  ...
  gldarmelf_haiku_before_allocation ();
}
...
static void
gldarmelf_haiku_after_allocation (void)
{
  int ret;
...
static void
gldarmelf_haiku_before_plugin_all_symbols_read (void)
{
...
static void
gldarmelf_haiku_after_open (void)
{
...
static void
gldarmelf_haiku_before_allocation (void)
{
...
static char *
gldarmelf_haiku_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/armelf_haiku.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/armelf_haiku.xr";
  else if (!config.text_read_only)
    return "ldscripts/armelf_haiku.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/armelf_haiku.xn";
	...
	return "ldscripts/armelf_haiku.xdwe";
      else
	return "ldscripts/armelf_haiku.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_haiku.xdce";
      else
	return "ldscripts/armelf_haiku.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_haiku.xde";
      else
	return "ldscripts/armelf_haiku.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_haiku.xswe";
      else
	return "ldscripts/armelf_haiku.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_haiku.xsce";
      else
	return "ldscripts/armelf_haiku.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_haiku.xse";
      else
	return "ldscripts/armelf_haiku.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_haiku.xwe";
      else
	return "ldscripts/armelf_haiku.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_haiku.xce";
      else
	return "ldscripts/armelf_haiku.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/armelf_haiku.xe";
      else
	return "ldscripts/armelf_haiku.x";
    }
}
...
static bool
gldarmelf_haiku_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldarmelf_haiku_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_armelf_haiku_emulation =
{
  gldarmelf_haiku_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldarmelf_haiku_before_plugin_all_symbols_read,
  gldarmelf_haiku_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldarmelf_haiku_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  arm_elf_before_allocation,
  gldarmelf_haiku_get_script,
  "armelf_haiku",
  "elf32-littlearm",
  gldarmelf_haiku_finish,
  arm_elf_create_output_section_statements,
  ldelf_open_dynamic_archive,
  ldelf_place_orphan,
  gldarmelf_haiku_set_symbols,
  NULL,
  gldarmelf_haiku_add_options,
  gldarmelf_haiku_handle_option,
  NULL,
  gldarmelf_haiku_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
