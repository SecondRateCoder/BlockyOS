...
/* 32 bit ELF emulation code for avrxmega4
...
static void gldavrxmega4_before_parse (void);
static void gldavrxmega4_before_plugin_all_symbols_read
  (void);
static void gldavrxmega4_after_open (void);
static void gldavrxmega4_before_allocation (void);
static void gldavrxmega4_after_allocation (void);
...
static void
avr_elf_avrxmega4_before_allocation (void)
{
  int ret;

  gldavrxmega4_before_allocation ();
  ...
  if (strcmp ("avrxmega4", "avr6") != 0
      && strcmp ("avrxmega4", "avrxmega6") != 0
      && strcmp ("avrxmega4", "avrxmega7") != 0)
    avr_no_stubs = true;
...
static void
gldavrxmega4_before_parse (void)
{
...
static void
gldavrxmega4_before_plugin_all_symbols_read (void)
{
...
static void
gldavrxmega4_before_allocation (void)
{
...
static void
gldavrxmega4_after_allocation (void)
{
...
static char *
gldavrxmega4_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/avrxmega4.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/avrxmega4.xr";
  else if (!config.text_read_only)
    return "ldscripts/avrxmega4.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/avrxmega4.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/avrxmega4.xe";
      else
	return "ldscripts/avrxmega4.x";
    }
}
...
static bool
gldavrxmega4_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldavrxmega4_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_avrxmega4_emulation =
{
  avr_elf_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldavrxmega4_before_plugin_all_symbols_read,
  gldavrxmega4_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  avr_elf_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  avr_elf_avrxmega4_before_allocation,
  gldavrxmega4_get_script,
  "avrxmega4",
  "elf32-avr",
  avr_finish,
  ...
  NULL,
  gldavrxmega4_add_options,
  gldavrxmega4_handle_option,
  NULL,
  gldavrxmega4_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
