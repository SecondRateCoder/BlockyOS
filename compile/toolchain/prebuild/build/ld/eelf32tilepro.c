...
/* 32 bit ELF emulation code for elf32tilepro
...
static void gldelf32tilepro_before_parse (void);
static void gldelf32tilepro_before_plugin_all_symbols_read
  (void);
static void gldelf32tilepro_after_open (void);
static void gldelf32tilepro_before_allocation (void);
static void gldelf32tilepro_after_allocation (void);


static void
gldelf32tilepro_before_parse (void)
{
  ldfile_set_output_arch ("tilepro", bfd_arch_tilepro);
...
static void
gldelf32tilepro_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32tilepro_after_open (void)
{
...
static void
gldelf32tilepro_before_allocation (void)
{
...
static void
gldelf32tilepro_after_allocation (void)
{
...
static char *
gldelf32tilepro_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32tilepro.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32tilepro.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32tilepro.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32tilepro.xn";
	...
	return "ldscripts/elf32tilepro.xdwe";
      else
	return "ldscripts/elf32tilepro.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32tilepro.xdce";
      else
	return "ldscripts/elf32tilepro.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32tilepro.xde";
      else
	return "ldscripts/elf32tilepro.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32tilepro.xswe";
      else
	return "ldscripts/elf32tilepro.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32tilepro.xsce";
      else
	return "ldscripts/elf32tilepro.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32tilepro.xse";
      else
	return "ldscripts/elf32tilepro.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32tilepro.xwe";
      else
	return "ldscripts/elf32tilepro.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32tilepro.xce";
      else
	return "ldscripts/elf32tilepro.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32tilepro.xe";
      else
	return "ldscripts/elf32tilepro.x";
    }
}
...
static bool
gldelf32tilepro_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf32tilepro_emulation =
{
  gldelf32tilepro_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32tilepro_before_plugin_all_symbols_read,
  gldelf32tilepro_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32tilepro_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32tilepro_before_allocation,
  gldelf32tilepro_get_script,
  "elf32tilepro",
  "elf32-tilepro",
  finish_default,
  NULL,
