...
OUTPUT_FORMAT("elf32-metag", "elf32-metag",
	      "elf32-metag")
OUTPUT_ARCH(metag)
ENTRY(__start)
SECTIONS
{
  ...
  PROVIDE (__executable_start = SEGMENT_START("text-segment", 0x10005000)); . = SEGMENT_START("text-segment", 0x10005000) + SIZEOF_HEADERS;
  .interp         : { *(.interp) }
