...
OUTPUT_FORMAT("elf64-ia64-aix-little", "elf64-ia64-aix-little",
	      "elf64-ia64-aix-little")
OUTPUT_ARCH(ia64)
ENTRY(_start)
SEARCH_DIR("=/usr/lib/ia64l64"); SEARCH_DIR("=/usr/lib"); SEARCH_DIR("=/usr/local/lib");
SECTIONS
{
  ...
  . = ALIGN (0x10000000) + (. & (CONSTANT (MAXPAGESIZE) - 1));
  /* Exception handling  */
