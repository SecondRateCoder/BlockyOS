...
/* 32 bit ELF emulation code for elf32lppclinux
...
#define TARGET_IS_elf32lppclinux
...
static void gldelf32lppclinux_before_parse (void);
static void gldelf32lppclinux_before_plugin_all_symbols_read
  (void);
static void gldelf32lppclinux_after_open (void);
static void gldelf32lppclinux_before_allocation (void);
static void gldelf32lppclinux_after_allocation (void);
...
ppc_before_allocation (void)
{
  ...
  gldelf32lppclinux_before_allocation ();
  ...
  /* Turn on relaxation if executable sections have addresses that
  ...
  else if (!RELAXATION_DISABLED_BY_USER)
    {
	 ...
	 up gldelf32lppclinux_before_allocation sizing.  This
...
static void
gldelf32lppclinux_before_parse (void)
{
...
static void
gldelf32lppclinux_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32lppclinux_after_open (void)
{
...
static void
gldelf32lppclinux_before_allocation (void)
{
...
static void
gldelf32lppclinux_after_allocation (void)
{
...
static char *
gldelf32lppclinux_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32lppclinux.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32lppclinux.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32lppclinux.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32lppclinux.xn";
	...
	return "ldscripts/elf32lppclinux.xdwe";
      else
	return "ldscripts/elf32lppclinux.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppclinux.xdce";
      else
	return "ldscripts/elf32lppclinux.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppclinux.xde";
      else
	return "ldscripts/elf32lppclinux.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppclinux.xswe";
      else
	return "ldscripts/elf32lppclinux.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppclinux.xsce";
      else
	return "ldscripts/elf32lppclinux.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppclinux.xse";
      else
	return "ldscripts/elf32lppclinux.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppclinux.xwe";
      else
	return "ldscripts/elf32lppclinux.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppclinux.xce";
      else
	return "ldscripts/elf32lppclinux.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32lppclinux.xe";
      else
	return "ldscripts/elf32lppclinux.x";
    }
}
...
static bool
gldelf32lppclinux_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32lppclinux_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32lppclinux_emulation =
{
  gldelf32lppclinux_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32lppclinux_before_plugin_all_symbols_read,
  gldelf32lppclinux_after_open,
  ppc_after_check_relocs,
  ldelf_before_place_orphans,
  gldelf32lppclinux_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  ppc_before_allocation,
  gldelf32lppclinux_get_script,
  "elf32lppclinux",
  "elf32-powerpcle",
  ppc_finish,
  ...
  NULL,
  gldelf32lppclinux_add_options,
  gldelf32lppclinux_handle_option,
  NULL,
  gldelf32lppclinux_list_options,
  ppc_recognized_file,
  NULL,
  NULL,
  NULL,
