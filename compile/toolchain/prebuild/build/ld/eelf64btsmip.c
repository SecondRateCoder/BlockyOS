...
static void gldelf64btsmip_before_plugin_all_symbols_read
  (void);
static void gldelf64btsmip_after_open (void);
static void gldelf64btsmip_before_allocation (void);
static void gldelf64btsmip_after_allocation (void);
...
static void
gldelf64btsmip_before_plugin_all_symbols_read (void)
{
...
static void
gldelf64btsmip_after_allocation (void)
{
...
gldelf64btsmip_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
	...
	return "ldscripts/elf64btsmip.xdwe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf64btsmip.xdce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf64btsmip.xde";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf64btsmip.xswe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf64btsmip.xsce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf64btsmip.xse";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf64btsmip.xwe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf64btsmip.xce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf64btsmip.xe";
      else
...
struct ld_emulation_xfer_struct ld_elf64btsmip_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldelf64btsmip_before_plugin_all_symbols_read,
  gldelf64btsmip_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf64btsmip_after_allocation,
