...
/* 32 bit ELF emulation code for elf32mep
...
static void gldelf32mep_before_parse (void);
static void gldelf32mep_before_plugin_all_symbols_read
  (void);
static void gldelf32mep_after_open (void);
static void gldelf32mep_before_allocation (void);
static void gldelf32mep_after_allocation (void);


static void
gldelf32mep_before_parse (void)
{
  ldfile_set_output_arch ("mep", bfd_arch_mep);
...
static void
gldelf32mep_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32mep_before_allocation (void)
{
...
static void
gldelf32mep_after_allocation (void)
{
...
static char *
gldelf32mep_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32mep.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32mep.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32mep.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32mep.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32mep.xe";
      else
	return "ldscripts/elf32mep.x";
    }
}
...
static bool
gldelf32mep_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf32mep_emulation =
{
  gldelf32mep_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32mep_before_plugin_all_symbols_read,
  gldelf32mep_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32mep_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32mep_before_allocation,
  gldelf32mep_get_script,
  "elf32mep",
  "elf32-mep-little",
  finish_default,
  NULL,
