...
/* 64 bit ELF emulation code for aarch64fbsdb
...
static void gldaarch64fbsdb_before_parse (void);
static void gldaarch64fbsdb_before_plugin_all_symbols_read
  (void);
static void gldaarch64fbsdb_after_open (void);
static void gldaarch64fbsdb_before_allocation (void);
static void gldaarch64fbsdb_after_allocation (void);
...
static void
gldaarch64fbsdb_before_parse (void)
{
...
aarch64_elf_before_allocation (void)
{
  ...
  gldaarch64fbsdb_before_allocation ();
}
...
static void
gldaarch64fbsdb_after_allocation (void)
{
  int ret;
...
static void
gldaarch64fbsdb_before_plugin_all_symbols_read (void)
{
...
static void
gldaarch64fbsdb_after_open (void)
{
...
static void
gldaarch64fbsdb_before_allocation (void)
{
...
static char *
gldaarch64fbsdb_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/aarch64fbsdb.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/aarch64fbsdb.xr";
  else if (!config.text_read_only)
    return "ldscripts/aarch64fbsdb.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/aarch64fbsdb.xn";
	...
	return "ldscripts/aarch64fbsdb.xdwe";
      else
	return "ldscripts/aarch64fbsdb.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64fbsdb.xdce";
      else
	return "ldscripts/aarch64fbsdb.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64fbsdb.xde";
      else
	return "ldscripts/aarch64fbsdb.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64fbsdb.xswe";
      else
	return "ldscripts/aarch64fbsdb.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64fbsdb.xsce";
      else
	return "ldscripts/aarch64fbsdb.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64fbsdb.xse";
      else
	return "ldscripts/aarch64fbsdb.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64fbsdb.xwe";
      else
	return "ldscripts/aarch64fbsdb.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64fbsdb.xce";
      else
	return "ldscripts/aarch64fbsdb.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/aarch64fbsdb.xe";
      else
	return "ldscripts/aarch64fbsdb.x";
    }
}
...
static bool
gldaarch64fbsdb_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldaarch64fbsdb_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_aarch64fbsdb_emulation =
{
  gldaarch64fbsdb_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldaarch64fbsdb_before_plugin_all_symbols_read,
  gldaarch64fbsdb_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldaarch64fbsdb_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  aarch64_elf_before_allocation,
  gldaarch64fbsdb_get_script,
  "aarch64fbsdb",
  "elf64-bigaarch64",
  gldaarch64fbsdb_finish,
  ...
  NULL,
  gldaarch64fbsdb_add_options,
  gldaarch64fbsdb_handle_option,
  NULL,
  gldaarch64fbsdb_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
