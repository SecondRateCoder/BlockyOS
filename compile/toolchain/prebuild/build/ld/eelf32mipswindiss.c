...
/* 32 bit ELF emulation code for elf32mipswindiss
...
#define TARGET_IS_elf32mipswindiss
...
static void gldelf32mipswindiss_before_parse (void);
static void gldelf32mipswindiss_before_plugin_all_symbols_read
  (void);
static void gldelf32mipswindiss_after_open (void);
static void gldelf32mipswindiss_before_allocation (void);
static void gldelf32mipswindiss_after_allocation (void);
...
mips_before_allocation (void)
{
  ...
  gldelf32mipswindiss_before_allocation ();
}


static void
gldelf32mipswindiss_before_parse (void)
{
...
static void
gldelf32mipswindiss_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32mipswindiss_after_open (void)
{
...
static void
gldelf32mipswindiss_before_allocation (void)
{
...
static void
gldelf32mipswindiss_after_allocation (void)
{
...
static char *
gldelf32mipswindiss_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf32mipswindiss.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf32mipswindiss.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf32mipswindiss.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf32mipswindiss.xn";
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf32mipswindiss.xwe";
      else
	return "ldscripts/elf32mipswindiss.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf32mipswindiss.xce";
      else
	return "ldscripts/elf32mipswindiss.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf32mipswindiss.xe";
      else
	return "ldscripts/elf32mipswindiss.x";
    }
}
...
static void
gldelf32mipswindiss_add_options
...
static bool
gldelf32mipswindiss_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32mipswindiss_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32mipswindiss_emulation =
{
  gldelf32mipswindiss_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32mipswindiss_before_plugin_all_symbols_read,
  gldelf32mipswindiss_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32mipswindiss_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  mips_before_allocation,
  gldelf32mipswindiss_get_script,
  "elf32mipswindiss",
  "elf32-bigmips",
  finish_default,
  ...
  NULL,
  gldelf32mipswindiss_add_options,
  gldelf32mipswindiss_handle_option,
  NULL,
  gldelf32mipswindiss_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
