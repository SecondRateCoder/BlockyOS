...
/* 64 bit ELF emulation code for elf64rdos
...
static void gldelf64rdos_before_parse (void);
static void gldelf64rdos_before_plugin_all_symbols_read
  (void);
static void gldelf64rdos_after_open (void);
static void gldelf64rdos_before_allocation (void);
static void gldelf64rdos_after_allocation (void);
...
static void
gldelf64rdos_before_parse (void)
{
...
static void
gldelf64rdos_before_plugin_all_symbols_read (void)
{
...
static void
gldelf64rdos_before_allocation (void)
{
...
static void
gldelf64rdos_after_allocation (void)
{
...
static char *
gldelf64rdos_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf64rdos.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf64rdos.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf64rdos.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf64rdos.xn";
	...
	return "ldscripts/elf64rdos.xdwe";
      else
	return "ldscripts/elf64rdos.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64rdos.xdce";
      else
	return "ldscripts/elf64rdos.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64rdos.xde";
      else
	return "ldscripts/elf64rdos.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64rdos.xswe";
      else
	return "ldscripts/elf64rdos.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64rdos.xsce";
      else
	return "ldscripts/elf64rdos.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64rdos.xse";
      else
	return "ldscripts/elf64rdos.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64rdos.xwe";
      else
	return "ldscripts/elf64rdos.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64rdos.xce";
      else
	return "ldscripts/elf64rdos.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf64rdos.xe";
      else
	return "ldscripts/elf64rdos.x";
    }
}
...
static bool
gldelf64rdos_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf64rdos_emulation =
{
  gldelf64rdos_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf64rdos_before_plugin_all_symbols_read,
  gldelf64rdos_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf64rdos_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf64rdos_before_allocation,
  gldelf64rdos_get_script,
  "elf64rdos",
  "elf64-x86-64",
  finish_default,
