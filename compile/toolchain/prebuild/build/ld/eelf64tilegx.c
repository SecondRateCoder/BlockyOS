...
/* 32 bit ELF emulation code for elf64tilegx
...
static void gldelf64tilegx_before_parse (void);
static void gldelf64tilegx_before_plugin_all_symbols_read
  (void);
static void gldelf64tilegx_after_open (void);
static void gldelf64tilegx_before_allocation (void);
static void gldelf64tilegx_after_allocation (void);


static void
gldelf64tilegx_before_parse (void)
{
...
static void
gldelf64tilegx_before_plugin_all_symbols_read (void)
{
...
static void
gldelf64tilegx_after_open (void)
{
...
static void
gldelf64tilegx_before_allocation (void)
{
...
static void
gldelf64tilegx_after_allocation (void)
{
...
static char *
gldelf64tilegx_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/elf64tilegx.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/elf64tilegx.xr";
  else if (!config.text_read_only)
    return "ldscripts/elf64tilegx.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/elf64tilegx.xn";
	...
	return "ldscripts/elf64tilegx.xdwe";
      else
	return "ldscripts/elf64tilegx.xdw";
    }
  else if (bfd_link_pie (&link_info)
	   && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64tilegx.xdce";
      else
	return "ldscripts/elf64tilegx.xdc";
    }
  else if (bfd_link_pie (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64tilegx.xde";
      else
	return "ldscripts/elf64tilegx.xd";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc
	   && link_info.relro && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64tilegx.xswe";
      else
	return "ldscripts/elf64tilegx.xsw";
    }
  else if (bfd_link_dll (&link_info) && link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64tilegx.xsce";
      else
	return "ldscripts/elf64tilegx.xsc";
    }
  else if (bfd_link_dll (&link_info))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64tilegx.xse";
      else
	return "ldscripts/elf64tilegx.xs";
    }
  else if (link_info.combreloc && link_info.relro
	   && (link_info.flags & DF_BIND_NOW))
    {
      if (link_info.separate_code)
	return "ldscripts/elf64tilegx.xwe";
      else
	return "ldscripts/elf64tilegx.xw";
    }
  else if (link_info.combreloc)
    {
      if (link_info.separate_code)
	return "ldscripts/elf64tilegx.xce";
      else
	return "ldscripts/elf64tilegx.xc";
    }
  else
    {
      if (link_info.separate_code)
	return "ldscripts/elf64tilegx.xe";
      else
	return "ldscripts/elf64tilegx.x";
    }
}
...
static bool
gldelf64tilegx_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf64tilegx_emulation =
{
  gldelf64tilegx_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf64tilegx_before_plugin_all_symbols_read,
  gldelf64tilegx_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf64tilegx_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf64tilegx_before_allocation,
  gldelf64tilegx_get_script,
  "elf64tilegx",
  "elf64-tilegx-le",
  finish_default,
  NULL,
