...
/* 32 bit ELF emulation code for avrxmega3
...
static void gldavrxmega3_before_parse (void);
static void gldavrxmega3_before_plugin_all_symbols_read
  (void);
static void gldavrxmega3_after_open (void);
static void gldavrxmega3_before_allocation (void);
static void gldavrxmega3_after_allocation (void);
...
static void
avr_elf_avrxmega3_before_allocation (void)
{
  int ret;

  gldavrxmega3_before_allocation ();
  ...
  if (strcmp ("avrxmega3", "avr6") != 0
      && strcmp ("avrxmega3", "avrxmega6") != 0
      && strcmp ("avrxmega3", "avrxmega7") != 0)
    avr_no_stubs = true;
...
static void
gldavrxmega3_before_parse (void)
{
  ldfile_set_output_arch ("avr:103", bfd_arch_avr);
...
static void
gldavrxmega3_before_plugin_all_symbols_read (void)
{
...
static void
gldavrxmega3_before_allocation (void)
{
...
static void
gldavrxmega3_after_allocation (void)
{
...
static char *
gldavrxmega3_get_script (int *isfile)
{
  *isfile = 1;

  if (bfd_link_relocatable (&link_info) && config.build_constructors)
    return "ldscripts/avrxmega3.xu";
  else if (bfd_link_relocatable (&link_info))
    return "ldscripts/avrxmega3.xr";
  else if (!config.text_read_only)
    return "ldscripts/avrxmega3.xbn";
  else if (!config.magic_demand_paged)
    return "ldscripts/avrxmega3.xn";
  else
    {
      if (link_info.separate_code)
	return "ldscripts/avrxmega3.xe";
      else
	return "ldscripts/avrxmega3.x";
    }
}
...
static bool
gldavrxmega3_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldavrxmega3_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_avrxmega3_emulation =
{
  avr_elf_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldavrxmega3_before_plugin_all_symbols_read,
  gldavrxmega3_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  avr_elf_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  avr_elf_avrxmega3_before_allocation,
  gldavrxmega3_get_script,
  "avrxmega3",
  "elf32-avr",
  avr_finish,
  ...
  NULL,
  gldavrxmega3_add_options,
  gldavrxmega3_handle_option,
  NULL,
  gldavrxmega3_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
