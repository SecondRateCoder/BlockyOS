#line 1 "../../binutils-2.42/bfd/elfnn-kvx.c"
...
/* This is the most important function of all . Innocuosly named
   though !  */
static bool
elf64_kvx_size_dynamic_sections (bfd *output_bfd ATTRIBUTE_UNUSED,
				 struct bfd_link_info *info)
{
  struct elf_kvx_link_hash_table *htab;
  bfd *dynobj;
...
static bool
elf64_kvx_always_size_sections (bfd *output_bfd,
				struct bfd_link_info *info)
{
  asection *tls_sec;
...
#define elf_backend_always_size_sections	\
  elf64_kvx_always_size_sections
...
#define elf_backend_size_dynamic_sections	\
  elf64_kvx_size_dynamic_sections
