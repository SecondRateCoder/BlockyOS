...
/* testsuite/.libs/lt-gentestdlls.c - temporary wrapper executable for .libs/gentestdlls.exe
   Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a

   The testsuite/gentestdlls program cannot be directly executed until all the libtool
   libraries that it depends on are installed.

   This wrapper executable should never be moved out of the build directory.
   If it is, it will not operate correctly.

   Currently, it simply execs the wrapper *script* "/bin/bash testsuite/gentestdlls",
   but could eventually absorb all of the scripts functionality and
   exec .libs/gentestdlls.exe directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "gentestdlls.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# testsuite/gentestdlls - temporary wrapper script for .libs/gentestdlls.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a\n", f);
  fputs ("#\n", f);
  fputs ("# The testsuite/gentestdlls program cannot be directly executed until all the libtool\n", f);
