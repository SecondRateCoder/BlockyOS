...
/* ./.libs/lt-objcopy.c - temporary wrapper executable for .libs/objcopy.exe
   ...
   Currently, it simply execs the wrapper *script* "/bin/bash objcopy",
   but could eventually absorb all of the scripts functionality and
   exec .libs/objcopy.exe directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "objcopy.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# objcopy - temporary wrapper script for .libs/objcopy.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a\n", f);
  fputs ("#\n", f);
  fputs ("# The objcopy program cannot be directly executed until all the libtool\n", f);
