...
/* ./.libs/lt-ar.c - temporary wrapper executable for .libs/ar.exe
   ...
   Currently, it simply execs the wrapper *script* "/bin/bash ar",
   but could eventually absorb all of the scripts functionality and
   exec .libs/ar.exe directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "ar.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# ar - temporary wrapper script for .libs/ar.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a\n", f);
  fputs ("#\n", f);
  fputs ("# The ar program cannot be directly executed until all the libtool\n", f);
