...
/* ./.libs/lt-windmc.c - temporary wrapper executable for .libs/windmc.exe
   Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a

   The windmc program cannot be directly executed until all the libtool
   libraries that it depends on are installed.

   This wrapper executable should never be moved out of the build directory.
   If it is, it will not operate correctly.

   Currently, it simply execs the wrapper *script* "/bin/bash windmc",
   but could eventually absorb all of the scripts functionality and
   exec .libs/windmc.exe directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "windmc.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# windmc - temporary wrapper script for .libs/windmc.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a\n", f);
  fputs ("#\n", f);
  fputs ("# The windmc program cannot be directly executed until all the libtool\n", f);
