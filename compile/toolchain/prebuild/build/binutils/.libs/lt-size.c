...
/* ./.libs/lt-size.c - temporary wrapper executable for .libs/size.exe
   Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a

   The size program cannot be directly executed until all the libtool
   libraries that it depends on are installed.

   This wrapper executable should never be moved out of the build directory.
   If it is, it will not operate correctly.

   Currently, it simply execs the wrapper *script* "/bin/bash size",
   but could eventually absorb all of the scripts functionality and
   exec .libs/size.exe directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "size.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# size - temporary wrapper script for .libs/size.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a\n", f);
  fputs ("#\n", f);
  fputs ("# The size program cannot be directly executed until all the libtool\n", f);
