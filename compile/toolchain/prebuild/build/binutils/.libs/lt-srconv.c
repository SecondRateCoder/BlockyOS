...
/* ./.libs/lt-srconv.c - temporary wrapper executable for .libs/srconv.exe
   Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a

   The srconv program cannot be directly executed until all the libtool
   libraries that it depends on are installed.

   This wrapper executable should never be moved out of the build directory.
   If it is, it will not operate correctly.

   Currently, it simply execs the wrapper *script* "/bin/bash srconv",
   but could eventually absorb all of the scripts functionality and
   exec .libs/srconv.exe directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "srconv.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# srconv - temporary wrapper script for .libs/srconv.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a\n", f);
  fputs ("#\n", f);
  fputs ("# The srconv program cannot be directly executed until all the libtool\n", f);
