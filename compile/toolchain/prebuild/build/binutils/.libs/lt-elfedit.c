...
/* ./.libs/lt-elfedit.c - temporary wrapper executable for .libs/elfedit.exe
   Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a

   The elfedit program cannot be directly executed until all the libtool
   libraries that it depends on are installed.

   This wrapper executable should never be moved out of the build directory.
   If it is, it will not operate correctly.

   Currently, it simply execs the wrapper *script* "/bin/bash elfedit",
   but could eventually absorb all of the scripts functionality and
   exec .libs/elfedit.exe directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "elfedit.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# elfedit - temporary wrapper script for .libs/elfedit.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a\n", f);
  fputs ("#\n", f);
  fputs ("# The elfedit program cannot be directly executed until all the libtool\n", f);
