...
/* ./.libs/lt-readelf.c - temporary wrapper executable for .libs/readelf.exe
   Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a

   The readelf program cannot be directly executed until all the libtool
   libraries that it depends on are installed.

   This wrapper executable should never be moved out of the build directory.
   If it is, it will not operate correctly.

   Currently, it simply execs the wrapper *script* "/bin/bash readelf",
   but could eventually absorb all of the scripts functionality and
   exec .libs/readelf.exe directly.
*/
#ifdef _MSC_VER
...
const char * EXE_PATH_VALUE   = "/mnt/c/Users/PC/Documents/GitHub/BlockyOS/compile/toolchain/prebuild/build/zlib;";
const char * TARGET_PROGRAM_NAME = "readelf.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# readelf - temporary wrapper script for .libs/readelf.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a\n", f);
  fputs ("#\n", f);
  fputs ("# The readelf program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    PATH=/mnt/c/Users/PC/Documents/GitHub/BlockyOS/compile/toolchain/prebuild/build/zlib:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
